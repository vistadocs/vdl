---
title: PREM*4*2 MOCHA Server Productions Operations Manual
doc_type: POM
...
<td>04/24/2025</td>
<td>2.1</td>
<td><p>Updated MOCHA to version 4.0.2</p>
<p>Tech Edits</p></td>
...
<p>3.2.4.2 Logical and Physical Descriptions</p>
<p>3.3 Dependent System(s)</p>
<p>3.5 System Recovery</p>
<p>1 Approval Signatures</p></td>
<td>Liberty IT Solutions</td>
</tr>
<tr class="odd">
<td>01/26/2017</td>
...
The Production Operations Manual provides the information needed by the production operations team to maintain and troubleshoot the product. The Production Operations Manual (POM) must be provided prior to release of the product.
...
![](prem-4-2-mocha-server-productions-operations-manual/002.png)
...
![](prem-4-2-mocha-server-productions-operations-manual/003.png)
...
![](prem-4-2-mocha-server-productions-operations-manual/004.png)

Figure 3: Logical Deployment of the MOCHA Server
...
- Full backups are performed daily and kept for 45 days. This means that at any time, there should be 45 full backup tapes available for each server.
