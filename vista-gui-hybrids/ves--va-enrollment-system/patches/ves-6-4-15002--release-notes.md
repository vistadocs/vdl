---
title: Release Notes VES 6_4_0_15002
doc_type: RN
doc_label: Release Notes
doc_layer: patch
doc_subject: VES 6_4_0_15002
app_code: VES
...
## Table of Contents
  ...
  - [Release Notes for VHA Enrollment System VES 6.4.0.15002](#release-notes-for-vha-enrollment-system-ves-64015002)
  - [Bugs](#bugs)

## Release Notes for VHA Enrollment System VES 6.4.0.15002
...
<tr class="odd">
<td>VES-27845</td>
<td><p><strong>Defect</strong>: MSDS Dozer mapping in infinite loop causing memory leak</p>
<p><strong>Fix</strong>: Updates for Activation and Deployment objects (added domain match concept and exclude properties)</p>
<p><u>Attempted Fixes:</u></p>
<ul>
<li><p><strong>VES 6.4.0.11001</strong>: Removed specific dozer mapping that are possible cause of memory leak</p></li>
<li><p><strong>VES 6.4.0.12003</strong>: Commented out ODM code from 6.3 that is a possible cause of a memory leak</p></li>
<li><p><strong>VES 6.4.0.13002</strong>: Added support for Cluster 5 (new cluster to separate MSDS so it doesn't negatively affect others)</p></li>
<li><p><strong>VES 6.4.0.14001</strong>: Added remote JNDI lookup for Cluster 5</p></li>
</ul></td>
</tr>
</tbody>
</table>