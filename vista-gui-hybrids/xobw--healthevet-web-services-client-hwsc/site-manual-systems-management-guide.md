...
description: Added the "Orientation" section. Updated the "Introduction" section. Updated the "Using the Web Server Manager" section for Patch XOBW*1.0*4. Updated the "Using SSL/TLS and Certificate-Based Authentication with HWSC" section for Patch XOBW*1.0*4. Converted Word document to .docx format. Reformatted...
audience: ''
keywords: []
file_numbers:
- '18.02'
