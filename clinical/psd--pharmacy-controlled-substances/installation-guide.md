---
title: Controlled Substances Version 3 Installation Guide
doc_type: IG
...
- SHIFT
menu_options: 0
description: This guide explains how to install Version 3.0 of the Controlled Substances (CS) module of the Pharmacy package.
...
docx_url: https://www.va.gov/vdl/documents/Clinical/Pharm-Controlled_Substances/csinstal.docx
pdf_url: https://www.va.gov/vdl/documents/Clinical/Pharm-Controlled_Substances/csinstal.pdf
...
![](controlled-substances-version-3-installation-guide/001.png)

CONTROLLED SUBSTANCESINSTALLATION GUIDE
...
- [Assigning CS Menus](#assigning-cs-menus)
- [Allocating Security Keys](#allocating-security-keys)
- [Resource Requirements](#resource-requirements)
  - [Hardware Requirements](#hardware-requirements)
  - [![](controlled-substances-version-3-installation-guide/003.png) If the TRAKKER has been configured differently, first it must be RESET. For details on this procedure, refer to the INTERMEC 944X TRAKKER READERS User's Manual. Next, you must CONFIGURE the TRAKKER, repeating steps 1-8 on Preparing the TRAKKER for Operation.](#controlled-substances-version-3-installation-guide003png-if-the-trakker-has-been-configured-differently-first-it-must-be-reset-for-details-on-this-procedure-refer-to-the-intermec-944x-trakker-readers-users-manual-next-you-must-configure-the-trakker-repeating-steps-1-8-on-preparing-the-trakker-for-operation)
  - [Disk Space](#disk-space)
  - [Journaling Globals and Mapping Routines](#journaling-globals-and-mapping-routines)
  - [Nightly Background Job](#nightly-background-job)
- [# # Appendix A](#appendix-a)
  - [Port Set up for HL7 Interface to Narcotic Dispensing EquipmentALPHA System](#port-set-up-for-hl7-interface-to-narcotic-dispensing-equipmentalpha-system)
- [# Appendix B](#appendix-b)
  - [Starting the HL7 Interface to Narcotic Dispensing Equipment](#starting-the-hl7-interface-to-narcotic-dispensing-equipment)
...
\><u>D ^XUP</u><u>\<RET\></u> *(To set DUZ when responding to the Access Code prompt.Press return at the OPTION prompt.)*

Setting up programmer environment

Terminal Type set to: <u>C-VT100</u>

Select OPTION NAME: <u>KERNEL INSTALLATION & DISTRIBUTION SYSTEM</u>

Select Kernel Installation & Distribution System Option: <u>IN</u>stallation

Select Installation Option: <u>LOA</u>d a Distribution

Enter a Host File: <u>CSUB3_0.KID</u>
...
Select Installation Option: <u>INST</u>all Package(s)

Select INSTALL NAME: <u>CONTROLLED SUBSTANCES 3.0</u>
...
for Narcotic Dispensing Equipment Systems? No// <u>?</u>
...
Select HELP SYSTEM action or \<return\>:<u>\<RET\></u>

Do you want to enter edit your interface setup

for narcotic dispensing equipment systems? No//<u>Y</u>es Only answer "yes" if you intend to use the HL7 interface to a narcotic dispensing equipment system.
...
Select a communications protocol: H//<u>\<RET\></u> ybrid Lower Layer Protocol

HLLP DEVICE: *\[Enter your Interface device from your DEVICE file here.\]*

Want to DISABLE Scheduled Options and Options? YES//<u>\<RET\></u>

Enter options you wish to mark as 'Out Of Order': <u>PSA\*</u>
...
Enter options you wish to mark as 'Out Of Order': <u>??</u>
...
You will place Out Of Order the following options:<u>\<RET\></u>
...
You will place Out Of Order the following protocols:<u>\<RET\></u>
...
Enter options you wish to mark as 'Out Of Order':<u>\<RET\></u>

Enter protocols you wish to mark as 'Out Of Order':<u>\<RET\></u>

Enter protocols you wish to mark as 'Out Of Order':<u>\<RET\></u>

Delay Install (Minutes): (0-60): 0//<u>\<RET\></u>
...
Kyocera Setup for Printing BarcodesDEVICE file (#3.5):
...
![](controlled-substances-version-3-installation-guide/002.png) Note: A brief example of the TRAKKER setup may be displayed by running routine PSDTRAK from programmer mode.
...
> i\. INTERCHAR DELAY: Tells the TRAKKER how long to pause between characters when uploading data to V*IST*A. Choose50 milliseconds(ms).
...
## ![](controlled-substances-version-3-installation-guide/003.png) If the TRAKKER has been configured differently, first it must be RESET. For details on this procedure, refer to the *INTERMEC 944X TRAKKER READERS User's Manual*. Next, you must CONFIGURE the TRAKKER, repeating steps 1-8 on *Preparing the TRAKKER for Operation*.

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

![](controlled-substances-version-3-installation-guide/004.png)Note: The clock should be set on the TRAKKER before users start performing inventories. It is not necessary to press enter after responding yes to setting the clock.
...
![](controlled-substances-version-3-installation-guide/005.png)
...
![](controlled-substances-version-3-installation-guide/006.png) ![](controlled-substances-version-3-installation-guide/007.png) Auxiliary ![](controlled-substances-version-3-installation-guide/008.png) Port

![](controlled-substances-version-3-installation-guide/009.png)![](controlled-substances-version-3-installation-guide/010.png)![](controlled-substances-version-3-installation-guide/011.png)

![](controlled-substances-version-3-installation-guide/012.png)![](controlled-substances-version-3-installation-guide/013.png)
...
> *\[To clear the data files you must have already ended the IRL session.\]*Example of using PSDTER routine<u>D ^XUP</u>

Setting up programmer environment

Access code:<u>XXXXX</u>
...
set-up into the P-HP BARCODER Terminal Type? No// <u>Y</u>ES
...
set-up into the C-VT420 (9440) Terminal Type? No// <u>Y</u>ES
...
![](controlled-substances-version-3-installation-guide/014.png)  
...
## *Port Set up for HL7 Interface to Narcotic Dispensing Equipment*ALPHA System
...
Access: Remote[^1] Local Switch: None
...
Access Code:<u>XXXXXX</u>

Terminal Type set to: <u>C-VT100</u>

Select OPTION NAME: <u>HL7 MAIN MENU</u> HL7 Main Menu

Select HL7 Main Menu Option: <u>V1.6 OPTIONS</u>

Select V1.6 OPTIONS Option: <u>COMMUNICATIONS SERVER</u>

Select Communications Server Option: <u>6</u> Systems Link Monitor
...
*{Depending on which protocol you selected for your interface, you will seeone of the following:}*
...
TYPE: (N) NEXT, (B) BACKUP, (Q) QUIT:<u>\<RET\></u>
...
Select Communications Server Option: <u>M</u>anage incoming & outgoing filers

Select Manage incoming & outgoing filers Option: <u>S</u>tart default number of incoming & outgoing filers
...
Select OPTION: <u>ENTER OR ED</u>IT FILE ENTRIES

INPUT TO WHAT FILE: OPTION//<u>\<RET\></u>

EDIT WHICH FIELD: ALL// <u>SCHEDULING RECOMMENDED</u>

THEN EDIT FIELD:<u>\<RET\></u>

Select OPTION NAME: <u>HL</u> START DEFAULT FILERS

Start default number of incoming & outgoing filers

SCHEDULING RECOMMENDED: <u>S</u> STARTUP

Select OPTION NAME:<u>\<RET\></u>

2\. Start the lower level protocol:

Select Communications Server Option: <u>START LLP</u>
...
Select HL LOGICAL LINK NODE: <u>PSD</u>
...
Method for running the receiver: B//<u>\<RET\></u> ACKGROUND

Job was queued as 392781.

Select Communications Server Option:<u>\<RET\></u>

[^1]: This is a change from the dynamic setting recommended with HL7 Version 1.5.
...
![](controlled-substances-version-3-installation-guide-updated-psd-3-89/002.png)
...
| Controlled Substance  |          | 3.0         | Standard          | VHA              |           |
...
> The documentation, described in the table below, will be in the form of Adobe Acrobat files. Documentation can be found on the VA Software Documentation Library at: <http://www.va.gov/vdl/><u>.</u> Documentation can also be found at <span class="mark">REDACTED</span>.
...
<tbody>
<tr class="odd">
<td>CONTROLLED SUBSTANCES (CS) TECHNICAL MANUAL</td>
<td><p>PSD_3_P89_TM.docx</p>
<blockquote>
<p>PSD_3_P89_TM.pdf</p>
</blockquote></td>
<td>Binary</td>
</tr>
<tr class="even">
<td>CONTROLLED SUBSTANCES (CS) SUPERVISOR'S USER MANUAL</td>
<td><p>PSD_3_P89_UM_SUPV.docx</p>
<p>PSD_3_P89_UM_SUPV.pdf</p></td>
<td>Binary</td>
</tr>
<tr class="odd">
<td>Release Notes</td>
<td><p>PSD_3_P89_RN.docx</p>
<p>PSD_3_P89_RN.pdf</p></td>
<td>Binary</td>
</tr>
<tr class="even">
<td>IG</td>
<td><p>PSD_3_P89_IG.docx</p>
<p>PSD_3_P89_IG.pdf</p></td>
<td>Binary</td>
</tr>
</tbody>
</table>
...
Knowledge of, and experience with, the Kernel Installation and Distribution System (KIDS) software is required. For more information, see Section V, Kernel Installation and Distribution System, in the [<u>Kernel 8.0 & Kernel Toolkit 7.3 Systems Management Guide.</u>](http://www.va.gov/VDL/documents/Infrastructure/Kernel/krn8_0sm.docx)
