---
title: Inbound ePrescribing Technical Manual (PSO*7*617)
doc_type: TM
...
<table>
<caption><p><span id="_Toc75272892" class="anchor"></span>Table 1: Routines – Response Time Monitor Hooks</p></caption>
<colgroup>
<col style="width: 11%" />
<col style="width: 20%" />
<col style="width: 68%" />
...
<td>PSO*7*617</td>
<td><ul>
<li><p>Updated Routine list:</p></li>
</ul>
<blockquote>
<p>PSOERX1F,PSOERX1G,PSOERXAU,PSOERXU9,PSOERXUT</p>
</blockquote>
<ul>
<li><p>Updated Protocol list:</p></li>
</ul>
<p>PSO ERX AUDIT LOG MENU,PSO ERX AUDIT LOG SHOW/HIDE ERX VALUE,PSO ERX AUDIT LOG SORT BY DATE/TIME,PSO ERX AUDIT LOG SORT BY EDITED BY,PSO ERX AUDIT LOG SORT BY FIELD NAME,PSO ERX HIDDEN ACTIONS,PSO ERX JUMP TO ERX,PSO ERX UN-ACCEPT,PSO ERX VIEW AUDIT LOG</p>
<ul>
<li><p>Updated Data Dictionary list:</p></li>
</ul>
<blockquote>
<p>20 – AUDIT LOG, 95.1 - CONTROLLED SUBSTANCE INDICATOR,95.2 - CS DIG SIGNATURE DIGEST METHOD, 95.3 - CS DIG SIGNATURE DIGEST VALUE,95.4 CS DIG SIGNATURE VALUE, 95.5-CS DIG SIGNATURE X509 DATA</p>
</blockquote></td>
</tr>
<tr class="even">
<td>05/2021</td>
<td>PSO*7*560</td>
<td>Added the new routine <a href="#p15">PSOREJP6</a>.</td>
</tr>
<tr class="odd">
<td>03/2021</td>
<td>PSO*7*625</td>
...
<td>PSO*7*581</td>
<td><ul>
<li><p>Deleted PSO ERX VD SBN and PSO ERX HIDDEN #1 from Inbound ePrescribing protocols list. (p.149)</p></li>
</ul></td>
</tr>
<tr class="odd">
<td>12/2020</td>
...
<td>02/2019</td>
<td>PSO*7*481</td>
<td>Added the new menu option for PSO*7*481, Non-VA Provider Import, to the PSO Maintenance Menu that is under the Outpatient Pharmacy Manager. Added the new option Non-VA Provider Inactivate to Standalone Options. Routine List updated.</td>
</tr>
<tr class="odd">
<td>11/2018</td>
<td>PSO*7*452</td>
...
<p>Updates to ORC HL7 segment.</p>
<p>Added definition for ORC-30, Authorization mode.</p></td>
</tr>
<tr class="even">
<td>05/2018</td>
<td>PSO*7*463</td>
...
<td>02/2018</td>
<td>PSO*7*402</td>
<td>Routines added: <a href="#routine-list">PSO7P402, PSODOSU4</a></td>
</tr>
<tr class="even">
<td>01/2018</td>
<td>PSO*7*497</td>
...
<p>Added the following routines per Bill Tatum, developer for PRE: PSO251PO, PSOCPPRE, PSODDPR1, PSODDPR2, PSODDPR3, PSODDPR4, PSODDPR5, PSODDPRE, PSODGAL1, PSODGDGP, PSODOSCL, PSODOSUN, PSODOSUT, PSOORROC, PSODOSU2, PSOVRPT.</p>
...
<span id="_Toc75272892" class="anchor"></span>Table 1: Routines – Response Time Monitor Hooks
...
- [Implementation and Maintenance](#implementation-and-maintenance)
  ...
  - [M Audiofax (Telephone Refill Requests](#m-audiofax-telephone-refill-requests)
...
- [Barcodes and Label Printer Support](#barcodes-and-label-printer-support)
  ...
  - [New Label Stock (Version 6.0 and Later Versions)](#new-label-stock-version-60-and-later-versions)
...
- [Appendix A: Outpatient Pharmacy HL7 Interface Specifications](#appendix-a-outpatient-pharmacy-hl7-interface-specifications)
  ...
  - [B. Transaction Specifications](#b-transaction-specifications)
    ...
    - [Active Veteran's Health Information Card (VHIC) Numbers Added to PID-4 Segment](#active-veterans-health-information-card-vhic-numbers-added-to-pid-4-segment)
    - [Specific Transaction – Dispense Release Date / Time](#specific-transaction-dispense-release-date-time)
...
- [Appendix F: OneVA Pharmacy HL7 Messaging using Middleware Application for External System](#appendix-f-oneva-pharmacy-hl7-messaging-using-middleware-application-for-external-system)
  ...
  - [OneVA Pharmacy HL7 Message Types](#oneva-pharmacy-hl7-message-types)
    ...
    - [RDS^O13 Pharmacy / Treatment Dispense Message Request](#rdso13-pharmacy-treatment-dispense-message-request)
    - [RRD^O14 Prescription Refill / Partial Services Response](#rrdo14-prescription-refill-partial-services-response)
...
- [Appendix G: Inbound ePrescribing (IEP)](#appendix-g-inbound-eprescribing-iep)
  ...
  - [Inbound ePrescribing Service Reason Codes (File \#52.45)](#inbound-eprescribing-service-reason-codes-file-5245)
  - [Outpatient Pharmacy PRESCRIPTION FILE (File \#52)](#outpatient-pharmacy-prescription-file-file-52)
  - [Outpatient Pharmacy OUTPATIENT SITE (File \#59)](#outpatient-pharmacy-outpatient-site-file-59)
...
[Effective with the Inbound ePrescribing Patch PSO\*7.0\*508 (November 2018), pharmacists are able to receive and process prescriptions that originated from external providers. The Inbound ePrescribing User Manual, Installation Guide, and Implementation Guide describe the site parameters required to use this functionality.](\l)
...
> [*Pharmacy Re-Engineering (PRE) Installation Guide – Inbound ePrescribing (PSO\*7\*508)*](\l)

> [*Pharmacy Re-Engineering (PRE) Release Notes – Inbound ePrescribing (PSO\*7\*508)*](\l)

> [*Pharmacy Re-Engineering (PRE) User Guide – Inbound ePrescribing (PSO\*7\*508)*](\l)
...
<span id="_Toc75272893" class="anchor"></span>Table 2: Disk Space
...
<span id="_Toc75272894" class="anchor"></span>Table 3: Options
...
<span id="_Toc75272895" class="anchor"></span>Table 4: Templates – Input
...
<span id="_Toc75272896" class="anchor"></span>Table 5: Templates – Print
...
<span id="_Toc75272897" class="anchor"></span>Table 6: Templates – Sort

| Sort   | File |
|--------|------|
| PSOBJP | \#52 |

<span id="_Toc75272898" class="anchor"></span>Table 7: Routine to be Deleted during Installation
...
<span id="_Toc75272899" class="anchor"></span>Table 8: Files & Fields Associated
...
> **IMPORTANT:** Telephone refill requests (M Audiofax) cannot be processed without the new VEXRX routine.
...
7.  When the background job fails to transmit the data to the state, a MailMan message is generated and sent to the subscribers of the PSO SPMP NOTIFICATIONS mail group.
...
1.  The default values for the following fields are highlighted on the screen display, not to indicate user input: TASK ID, QUEUED TO RUN AT WHAT TIME, DEVICE FOR QUEUED JOB OUTPUT, and RESCHEDULING FREQUENCY.
...
The namespace for the Outpatient Pharmacy V. 7.0 package is PSO.
...
<span id="_Toc71273146" class="anchor"></span>Table 9: Waiver
...
- PSOREJP4
- PSOREJP5
- <span id="p15" class="anchor"></span>PSOREJP6
- PSOREJU1
- PSOREJU2
- PSOREJU3
- PSOREJU4
...
<span id="_Toc71273147" class="anchor"></span>Table 10: Supporting Documentation
...
<span id="_Toc75272902" class="anchor"></span>Table 11: Security Keys
...
<table>
<caption><p><span id="_Toc75272903" class="anchor"></span>Table 12: Package Version</p></caption>
<colgroup>
<col style="width: 30%" />
<col style="width: 69%" />
</colgroup>
...
<span id="_Toc75272903" class="anchor"></span>Table 12: Package Version
...
8.  The HL Logical Link Entry / Node set up for Outpatient Pharmacy V. 7.0 is PSO DISP. This is a new Logical Link installed with Patch PSO\*7\*156.

    The HL Logical Link Entry / Node set up for Outpatient Pharmacy V. 7.0 is PSORRXSEND. This is a new Logical Link installed with Patch PSO\*7\*454.
...
<span id="_Toc75272904" class="anchor"></span>Table 13: Options that can be Revoked

9.  For Outpatient Medication Copay options to be fully functional, the Pharmacy Ordering Enhancement (POE) project software must be installed, which includes patches to Outpatient Pharmacy (PSO\*7\*46), Order Entry/Results Reporting (OR\*3\*94), Pharmacy Data Management (PSS\*1\*38), and Inpatient Medications (PSJ\*5\*50).
10. For Clinical Indicator Data Capture (CIDC) to be fully functional, the Outpatient Pharmacy CIDC software (PSO\*7\*143) must be installed along with CPRS Version 25.
11. The OneVA Pharmacy Patch PSO\*7\*454 introduces new functionality that allows for a pharmacist to remotely refill a prescription from another VistA instance. This patch utilizes Health Level 7 (HL7) messaging to send and receive remote prescription details from another VAMC. This allows a 'dispensing', or 'non-custodial' Pharmacy to refill a prescription that originated from another VA facility. The VA facility where the prescription exists is considered the 'host' facility. VistA utilizes HL7 to send a query message to middleware application. A middleware application is used to query the Health Data Repository / Clinical Data Service (HDR / CDS) Repository for all active medications from all sites. The medications are returned to the querying site. Once the prescriptions are received, they are displayed below any 'local' prescriptions within the Patient Prescription Processing \[PSO LM BACKDOOR ORDERS\] option sorted by facility. The pharmacist can then view the remote prescriptions and will be able to refill or partially fill any active prescriptions that are not considered controlled substances at either facility. To be fully functional, the site must be configured to middleware.
...
<span id="_Toc75272905" class="anchor"></span>Table 14: Templates – Sort

Any locally created menu that includes options from this package *must* have the ENTRY ACTION field read: D:'\$D(PSOPAR) ^PSOLSET and should have the MENU EXIT ACTION field read: D FINAL^PSOLSET
...
<span id="_Toc75272906" class="anchor"></span>Table 15: Templates – Input
...
<span id="_Toc75272907" class="anchor"></span>Table 16: Templates – Print
...
<span id="_Toc75272908" class="anchor"></span>Table 17: Security Keys
...
A mail group and device should be set up in order to run the HL7 external interface. The recommended name of the mail group is PSO HLGROUP1. The recommended device name is PSO HLDEVICE1.
...
<span id="_Toc75272909" class="anchor"></span>Table 18: File Security
...
<table>
<caption><p><span id="_Toc75272910" class="anchor"></span>Table 19: Control Codes</p></caption>
<colgroup>
<col style="width: 12%" />
<col style="width: 52%" />
<col style="width: 5%" />
...
<tr class="odd">
<td>52.52</td>
<td>CLOZAPINE PRESCRIPTION OVERRIDES</td>
<td>@</td>
<td>@</td>
<td>@</td>
<td>@</td>
...
<tr class="even">
<td>59.8</td>
<td>OUTPATIENT CLINIC SORT GROUP</td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<span id="_Toc75272910" class="anchor"></span>Table 19: Control Codes

12. Please refer to Chapter 28 of Kernel V. 8.0 Systems Manual concerning installation of security codes sections entitled “Sending Security Codes.”
...
Autocancel Rx’s on AdmissionBingo Board ...
...
Change Label PrinterCheck Drug InteractionClozapine Pharmacy Manager
...
Enter/Edit Clinic Sort GroupsExternal Interface Menu …
...
Label/Profile Monitor ReprintMaintenance (Outpatient Pharmacy) ...
...
Medication ProfileOutput Reports ...
...
Process Order ChecksRelease MedicationReturn Medication to StockRx (Prescriptions) ...
...
Update Patient RecordVerification ...
...
Change Label PrinterChange Suspense DateCheck Drug InteractionDUE Supervisor ...
...
Medication ProfilePharmacy Intervention Menu ...
...
Print from Suspense FileProcess Order ChecksPull Early from SuspenseQueue CMOP PrescriptionRelease MedicationReturn Medication to StockRx (Prescriptions) ...
...
Medication ProfilePatient Prescription ProcessingPull Early from SuspenseQueue CMOP PrescriptionRelease MedicationUpdate Patient Record
...
## New Label Stock (Version 6.0 and Later Versions) 

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

> **IMPORTANT:** Please test new label stock on all printers that will be used before going into production with new label stock.
...
15. The character after the \[\<4 in the BAR CODE OFF above is a lower case L.
...
16. The setup of the MT290 will not allow for a form length of 5 inches. It skips from 4 to 5.5. Following is the terminal type information that will allow the MT290 to print the labels at a form length of 5 inches.
...
20. The form must have a length of 255 and a width of 512.
...
<span id="_Toc75272911" class="anchor"></span>Table 20: Glossary
...
21. When using 10k printers make sure that the device is set up to use a Print Queue. If it is not then the 10k labels will not print.
...
PRINT SERVER NAME OR ADDRESS: xxx.xxx.va.gov
...
<table>
<caption><p><span id="_Toc75272912" class="anchor"></span>Table 21: HL7 Messages</p></caption>
<colgroup>
<col style="width: 23%" />
<col style="width: 76%" />
</colgroup>
...
<tr class="even">
<td><strong>OneVA Pharmacy Label</strong></td>
...
<tr class="odd">
<td><strong>OPAI</strong></td>
<td>Outpatient Pharmacy Automated Interface</td>
</tr>
<tr class="even">
<td><strong>PDMP</strong></td>
...
<tr class="even">
<td><strong>VHIC</strong></td>
<td>Veterans’ Health Identification Card</td>
</tr>
<tr class="odd">
<td><strong>VistA</strong></td>
<td>Acronym for <strong>V</strong>eterans Health <strong>I</strong>nformation <strong>S</strong>ystems and <strong>T</strong>echnology <strong>A</strong>rchitecture, the new name for Decentralized Hospital Computer Program (DHCP).</td>
</tr>
<tr class="even">
...
<span id="_Toc75272912" class="anchor"></span>Table 21: HL7 Messages
...
The following HL7 messages will be used to support the exchange of Outpatient Pharmacy data with any automatic dispensing system:
...
<span id="_Toc75272913" class="anchor"></span>Table 22: HL7 Segments

The messages for the dispense request will consist of the following HL7 segments:
...
<span id="_Toc75272914" class="anchor"></span>Table 23: Pharmacy Encoded Order / Treatment Dispense Message

### Specific Transaction – Dispense Request

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

The Pharmacy Encoded Order / Treatment Dispense Message is as follows:
...
<span id="_Toc75272915" class="anchor"></span>Table 24: Pharmacy Encoded Order Acknowledgment Message
...
The Pharmacy Encoded Order Acknowledgment Message is as follows:
...
<span id="_Toc75272916" class="anchor"></span>Table 25: Segments used in the Outpatient Pharmacy HL7 Interface Dispense Request
...
22. The changes in HL7 message generated by OPAI are tested with ScripPro and Optifill, only. Sites using other vendors are requested to inform them of the changes, so that they can make necessary changes to ensure smooth running of interface at their sites.
...
<table>
<caption><p><span id="_Toc75272917" class="anchor"></span>Table 26: Segments used in the Outpatient Pharmacy HL7 interface Dispense Release Date / Time Request</p></caption>
<colgroup>
<col style="width: 12%" />
<col style="width: 7%" />
<col style="width: 6%" />
...
<td>164 Friendship DR~""~REDACTED~XX~12180~~P~""</td>
</tr>
<tr class="odd">
<td></td>
<td>13</td>
...
<td>101 CHURCH AVE~~REDACTED~XX~12208</td>
</tr>
<tr class="even">
<td></td>
<td>23</td>
...
<ol start="23">
<li><p>The separator value “\.sp\” has been added to NTE-3, 3 = Drug Warning Narrative, to separate the different warning labels.</p></li>
</ol></td>
</tr>
<tr class="even">
<td>RXE</td>
...
<span id="_Toc75272917" class="anchor"></span>Table 26: Segments used in the Outpatient Pharmacy HL7 interface Dispense Release Date / Time Request
...
- Confidential Address 3rd up-arrow piece if it is Active   
...
- Patient Temporary Address 3rd up-arrow piece or piece after the last Confidential Address entry if the Confidential Address is active.
...
Example: 321 Dakota Ave.~""~ANYTOWN~DC~20032~USA~P~""~001
...
Example: 100 PERMANENT ADDRESS~""""~NEW YORK~NY~10018~USA~P~""""~061^\~~REDACTED~XX\~\~~N^1 CONFIDENTIAL STREET~""""~NEW YORK~NY~10019~USA~VACAE~""""~061\~\~~20160628&20160718^1 CONFIDENTIAL STREET~""""~REDACTED~XX~10019~USA~VACAA"^HL(772,35537819,"IN",3,0)="~""""~061\~\~~20160628&20160718^1 CONFIDENTIAL STREET~""""~REDACTED~XX~10019~USA~VACAM~""""~061\~\~~20160628&20160718^200 TEMPROARY ADDRESS~""""~REDACTED~XX~10017~USA~C
...
> PADD-1~PADD-2~ANYTOWN~TX~77379\~~P~PADD-3~201^\~~""~""\~\~~N\|""\|\|\|\|\|\|\|\|

> Example: Confidential address – active:

> PADD-1~PADD-2~ANYTOWN~TX~77379\~~P~PADD-3~201^\~~""~""\~\~~N^1 CONFIDENTIAL STREET~""""~NEW YORK~NY~10019~USA~VACAM~

> Example: Temporary address – active:

> PADD-1~PADD-2~ANYTOWN~TX~77379\~~P~PADD-3~201^\~~""~""\~\~~N^TADD-1~TADD-2

> TADD-3~ANYTOWN~TX~12345\~~C\~~""\~\~~

> Example: Address flagged as BAI:

> PADD-1~PADD-2~ANYTOWN~TX~77379\~~VAB1~PADD-3~201^\~~""~""\~\~~N\|""\|\|\|\|\|\|\|\|\|

"VAB1" - indicates Bad Address Indicator and 1 is for UNDELIVERABLE (2 for HOMELESS, 3 for OTHER)

25. For each Active Confidential Address Category entered for the patient, an entry will be made into the HL7 record delimited by ^.
...
> ESS~""""~REDACTED~XX~10018~USA~P~""""~061^\~~REDACTED~XX\~\~~N^1 CONFIDENTIAL ST

> REET~""""~REDACTED~XX~10019~USA~VACAE~""""~061\~\~~20160628&20160718^1 CONFIDENTIA

> L STREET~""""~REDACTED~XX~10019~USA~VACAA"

> ^HL(772,35537804,"IN",3,0)="~""""~061\~\~~20160628&20160718^1 CONFIDENTIAL STREET~

> """"~REDACTED~XX~10019~USA~VACAC~""""~061\~\~~20160628&20160718^1 CONFIDENTIAL STR

> EET~""""~REDACTED~XX~10019~USA~VACAM~""""~061\~\~~20160628&20160718^1 CONFIDENTIAL

> STREET~""""~REDACTED~XX~10019~USA~VACAO~"""""

> ^HL(772,35537804,"IN",4,0)="~061\~\~~20160628&20160718^200 TEMPROARY ADDRESS~""""~

> REDACTED~XX~10017~USA~C~""""~061\~\~~20160623&20160802\|\|(222)222-2222~PRN~PH^(111)
...
\[ORC-12\] Ordering Provider is a composite ID field. The first component is the Provider’s pointer to the NEW PERSON file (#200) in VistA and the second component is their name.
...
\[ORC-19\] Action By is the physician who cosigned, if any, and is a composite field. The first component is the physician’s pointer to the NEW PERSON file (#200) in VistA and the second component is their name.
...
\[ORC-30\] Enterer Authorization Mode is passed for digitally signed controlled substance orders. The value of ‘EL’ is used, representing a value of ‘Electronic’.
...
26. The separator value “\\sp\\ has been added to NTE-3, 3 = Drug Warning Narrative, to separate the different warning labels.
...
27. The separator value “\\sp\\ has been added to NTE-3, 3 = Drug Warning Narrative, to separate the different warning labels.
...
PID\|\|\|5000002199V009321\~\~~USVHA&&0363~NI~VA FACILITY ID&500&L\~~20140212^234234987\~\~~USSSA&&0363~SS~VA FACILITY ID&500&L^""""\~\~~USDOD&&0363~TIN~VA FACILITY ID&500&L^""""\~\~~USDOD&&0363~FIN~VA FACILITY ID&500&L^7172676\~\~~USVHA&&0363~PI~VA FACILITY ID&500&L\|333888478\~\~~USVHA&&0363~PI~VA FACILITY ID&742V1&L^492994922\~\~~USVHA&&0363~PI~VA FACILITY ID&742V1&L\|PSOPATIENT~MULTIPLE\~~RX\~\~~L\|\|19111111\|M\|\|\|123 MAIN ST~""~ANYTOWN ONE~CA~94114~USA~P~""~075^\~~ ANY TOWN TWO~CA\~\~~N\|\|(555)555-5555~PRN~PH\|\|\|\|\|\|\|\|\|\|\|\|\|\|\|\|\|\|
...
|         | 4    | 180 | HD  | R   |      | 0362 | Sending Facility – station ID and station DNS name                 | 521~XXX.XXX.VA.GOV~DNS                                                                            |
|         | 5    | 180 | HD  | R   |      | 0361 | Receiving Application                                              | PSO DISPENSE                                                                                      |
|         | 6    | 180 | HD  | R   |      | 0362 | Receiving Facility – DNS name and port of dispensing machine       | ~XXX.XXX.VA.GOV:9300~DNS                                                                          |
...
|         | 11   | 250 | XAD | R   | Y/3  |      | Patient Address                                                    | 164 Friendship DR~""~REDACTED~XX~12180\~~P~""                                                     |
...
<span id="_Toc75272918" class="anchor"></span>Table 27: Segments used in the Outpatient Pharmacy HL7 interface Dispense Completion
...
<table>
<caption><p><span id="_Toc75272919" class="anchor"></span>Table 28: HL7 Order Message Segment</p></caption>
<colgroup>
<col style="width: 12%" />
<col style="width: 7%" />
<col style="width: 6%" />
...
<span id="_Toc75272919" class="anchor"></span>Table 28: HL7 Order Message Segment
...
<span id="_Toc75272920" class="anchor"></span>Table 29: Segments
...
<span id="_Toc75272921" class="anchor"></span>Table 30: Segments
...
<span id="_Toc75272922" class="anchor"></span>Table 31: Example of VDEF HL7 Message Details
...
MSH^~\|\\^HDRPREF^613~XXX.XXX.VA.GOV~DNS^PSO VDEF IE SIDE^200HD~XXX.XXX.VA.GOV~DNS^20041216192259-0500^^RDS~O13^61332594923^T^2.4^^^AL^NE^US

PID^1^1234567890V123456^1234567890V123456\~\~~USVHA&&0363~NI~VA FACILITY ID&613&L\|000654321\~\~~USSSA&&0363~SS~VA FACILITY ID&613&L\|1234\~\~~USVHA&&0363~PI~VA FACILITY ID&613&L\|000654321\~\~~USVBA&&0363~PN~VA FACILITY ID&613&L^^LastName~FirstName~M\~\~\~~L^MotherMaidenLastName\~\~\~\~\~~M^19150511^M^^""^HC 11, BOX 22B~""~ANYTOWN~WV~12345\~~P~""\|\~~ANYTOWN~MD\~\~~N^027^(123)555-1212^""^^D^0^^000654321^^^""^REDACTED MD^^^^^^20000301^^

ORC^RE^^1685567~613_52\_.001^^CM^^\~\~~19950109~19960110\~~FILL/EXPIRATION\|\~\~\~~19950109\~~ISSUED\|\~\~~19950109~19950330\~~DISPENSED/LAST DISPENSED\|\~\~\~~19950629\~~CANCEL^^19950109123449-0500^63~OPPROVIDER40~TWO\~\~\~\~~VistA200^^947~OPPROVIDER41~TWO~A~MD\~~MD~RE^ CCS/HOME VISIT~2559^^^613~ANYTOWN VAMC~613_52_20~5005423~ANYTOWN VAMC~NCPDP^^^^REDACTED, WV^^^^4500704~DISCONTINUED~99VA_52_100
...
ORC^RF^^1^^^^\~\~~19950330\~\~~DISPENSED^~1685567^19950306^^^947~OPPROVIDER41~TWO~A~MD\~~MD~VistA200^^^^REFILL^613~ANYTOWN

VAMC~613_52.1_8~5005423~ANYTOWN VAMC~NCPDP^^^^ANYTOWN, WV RXE^\~\~~19950330\~\~~REFILL^4005192~AMANTADINE HCL 100MG CAP~99VA \_52_6~0781-2048-01\~~NDC ^0^^20~MG~613_52_6^^^\~\~\~\~~MAIL^^90^^^^2992~OPPROVIDER42~THREE~M\~\~\~~PHARMACIST^^^^199503290934-0500^^^^D90^^^^^^^^^11135~ AMANTADINE HCL 100MG CAP ~613_50\_.01\|C0255\~~613_50_27

FT1^^^^19950330^^CG^620~AMANTADINE\~~613_52_39.2^^^^^0.009

FT1^2^^^19950330^^CG^1~PSO NSC RX COPAY NEW~500_52_105

ORC^RF^^1^^^^^~1685567^199503061212-0500^^^947~OPPROVIDER41~TWO~A~MD\~~MD~VistA200^^^^PARTIAL^613~ANYTOWN VAMC~613_52.2\_.09~5005423~ANYTOWN VAMC~NCPDP^^^^ANYTOWN, WV RXE^\~\~~19950306\~\~~PARTIAL^4005192~AMANTADINE HCL 100MG CAP~99VA \_52_6~0781-2048-01\~~NDC ^0^^20~MG~613_52_6^^^\~\~\~\~~WINDOW^^30^^^^2992~OPPROVIDER42~THREE~M\~\~\~~PHARMACIST^^^^19950307144822-0500^^^^D30^^^^^^^^^11135~ AMANTADINE HCL 100MG CAP ~613_50\_.01\|C0255\~~613_50_27
...
28. The dosage will only appear in the RXE segment associated with the original fill, it will not appear in RXE segments associated with refills or partial fills.

<table style="width:100%;">
<caption><p><span id="_Toc75272923" class="anchor"></span>Table 32: SPMP Data Source</p></caption>
<colgroup>
<col style="width: 0%" />
<col style="width: 11%" />
<col style="width: 12%" />
...
<td>Receiving Facility</td>
<td>HD</td>
<td>200HD~XXX.XXX.VA.GOV~DNS</td>
</tr>
<tr class="odd">
<td colspan="2">MSH</td>
<td>7</td>
...
<td>Entering Organization</td>
<td>CE</td>
<td>613~REDACTED VAMC~613_52_20~5005423~REDACTED VAMC~NCPDP</td>
</tr>
<tr class="even">
<td colspan="2">ORC</td>
<td>18</td>
...
<td>Entering Organization</td>
<td>CE</td>
<td>613~REDACTED VAMC~613_52.1_8~5005423~REDACTED VAMC~NCPDP</td>
</tr>
<tr class="even">
<td colspan="2">ORC</td>
<td>18</td>
...
<td>Entering Organization</td>
<td>CE</td>
<td>613~REDACTED VAMC~613_52.2_.09~5005423~MREDACTEDARTINSBURG VAMC~NCPDP</td>
</tr>
<tr class="even">
<td colspan="2">ORC</td>
<td>18</td>
...
<span id="_Toc75272923" class="anchor"></span>Table 32: SPMP Data Source
...
The data elements in this standard include those described in the Prescription Monitoring Program Model Act of November 2002 developed by the Alliance of States with Prescription Monitoring Programs and the National Association of State Controlled Substances Authorities.
...
29. Prescription fills Administered in Clinic will not be sent to the states. Only outpatient prescriptions (new and updated) dispensed to patients will be submitted to the states.
...
<table>
<caption><p><span id="_Toc75272924" class="anchor"></span>Table 33: ASAP Zero Report Specifications (PSO*7*625)</p></caption>
<colgroup>
<col style="width: 11%" />
<col style="width: 46%" />
<col style="width: 41%" />
...
<td><p>ASAP 3.0 : Response ID (Not Used)<br />
; ASAP 4.0+: Creation Time. Format: HHMMSS or HHMM</p>
...
<p><strong>Example</strong>: ANYTOWN VA MEDICAL CENTER</p></td>
</tr>
<tr class="even">
<td>IS03</td>
<td><p>Message</p>
...
<p><strong>Example</strong>: REDACTED PMP PROGRAM</p></td>
</tr>
<tr class="odd">
<td>IR03-IR10</td>
<td>ASAP 3.0 only</td>
...
<p><strong>Field</strong>: NAME (#.01)</p>
<p><strong>Option</strong>: Site Parameter Enter/Edit [PSO SITE PARAMETERS]</p>
<p><strong>Example</strong>: ANYTOWN</p></td>
</tr>
<tr class="odd">
<td>PHA05</td>
...
<p>Example: OK</p>
<ol start="31">
<li><p>The pointer to STATE file (#5) is retrieved from OUTPATIENT SITE file (#59) MAILING FRANK STATE field (#.08).</p></li>
</ol></td>
</tr>
<tr class="odd">
<td>PHA09</td>
...
<span id="_Toc75272924" class="anchor"></span>Table 33: ASAP Zero Report Specifications (PSO\*7\*625)
...
<span id="_Toc75272925" class="anchor"></span>Table 34: Response Control Parameter (RCP) Segment
...
<span id="_Toc75272883" class="anchor"></span>Figure 1: Dispensing VistA Instance to HDR / CDS Repository

![](inbound-eprescribing-technical-manual-pso-7-617/002.png)
...
<span id="_Toc75272884" class="anchor"></span>Figure 2: Business Capability Processed for OneVA Pharmacy Patch

![](inbound-eprescribing-technical-manual-pso-7-617/003.png)

When the Pharmacist enters a request to display the Medication Profile screen from a dispensing VistA instance, the QBP^Q13 HL7 ‘Query By Parameter Request’ message is sent to a middleware application. A middleware application will harvest the necessary information to send a SOAP request to the HDR / CDS Repository for the patient’s prescriptions. The SOAP response is transformed into an RTB^K13 HL7 ’Prescription Query Service Response’ message that contains the patient’s prescription data. The patient’s prescription data is returned to the dispensing VistA instance and displayed on the Medication Profile screen. The following image displays the sequence of events and message types for this processing.

<span id="_Toc75272885" class="anchor"></span>Figure 3: Processing Sequence of Events and Message Type

![](inbound-eprescribing-technical-manual-pso-7-617/004.png)
...
<span id="_Toc75272886" class="anchor"></span>Figure 4: Dispense Order from another VA Pharmacy Location Functionality

![](inbound-eprescribing-technical-manual-pso-7-617/005.png)
...
2.  RTB^K13 Prescription Query Service Request
3.  RDS^O13 Pharmacy / Treatment Dispense Message Request
4.  RRD^O14 Prescription Refill / Partial Service Response
...
39. The MUMPS code is designed to use the ‘D BLDPID^PSOTPHL2(DFN,"",.PSORRDAT,.HL,.ERR)’ routine to create the Patient Identification (PID) segment.
...
<span id="_Toc75272926" class="anchor"></span>Table 35: Table Row Definition (RDF) Segment
...
<span id="_Toc75272927" class="anchor"></span>Table 36: Notes and Comments (NTE) segment

<span id="_Toc75272887" class="anchor"></span>Figure 5: Example RTB^K13 Prescription Query Service Response

![](inbound-eprescribing-technical-manual-pso-7-617/006.png)
...
<span id="_Toc75272888" class="anchor"></span>Figure 6: Example RTB^K13 HL7 RDF Segment

![](inbound-eprescribing-technical-manual-pso-7-617/007.png)
...
40. The MUMPS code uses BLDPID^PSOTPHL2(DFN,"",.PSORRDAT,.HL,.ERR)’ to create the Patient Identification (PID) segment.
...
41. The Notes and Comments (NTE) segment will be present if the request is for a ‘Partial Fill’.
...
<span id="_Toc75272928" class="anchor"></span>Table 37: Notes and Comments (NTE) segment

<span id="_Toc71273180" class="anchor"></span>Figure 7: Example RDS^O13 Pharmacy / Treatment Dispense Message Request Refill

![](inbound-eprescribing-technical-manual-pso-7-617/008.png)

<span id="_Toc71273181" class="anchor"></span>Figure 8: Example RDS^O13 Pharmacy / Treatment Dispense Message Request Partial Fill

![](inbound-eprescribing-technical-manual-pso-7-617/009.png)
...
42. The MUMPS code uses BLDPID^PSOTPHL2(DFN,"",.PSORRDAT,.HL,.ERR)’ to create the Patient Identification (PID) segment.
...
43. The Notes and Comments (NTE) segment will be present if the request is for a ‘Partial Fill’.
...
<span id="_Ref75269611" class="anchor"></span>Figure 9: Inbound ePrescribing Process Flow (Version 5.0)

![](inbound-eprescribing-technical-manual-pso-7-617/010.png)
...
[ERX Holding Queue File \#52.49](#inbound-eprescribing-holding-queue-file-file-52.49)
...
20 AUDIT LOG 20.1 VISTA QUANTITY
...
95.1 CONTROLLED SUBSTANCE INDICATOR

95.2 CS DIG SIGNATURE DIGEST METHOD

95.3 CS DIG SIGNATURE DIGEST VALUE

95.4 CS DIG SIGNATURE VALUE

95.5 CS DIG SIGNATURE X509 DATA 100 PROCESSING ERRORS
...
[ERX External Patient File \#52.46](\l)
...
[Inbound ePrescribing External Pharmacy File (#52.47)](\l)
...
[Inbound ePrescribing External Person (File \#52.48)](\l)
...
## Inbound ePrescribing Service Reason Codes (File \#52.45)
...
## Outpatient Pharmacy PRESCRIPTION FILE (File \#52)

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

PRESCRIPTION (#52) ACTIVITY LOG SUB-FILE (#52.3)
