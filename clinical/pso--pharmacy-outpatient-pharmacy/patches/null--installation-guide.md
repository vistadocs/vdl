...
patch_id: null
group_key: null
description: '''05/05/2021 1.0.1.2 PSO*7*633: Update CMOP SharePoint URL to new VA Share site for Med Guide retrieval. Moved Adobe custom modification section to the Adobe installation section of the document per field input request. Updated JAVA installation notes table to include a step to copy the...'''
