---
title: PSO*7*207 Remote Data Interoperability (RDI) Project Release Notes
doc_type: RN
...
<tbody>
<tr class="odd">
<td>![](pso-7-207-remote-data-interoperability-rdi-project-release-notes/003.png)<strong>Note</strong>: Once the above patches have been installed, a new comment for remote order checks is displayed: “Now doing remote order checks. Please wait..."<br />
<br />
