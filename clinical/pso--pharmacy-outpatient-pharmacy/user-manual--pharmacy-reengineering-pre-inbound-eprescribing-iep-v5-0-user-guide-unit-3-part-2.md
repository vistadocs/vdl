---
title: Pharmacy Reengineering (PRE) Inbound ePrescribing (IEP) Version 5.0 User Guide (Unit 3 Part 2) Updated PSO*7*667
doc_type: UG
doc_label: User Guide
doc_layer: anchor
doc_subject: (Unit 3 Part 2) Updated PSO*7*667
app_code: PSO
...
revision_newest: 
revision_oldest: 
docx_url: "https://www.va.gov/vdl/documents/Clinical/Pharm-Outpatient_Pharmacy/pso_7_0_um_32.docx"
pdf_url: "https://www.va.gov/vdl/documents/Clinical/Pharm-Outpatient_Pharmacy/pso_7_0_um_32.pdf"
...
title: |
  ...
  User Guide
---
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/001.png)
May 2022
...
<td>5.0</td>
<td><p>PSO*7.0*667:</p>
<p>Added screen captures for DEA Suffix Mismatch: <u>Figure 3.6‑24</u>, <u>Figure 3.6‑28</u>, <u>Figure 3.6‑53</u>, and <u>Figure 3.6‑61</u></p></td>
<td>Liberty ITS</td>
</tr>
<tr class="even">
<td>11/01/2021</td>
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/002.png)

<span id="_Toc104274826" class="anchor"></span>Figure ‑: Summary/Details Screen Actions
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/003.png)

<span id="_Toc104274827" class="anchor"></span>Figure ‑: Validate Patient
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/004.png)

<span id="_Toc104274828" class="anchor"></span>Figure ‑: Patient Validation Screen Display - Patient Not Validated/Not Auto Matched
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/005.png)

<span id="_Toc104274829" class="anchor"></span>Figure ‑: Patient Validation Screen Display - Patient Not Validated/Patient Auto Matched

If the VistA patient has known allergies, verified allergies display in the Allergies section.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/006.png)

<span id="_Toc104274830" class="anchor"></span>Figure ‑: VistA Patient with Known Allergies
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/007.png)

<span id="_Toc104274831" class="anchor"></span>Figure ‑: Patient Validated
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/008.png)

<span id="_Toc104274832" class="anchor"></span>Figure ‑: Edit Patient on a VistA Match
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/009.png)

<span id="_Toc104274833" class="anchor"></span>Figure ‑: Mismatch Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/010.png)

<span id="_Toc104274834" class="anchor"></span>Figure ‑: Confirm Acceptance of Patient Validation

A “\[v\]” displays to the right of the VistA Patient field on the Summary/Details screen.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/011.png)
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/012.png)

<span id="_Toc104274836" class="anchor"></span>Figure ‑: Patient Validation Unable To Validate Address Warning
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/013.png)
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/014.png)

<span id="_Toc104274838" class="anchor"></span>Figure ‑: Apply Patient Validation to Other eR<sub>X</sub>es
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/015.png)

<span id="_Toc104274839" class="anchor"></span>Figure ‑: Patient Validation Unable To Validate Address Warning
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/016.png)

<span id="_Toc104274840" class="anchor"></span>Figure ‑: Summary/Details Screen Action - Validate Provider
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/017.png)

<span id="_Toc104274841" class="anchor"></span>Figure ‑: Provider Not Auto Matched / Not Validated
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/018.png)

<span id="_Toc104274842" class="anchor"></span>Figure ‑: Modify Current VistA Provider
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/019.png)
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/020.png)

<span id="_Toc104274844" class="anchor"></span>Figure ‑: Select Provider DEA Expiration Date Message

CS NOTE: The following block message displays upon selecting the Provider if the Provider’s eRx DEA number is missing.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/021.png)

<span id="_Toc104274845" class="anchor"></span>Figure ‑: Select Provider Missing DEA Number Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/022.png)

<span id="_Toc104274846" class="anchor"></span>Figure ‑: Select VistA Provider Missing DEA Number Warning Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/023.png)

<span id="_Toc104274847" class="anchor"></span>Figure ‑: Select eRx Provider Missing DEA Number Warning Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/024.png)

<span id="_Toc104274848" class="anchor"></span>Figure ‑: Select Provider DEA Number Mismatch Warning Message

CS NOTE: The following warning message displays upon selecting the Provider if the eRx Provider’s DEA number matches the VistA DEA number on file, but contains a DEA suffix.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/025.png)

<span id="_Ref103323889" class="anchor"></span>Figure 3.6‑24: Select Provider DEA Number Suffix Mismatch Warning Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/026.png)

<span id="_Toc104274850" class="anchor"></span>Figure ‑: Select VistA Provider Not Authorized Warning Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/027.png)

<span id="_Toc104274851" class="anchor"></span>Figure ‑: Select VistA Provider Missing DEA Number Warning Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/028.png)

<span id="_Toc104274852" class="anchor"></span>Figure ‑: Select Provider Warning Message

CS NOTE: The following warning message displays upon selecting the validation if the eRx Provider’s DEA number matches the VistA DEA number on file, but the eRx Provider DEA contains a DEA suffix.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/029.png)

<span id="_Ref103323903" class="anchor"></span>Figure 3.6‑28: Accept Provider Validation Warning Message – DEA Suffix Mismatch

CS NOTE: The following block message displays upon selecting the validation if the Provider’s Vista DEA number is missing.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/030.png)

<span id="_Toc104274854" class="anchor"></span>Figure ‑: Select Provider Missing VistA DEA Number Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/031.png)

<span id="_Toc104274855" class="anchor"></span>Figure ‑: Select Provider Not Authorized Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/032.png)

<span id="_Toc104274856" class="anchor"></span>Figure ‑: Select eRx Provider Missing DEA Number Warning Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/033.png)

<span id="_Toc104274857" class="anchor"></span>Figure ‑: Select VistA Provider Missing DEA Number Warning Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/034.png)

<span id="_Toc104274858" class="anchor"></span>Figure ‑: Select Provider DEA Mismatch Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/035.png)

<span id="_Toc104274859" class="anchor"></span>Figure ‑: Select Provider Not Authorized Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/036.png)

<span id="_Toc104274860" class="anchor"></span>Figure ‑: Select VistA Provider Invalid Detox Number Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/037.png)

<span id="_Toc104274861" class="anchor"></span>Figure ‑: Before Provider Validation (Validate Provider Screen)

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/038.png)

<span id="_Toc104274862" class="anchor"></span>Figure ‑: After Provider Validation (Validate Provider Screen)

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/039.png)
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/040.png)

<span id="_Toc104274864" class="anchor"></span>Figure ‑: Automatic Provider Validation
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/041.png)

<span id="_Toc104274865" class="anchor"></span>Figure ‑: Validate Drug / SIG
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/042.png)
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/043.png)
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/044.png)
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/045.png)

<span id="_Toc104274869" class="anchor"></span>Figure ‑: Select Provider Not Authorized Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/046.png)

<span id="_Toc104274870" class="anchor"></span>Figure ‑: Select Provider Missing Valid Detox Number Warning Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/047.png)

<span id="_Toc104274871" class="anchor"></span>Figure ‑: Blocked Accept Validation Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/048.png)

<span id="_Toc104274872" class="anchor"></span>Figure ‑: Drug Validation Warning Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/049.png)

<span id="_Toc104274873" class="anchor"></span>Figure ‑: Drug Validation eRx without DS Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/050.png)

<span id="_Toc104274874" class="anchor"></span>Figure ‑: Drug Validation eRx without DS Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/051.png)

<span id="_Toc104274875" class="anchor"></span>Figure ‑: Drug Validation eRx with Invalid eRx Provider DEA Number Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/052.png)

<span id="_Toc104274876" class="anchor"></span>Figure ‑: Drug Validation eRx with Invalid VistA Provider DEA Number Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/053.png)

<span id="_Toc104274877" class="anchor"></span>Figure ‑: Drug Validation eRx with Provider DEA Number Mismatch Message

CS NOTE: The following warning message displays upon selecting an eRx that has a matching DEA number on file for the provider, but the eRx Provider’s DEA contains a DEA suffix.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/054.png)

<span id="_Ref103323922" class="anchor"></span>Figure 3.6‑53: Drug Validation eRx with Provider DEA Number Suffix Mismatch Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/055.png)

<span id="_Toc104274879" class="anchor"></span>Figure ‑: Drug Validation eRx Written After VistA Provider DEA Expiration Warning Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/056.png)

<span id="_Toc104274880" class="anchor"></span>Figure ‑: Drug Validation eRx VistA Provider Invalid DEA Number Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/057.png)

<span id="_Toc104274881" class="anchor"></span>Figure ‑: Drug Validation eRx VistA Provider Not Authorized Warning Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/058.png)

<span id="_Toc104274882" class="anchor"></span>Figure ‑: Drug Validation eRx VistA Provider Not Authorized Warning Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/059.png)

<span id="_Toc104274883" class="anchor"></span>Figure ‑: Confirm Acceptance of Drug / SIG Validation
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/060.png)

<span id="_Toc104274884" class="anchor"></span>Figure ‑: Drug Accept Validation eRx VistA Provider Not Authorized Block Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/061.png)

<span id="_Toc104274885" class="anchor"></span>Figure ‑: Drug Accept Validation eRx VistA Provider Not Authorized Block Message

CS NOTE: The following warning message displays upon selecting the eRx where the Provider’s DEA number matches the VistA DEA number on file, but the eRx Provider DEA contains a DEA suffix.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/062.png)

<span id="_Ref103323940" class="anchor"></span>Figure 3.6‑61: Drug Accept Validation eRx DEA Suffix Mismatch Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/063.png)
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/064.png)
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/065.png)
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/066.png)
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/067.png)

<span id="_Toc104274891" class="anchor"></span>Figure ‑: Accept eR<sub>X</sub> - Sample Validation Errors
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/068.png)

<span id="_Toc104274892" class="anchor"></span>Figure ‑: Accept eR<sub>X</sub>es

A message displays notifying the user that the eR<sub>X</sub> was sent to Pending Outpatient Orders for further processing.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/069.png)

<span id="_Toc104274893" class="anchor"></span>Figure ‑: eR<sub>X</sub>es Sent to Pending Outpatient Orders
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/070.png)

<span id="_Toc104274894" class="anchor"></span>Figure ‑: Rejecting an eR<sub>X</sub>

Once the eR<sub>X</sub> is rejected, the details of the reject message are available in the IEP Processing Hub as reference. Refer to Figure 3.13‑2.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/071.png)
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/072.png)

<span id="_Toc104274896" class="anchor"></span>Figure ‑: eRx has Do Not Fill Indicator Per Provider

The user will be prompted to select REMOVE or REJECT actions.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/073.png)

<span id="_Toc104274897" class="anchor"></span>Figure ‑: Do Not Fill Error Message
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/074.png)

<span id="_Ref5967635" class="anchor"></span>Figure ‑: Print Display of Non-Controlled Substance eR<sub>X</sub>

| ![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/075.png)![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/076.png)![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/077.png) |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

<span id="_Toc104274899" class="anchor"></span>Figure ‑: Print Display of Controlled Substance eR<sub>X</sub>
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/078.png)
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/079.png)

<span id="_Toc104274901" class="anchor"></span>Figure ‑: Select Hold Reason Code
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/080.png)

<span id="_Toc104274902" class="anchor"></span>Figure ‑: Hold Status and Reason

The hold status also displays in the “Status” column (STA) on the Holding Queue List screen.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/081.png)

<span id="_Toc104274903" class="anchor"></span>Figure ‑: Hold Status in Status Column
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/082.png)

<span id="_Toc104274904" class="anchor"></span>Figure ‑: Un Hold eR<sub>X</sub>
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/083.png)

<span id="_Toc104274905" class="anchor"></span>Figure ‑: Removing an eR<sub>X</sub>
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/084.png)

<span id="_Toc104274906" class="anchor"></span>Figure ‑: Search Queue Actions
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/085.png)

<span id="_Toc104274907" class="anchor"></span>Figure ‑: Search Criteria - Patient Name
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/086.png)

<span id="_Toc104274908" class="anchor"></span>Figure ‑: Patient Name Search
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/087.png)

<span id="_Toc104274909" class="anchor"></span>Figure ‑: Search eR<sub>X</sub> by Patient Name Results
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/088.png)

<span id="_Toc104274910" class="anchor"></span>Figure ‑: Search Criteria - Date of Birth

The search results in the following display:

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/089.png)

<span id="_Toc104274911" class="anchor"></span>Figure ‑: Search eR<sub>X</sub> by Date of Birth Results
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/090.png)

<span id="_Toc104274912" class="anchor"></span>Figure ‑: Search Criteria - Received Date Range
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/091.png)

<span id="_Toc104274913" class="anchor"></span>Figure ‑: Enter Beginning and Ending Date

The search results display.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/092.png)

<span id="_Toc104274914" class="anchor"></span>Figure ‑: Search eR<sub>X</sub> by Received Date Range
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/093.png)

<span id="_Toc104274915" class="anchor"></span>Figure ‑: Search Criteria - Provider Name

3.  Type the provider’s name and press \<Enter\>.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/094.png)

<span id="_Toc104274916" class="anchor"></span>Figure ‑: Enter Provider Name

The search results display.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/095.png)

<span id="_Toc104274917" class="anchor"></span>Figure ‑: Search eR<sub>X</sub> by Provider
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/096.png)

<span id="_Toc104274918" class="anchor"></span>Figure ‑: Search Criteria - ERX Status

The search results display.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/097.png)

<span id="_Toc104274919" class="anchor"></span>Figure ‑: Search by eR<sub>X</sub> Status
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/098.png)

<span id="_Toc104274920" class="anchor"></span>Figure ‑: Search Criteria - Drug Name

The search results display.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/099.png)

<span id="_Toc104274921" class="anchor"></span>Figure ‑: Search eR<sub>X</sub> by Drug Name
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/100.png)

<span id="_Toc104274922" class="anchor"></span>Figure ‑: Search Criteria - Message Type

The search results display.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/101.png)

<span id="_Toc104274923" class="anchor"></span>Figure ‑: Search by Message Type
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/102.png)

<span id="_Toc104274924" class="anchor"></span>Figure ‑: Search Criteria – eR<sub>X</sub> Reference Number: Inbound

The search results display.

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/103.png)

<span id="_Toc104274925" class="anchor"></span>Figure ‑: Search by eR<sub>X</sub> Reference Number Results – Inbound eR<sub>X</sub> Message Type
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/104.png)

<span id="_Toc104274926" class="anchor"></span>Figure ‑: Sort Entries Action
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/105.png)

<span id="_Toc104274927" class="anchor"></span>Figure ‑: Sort by Patient Name
...
3.  Enter Yes or No to group by Controlled Substance. If the user selects ‘Yes’, prescriptions are grouped by Controlled Substance for each sort. If the user selects ‘No’, the prescriptions are not grouped by a Controlled Substance for each sort.
    ...
    ![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/106.png)

<span id="_Toc104274928" class="anchor"></span>Figure ‑: Group by Controlled Substance
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/107.png)

<span id="_Toc104274929" class="anchor"></span>Figure ‑: Sort by Date of Birth

3.  Enter Yes or No to group by Controlled Substance. If the user selects ‘Yes’, prescriptions are grouped by Controlled Substance for each sort. If the user selects ‘No’, the prescriptions are not grouped by a Controlled Substance for each sort.

    ![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/108.png)

<span id="_Toc104274930" class="anchor"></span>Figure ‑: Group by Controlled Substance
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/109.png)

<span id="_Toc104274931" class="anchor"></span>Figure ‑: Sort by Received Date Range

3.  Enter Yes or No to group by Controlled Substance. If the user selects ‘Yes’, prescriptions are grouped by Controlled Substance for each sort. If the user selects ‘No’, the prescriptions are not grouped by a Controlled Substance for each sort.

    ![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/110.png)

<span id="_Toc104274932" class="anchor"></span>Figure ‑: Group by Controlled Substance
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/111.png)

<span id="_Toc104274933" class="anchor"></span>Figure ‑: Sort Criteria - Sort by Provider
...
1.  Enter Yes or No to group by Controlled Substance. If the user selects ‘Yes’, prescriptions are grouped by Controlled Substance for each sort. If the user selects ‘No’, the prescriptions are not grouped by a Controlled Substance for each sort.
    ...
    ![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/112.png)

<span id="_Toc104274934" class="anchor"></span>Figure ‑: Group by Controlled Substance
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/113.png)

<span id="_Toc104274935" class="anchor"></span>Figure ‑: Sort Criteria – Sort by eR<sub>X</sub> Status

3.  Enter Yes or No to group by Controlled Substance. If the user selects ‘Yes’, prescriptions are grouped by Controlled Substance for each sort. If the user selects ‘No’, the prescriptions are not grouped by a Controlled Substance for each sort.

    ![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/114.png)

<span id="_Toc104274936" class="anchor"></span>Figure ‑: Group by Controlled Substance
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/115.png)

<span id="_Toc104274937" class="anchor"></span>Figure ‑: Sort Criteria – Sort by Drug Name

3.  Enter Yes or No to group by Controlled Substance. If the user selects ‘Yes’, prescriptions are grouped by Controlled Substance for each sort. If the user selects ‘No’, the prescriptions are not grouped by a Controlled Substance for each sort.

    ![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/116.png)

<span id="_Toc104274938" class="anchor"></span>Figure ‑: Group by Controlled Substance
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/117.png)

<span id="_Toc104274939" class="anchor"></span>Figure ‑: Sort Criteria – Sort by Message Type

3.  Enter Yes or No to group by Controlled Substance. If the user selects ‘Yes’, prescriptions are grouped by Controlled Substance for each sort. If the user selects ‘No’, the prescriptions are not grouped by a Controlled Substance for each sort.

    ![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/118.png)

<span id="_Toc104274940" class="anchor"></span>Figure ‑: Group by Controlled Substance
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/119.png)

<span id="_Toc104274941" class="anchor"></span>Figure ‑: eR<sub>X</sub> Received from External Provider
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/120.png)

<span id="_Toc104274942" class="anchor"></span>Figure ‑: Hidden Option EP / Print Display of eR<sub>X</sub>
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/121.png)

<span id="_Toc104274943" class="anchor"></span>Figure ‑: eR<sub>X</sub> Display in Pending Queue - Page 1
...
![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/122.png)

<span id="_Toc104274944" class="anchor"></span>Figure ‑: eR<sub>X</sub> Order in Pending Queue – Page 2

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/123.png)

<span id="_Toc104274945" class="anchor"></span>Figure ‑: eR<sub>X</sub> Order in Pending Queue - Page 3

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/124.png)

<span id="_Toc104274946" class="anchor"></span>Figure ‑: eR<sub>X</sub> Order in Pending Queue - Page 4

![](pharmacy-reengineering-pre-inbound-eprescribing-iep-version-5-0-user-guide-unit-/125.png)

<span id="_Toc104274947" class="anchor"></span>Figure ‑: eR<sub>X</sub> Order in Pending Queue - Page 5
