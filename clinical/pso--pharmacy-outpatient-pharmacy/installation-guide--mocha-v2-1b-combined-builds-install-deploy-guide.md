---
title: MOCHA Version 2.1b Combined Builds Install Deploy Guide
doc_type: IG
doc_label: Installation Guide
doc_layer: anchor
doc_subject: b Combined Builds Install Deploy Guide
app_code: PSO
...
revision_newest: 
revision_oldest: 
docx_url: "https://www.va.gov/vdl/documents/Clinical/Pharm-Inpatient_Med/mocha_2-1b_cb_deploy_install_bo_rb_guide.docx"
pdf_url: "https://www.va.gov/vdl/documents/Clinical/Pharm-Inpatient_Med/mocha_2-1b_cb_deploy_install_bo_rb_guide.pdf"
...
![](mocha-version-2-1b-combined-builds-install-deploy-guide/001.png)
...
![](mocha-version-2-1b-combined-builds-install-deploy-guide/002.png) Note: Installation of MOCHA 2.1b is completed. The following procedure is to be followed only if MOCHA 2.1b needs to be backed out.
...
|---------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|
| ![](mocha-version-2-1b-combined-builds-install-deploy-guide/003.png) |                                                                                               |
