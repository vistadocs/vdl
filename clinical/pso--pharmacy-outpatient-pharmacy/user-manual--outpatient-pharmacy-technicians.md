---
title: Outpatient Pharmacy Version 7 Technician's User Manual (updated PSO*7*779)
doc_type: UM
doc_label: User Manual
doc_layer: anchor
doc_subject: Technician's (updated PSO*7*779)
app_code: PSO
...
docx_url: https://www.va.gov/vdl/documents/Clinical/Pharm-Outpatient_Pharmacy_Archive/pso_7_tech_um_1.docx
pdf_url: https://www.va.gov/vdl/documents/Clinical/Pharm-Outpatient_Pharmacy_Archive/pso_7_tech_um.pdf
app_url: https://www.va.gov/vdl/application.asp?appid=394
audit_applied: '2026-05-31'
master_source: Outpatient Pharmacy Version 7 Technician's User Manual (updated PSO*7*779)
master_pub_date: December 1997
consolidated_from: 2 versions
prior_versions:
- Outpatient Pharmacy Version 7 Technician's User Manual (updated PSO*7*737)
consolidated_title: outpatient pharmacy technician's user manual
---

Outpatient Pharmacy (PSO)Technician's User Manual

![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/001.png)
...
<td>PSO*7*753</td>
<td><ul>
<li><p>Added <a href="#EDITING_MAIL_EXEMPTION">Editing the Mail Exemption</a></p></li>
<li><p>Added <a href="#MailExemptionIndicatorText">the Mail Exemption indicator text</a></p></li>
<li><p>Added <a href="#OTH_MAIL_EXEMPTION">Mail Exemption to Other OP Actions [OTH]</a></p></li>
<li><p>Added <a href="#SpeedMailExemption">the Speed Mail Exemption action</a></p></li>
</ul></td>
</tr>
<tr class="odd">
<td>07/2024</td>
<td>PSO*7*704</td>
<td><a href="#p117">Renamed Sex to Birth Sex and added Self-Identified Gender after Birth Sex on the ePharmacy Reject Notification Screen</a></td>
</tr>
<tr class="even">
<td>04/2024</td>
<td>PSO*7*736</td>
...
<ul>
<li><p>Updated <u>Chapter 1: Introduction</u></p></li>
<li><p>Updated <u>Chapter 8: Using the Medication Profile</u></p></li>
<li><p>Updated</p></li>
<li><p><u>Chapter 9: Processing a Prescription</u>Updated <u>Glossary</u></p></li>
</ul></td>
</tr>
<tr class="odd">
<td>02/2024</td>
<td>PSO*7*739</td>
<td>Added a note for <a href="#titration">Titration</a></td>
</tr>
<tr class="even">
<td>12/2023</td>
<td>PSO*7*700</td>
<td>Added <a href="#chapter-inbound-eprescribing">Inbound ePrescribing Section</a></td>
</tr>
<tr class="odd">
<td>11/2023</td>
<td>PSO*7*731</td>
<td>Removed references to Detox Number (#) on pages <a href="#p160"><u>156</u></a> and <a href="\l"><span><u>165</u></span></a></td>
</tr>
<tr class="even">
<td>11/2023</td>
<td>PSO*7*712</td>
<td><ul>
<li><p>Added a note for <a href="#parked_note_tech_um">Parked prescription refill</a></p></li>
</ul>
<ul>
<li><p>Adjusted heading levels in Chapter 9</p></li>
</ul></td>
</tr>
<tr class="odd">
<td>04/2023</td>
...
<p>Updated <a href="#oneva-pharmacy-and-the-medication-profile">OneVA Pharmacy and the Medication Profile</a> section</p>
<p>Updated <a href="#oneva-pharmacy-processing-within-patient-prescription-processing">OneVA Pharmacy Processing within Patient Prescription Processing</a> section</p>
<p>Updated <a href="#oneva-prescription-refillpartial-fill-activity-log-entries">OneVA Prescription Refill/Partial Fill Activity Log Entries</a> section</p>
<p>REDACTED</p></td>
</tr>
<tr class="even">
<td>09/2022</td>
<td>PSO*7*441</td>
<td><p>Added new section: <a href="#p441_Section_Adding_Indication_NewOrder">Adding Indication to a New Order</a>, with description and two examples</p>
<p>Added new section: <a href="#update-an-indication-on-an-active-order">Update an Indication on an Active Order</a>, with description and one example</p>
<p>Added new section: <a href="#park-and-unpark-a-prescription">Park and UnPark a Prescription</a>, with description, two notes and six examples</p>
<p>Added new section: <a href="#finishing-a-pending-order-with-indications">Finishing a Pending Order with Inidications</a>, with description and one example</p>
<p>Redacted names from Revision Table</p></td>
</tr>
<tr class="odd">
<td>07/2021</td>
<td>PSO*7*630</td>
<td>Added <a href="#chapter-meds-by-mail-virtual-pharmacy-services">Chapter 14: Meds by Mail</a> – Virtual Pharmacy Services</td>
</tr>
<tr class="even">
<td>07/2021</td>
<td>PSO*7*524</td>
...
<td>6/2020</td>
<td>PSO*7*477</td>
<td><p>Added a note about the EXCEPT conjunction: <a href="#p477_36_Except_note"><u>31</u></a>, <a href="#p477_133_Except_no_copy_ref"><u>130</u></a>, <a href="#p477_143_Except_no_copy_ref"><u>144</u></a></p>
<p>Removed references to EXCEPT conjunction: <a href="#p477_116_Remove_Except_ref"><u>110</u></a></p>
<p>REDACTED</p></td>
</tr>
<tr class="even">
<td>2/2019</td>
...
<td>12/2016</td>
<td>PSO*7*460</td>
<td><p>Updated copay activity log for Fixed Medication Copayment Tiers REDACTED</p>
...
- [Chapter : List Manager](#chapter-list-manager)
...
- [# Chapter : Using the Pharmacy Technician's Menu](#chapter-using-the-pharmacy-technicians-menu)
- [Patient Lookup](#patient-lookup)
- [Chapter : Using the Bingo Board User Menu](#chapter-using-the-bingo-board-user-menu)
...
- [Chapter : Changing the Label Printer](#chapter-changing-the-label-printer)
- [Change Label Printer](#change-label-printer)
- [Chapter : Check Drug Interaction](#chapter-check-drug-interaction)
- [Check Drug Interaction](#check-drug-interaction)
- [Chapter : Creating, Editing, and Printing a DUE Answer Sheet](#chapter-creating-editing-and-printing-a-due-answer-sheet)
- [DUE User](#due-user)
...
- [Chapter : Using the Medication Profile](#chapter-using-the-medication-profile)
...
- [Chapter : Processing a Prescription](#chapter-processing-a-prescription)
- [Patient Prescription Processing](#patient-prescription-processing)
  - [Order Check Types and Sequence](#order-check-types-and-sequence)
    ...
    - [Clinic Orders Order Checks](#clinic-orders-order-checks)
    - [Duplicate Drug Order Check](#duplicate-drug-order-check)
  - [CPRS Auto Refill](#cprs-auto-refill)
  - [Verification Site Parameter](#verification-site-parameter)
  - [Outpatient Pharmacy Hidden Actions](#outpatient-pharmacy-hidden-actions-1)
  - [Patient Address](#patient-address)
  - [OneVA Prescription Refill/Partial Fill Activity Log Entries](#oneva-prescription-refillpartial-fill-activity-log-entries)
  - [Outpatient Allergy Order Entry Process](#outpatient-allergy-order-entry-process)
  - [CPRS Allergy Entry Process](#cprs-allergy-entry-process)
  ...
  - [Entering a New Order](#entering-a-new-order)
    ...
    - [Displaying a Patient's Remote Prescriptions](#displaying-a-patients-remote-prescriptions)
  ...
  - [Adding Indication to a New Order](#adding-indication-to-a-new-order)
  - [Update an Indication on an Active Order](#update-an-indication-on-an-active-order)
  - [Park and UnPark a Prescription](#park-and-unpark-a-prescription)
  - [Renewing a Prescription](#renewing-a-prescription)
  - [Renewing an ePharmacy Order](#renewing-an-epharmacy-order)
- [Chapter : Pull Early from Suspense](#chapter-pull-early-from-suspense)
- [Pull Early from Suspense](#pull-early-from-suspense)
- [Chapter : Queue CMOP Prescription](#chapter-queue-cmop-prescription)
- [Queue CMOP Prescription](#queue-cmop-prescription)
- [Chapter : Releasing Medication](#chapter-releasing-medication)
...
- [Chapter : Updating a Patient's Record](#chapter-updating-a-patients-record)
- [Update Patient Record](#update-patient-record)
- [# Chapter : Meds by Mail – Virtual Pharmacy Services](#chapter-meds-by-mail-virtual-pharmacy-services)
- [Chapter 15: CPRS Order Checks: How They Work](#chapter-15-cprs-order-checks-how-they-work)
  ...
  - [Hash Counts and DEA Certification](#hash-counts-and-dea-certification)
    - [Finishing a Pending Order with Indications](#finishing-a-pending-order-with-indications)
- [Chapter : Error Messages](#chapter-error-messages)
  - [Error Information](#error-information)
  - [Three Levels of Error Messages](#three-levels-of-error-messages)
- [Chapter : Inbound ePrescribing](#chapter-inbound-eprescribing)
- [Glossary](#glossary)
- [Index](#index)
...
The OneVA Pharmacy patch PSO\*7\*736 replaced the query to the Health Data Repository/Clinical Data Service (HDR/CDS) repository with a query to the Veterans Data Integration Information Exchange (VDIF). This patch also includes modifications to the "PROVIDER HOLD" status abbreviation from "PH" to "HP" and also adds "DISCONTINUED BY PROVIDER", "DISCONTINUED (EDIT)", and "NON-VERIFIED" statuses for display on the patient's medication profile for remote prescriptions.
...
<tr class="odd">
<td>![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/002.png)Indicates especially important or helpful information.</td>
<td><blockquote>
<p>![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/003.png)Up to four of the last LAB results can be displayed in the message.</p>
</blockquote></td>
</tr>
<tr class="even">
<td><blockquote>
<p>![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/004.png)Indicates that options are locked with a particular security key. The user must hold the particular security key to be able to perform the menu option.</p>
</blockquote></td>
<td>![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/005.png)This option requires the security key PSOLOCKCLOZ.</td>
</tr>
</tbody>
</table>
...
> 11 3012001x PRESTANUS 1% SOL 1 DA 02-03 02-03 5 30
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/006.png)A "B" will be appended to the above statuses if the Bad Address Indicator was set and there was no active temporary address at the time of the last label activity.
...
Prescription-levelMail ExemptionIndicator: <span id="MailExemptionIndicatorText" class="anchor"></span>Patch PSO\*7.0\*753 adds a new indicator 'x' at the end of each prescription number in the Medication Profile screen when a value has been entered for the prescription Mail Exemption field (22) on the OP Medications screen or via the OTH-\>EX hidden menu option.
...
PC Provider: REDACTED Position: PROV GREEN 7
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/007.png)Not all functionality displayed in this section (i.e., hidden and speed actions) is available to pharmacy technicians.
...
> EX Mail Exemption for Prescription

> MR Multi Rx Request Print

> NV Non VA Meds Report

> RR RxRenewal Request

<span id="OTH_MAIL_EXEMPTION" class="anchor"></span>Patient Information \[PI\] Shows patient information, allergies, adverse reactions, and pending clinic appointments.

Pull Rx \[PP\] Action taken to pull prescription(s) early from suspense.

Reprint \[RP\] Reprints the label.

> ![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/008.png) Note: The Reprint function is not enabled for OneVA Pharmacy labels. To reprint a OneVA Pharmacy label execute a OneVA Pharmacy partial.
...
<p>![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/009.png) <strong>Note:</strong> The Reprint function is not enabled for OneVA Pharmacy labels. To reprint a OneVA Pharmacy label execute a OneVA Pharmacy partial.</p></td>
</tr>
<tr class="even">
<td>Renew [RN]</td>
...
<tr class="even">
<td><span id="SpeedMailExemption" class="anchor"></span>Mail Exemption for Prescription [EX]</td>
<td>Action that adds a Mail Exemption to prescriptions which override the patient level mail preference.</td>
</tr>
</tbody>
</table>
...
<p>![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/011.png)<strong>Note:</strong> For additional information regarding OneVA Pharmacy PR processing go to the VA Software Document Library (VDL), select the Clinical section then choose the "Pharm: Outpatient Pharmacy" page. Locate the "User Manual – OneVA Pharmacy" document.</p></td>
</tr>
</tbody>
</table>

# # Chapter : Using the Pharmacy Technician's Menu
...
# Chapter : Using the Bingo Board User Menu
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/012.png)It is recommended that a patient's name be removed from the monitor as soon as the prescription is picked up.
...
# Chapter : Changing the Label Printer
...
# Chapter : Check Drug Interaction 
...
Display Professional Interaction monograph? N//

# Chapter : Creating, Editing, and Printing a DUE Answer Sheet
...
# Chapter : Using the Medication Profile
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/013.png)Note: For additional information regarding OneVA Pharmacy processing go to the [Outpatient folder](https://www.va.gov/vdl/application.asp?appid=90) on the VA Software Document Library ([VDL](https://www.va.gov/vdl/)). Locate the " OneVA Pharmacy User Manual" document.
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/014.png)Note: For additional information regarding OneVA Pharmacy processing go to the [Outpatient folder](https://www.va.gov/vdl/application.asp?appid=90) on the VA Software Document Library ([VDL](https://www.va.gov/vdl/)). Locate the "OneVA Pharmacy User Manual" document.
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/015.png)
...
# Chapter : Processing a Prescription
...
> ![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/016.png) If the order utilizes the <span id="p477_36_Except_note" class="anchor"></span>EXCEPT conjunction, copy, renew, and reinstate will no longer be allowed.
...
## Order Check Types and Sequence 
...
> **NOTE:** Severity for an allergy can ONLY be entered for (O)bserved and NOT (H)istorical Allergy/Adverse Reactions and the user MUST HOLD the GMRA-ALLERGY VERIFY key and complete an observed reaction report to enter MECHANISM and SEVERITY for Observed types of Allergy/Adverse Reactions.
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/017.png)
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/018.png)For the *Patient Prescription Processing,* if a temporary address has no end date, the following text is displayed in the Status column: "(Temp address from XXX 99,9999 till (no end date))".

## OneVA Prescription Refill/Partial Fill Activity Log Entries

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

Patch PSO\*7\*643 brought in new and enhanced existing activity log entries to provide an audit trail for OneVA refills and partial fills sent through the OPAI to an OPAI supported external automated dispensing robot for dispensing. Activity log and label log entries document the facility name and station number where the OneVA refill/partial fill was dispensed. The 'Initiator of Activity' was corrected to reflect the remote pharmacist's name instead of 'Postmaster'. Entries 4-5 illustrate a OneVA refill filled at a dispensing site DAYTSHR TEST LAB (984). Entries 6-9 illustrate a OneVA partial filled at a dispensing site, CHYSHR (983) which has multiple ADDs.

Host Site Activity Log entries for a OneVA refill and Partial filled at Dispensing Site.

<u>Rx Activity Log Nov 30, 2021@11:31:15 Page: 1 of 3</u>

PSOPATIENT,ONE \<NO ALLERGY ASSESSMENT\>

PID: REDACTED Ht(cm): 167.64 (11/05/2021)
...
1 10/25/21 ORIGINAL PHARMACIST,LOCAL

Comments: From RX number 2722091

2 11/15/21 REFILL 1 PHARMACIST,DAYTSHR

Comments: From RX number 2722091

Printed at DAYTSHR TEST LAB (984)

3 11/30/21 REFILL 98 PHARMACIST,CHYSHR

Comments: From RX number 2722091 (Partial)

Printed at CHYSHR(983)
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/019.png)

Example of Historical Allergy:

![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/020.png)

Example of Observed Allergy:

![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/021.png)

## OneVA Pharmacy Processing within Patient Prescription Processing

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/022.png)Note: For information regarding OneVA Pharmacy processing go to the [Outpatient](https://www.va.gov/vdl/application.asp?appid=90) folder on the VA Software Document Library ([VDL](https://www.va.gov/vdl/)). Locate the *OneVA Pharmacy User Manual*.

OneVA Pharmacy queries VDIF for prescriptions from other VA Pharmacy locations and displays them in the Medications Profile view. The query will only execute if the patient has been treated at more than one VA Medical Center. The query retrieves all prescriptions associated with the patient from the repository, which requires additional time. To execute the query to VDIF, the user must accept the default of 'YES' to the 'Would you like to query prescriptions from other OneVA Pharmacy locations?' prompt. When the user responds 'YES' or accepts the default to the OneVA Pharmacy prompt, the system displays the OneVA Pharmacy Query Message.

![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/023.png)The OneVA Pharmacy's feature to query VDIF will not execute if the patient has only one entry in the 'TREATING FACILITY LIST file (#391.91)'.

![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/024.png)The system identifies and queries VDIF for all the prescriptions that are active, suspended, on hold, expired (within 120 days), or discontinued (within 120 days).

![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/025.png) <span id="PSO_532_OneVAPharmPatRxProcess" class="anchor"></span>If the query connection to VDIF fails, a message will display stating 'The system is down or not responding (Connection Failed). Could not query prescriptions at other VA Pharmacy locations. Press RETURN to continue:' The user should press return to continue and contact local support if this problem persists.

![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/026.png)When the system is down message displays, the VistA session will continue to display the local/dispensing sites prescriptions on the Medication Profile view. There will be no indication if a patient is registered or has prescriptions on other sites (i.e., remote site/OneVA Pharmacy prescriptions will not display on the Medication Profile view.)

![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/027.png)If the patient does not have any prescription records from other VA Pharmacy locations, matching the search criteria, a message will display stating the "Patient found with no prescription records matching search criteria."

![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/028.png)The OneVA Pharmacy patch PSO\*7\*643 introduces the sending of OneVA Rx refills/partial fills to the Outpatient Pharmacy Automated Interface (OPAI) to be filled by an OPAI supported external automated dispensing robot when a OneVA Rx refill or partial is processed. The user is not prompted with whether or not to send the refill/partial fill to the OPAI. Whether or not the OneVA Rx refill/partial fill is sent to the OPAI is determined by the EXTERNAL INTERFACE parameter setting in the OUTPATIENT SITE File (#59). Additional parameters in the OUTPATIENT SITE File (#59) and DRUG File (#50) determine what Automated Dispensing Devices the refill/partial fill is routed to if more than one OPAI supported external automated dispensing robot is associated with an Outpatient site.
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/029.png)Note: A prescription can be unmarked as Titration/Maintenance by invoking the same TM action on an already marked prescription.

> ![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/030.png)Note: Marking a controlled substance Rx as a Titration prescription will prevent refills and renewals. You will not be able to convert the Rx to maintenance prescription by the TR Hidden Action.
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/031.png)If RDI is active and a patient has prescriptions at another location, when the user selects the patient to enter a new order from Patient Prescription Processing, the following message appears.
...
> With patch PSO\*7.0\*753, prescription-level mail exemptions on file at the time of the copy are copied over to the new prescription.

![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/032.png)
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/033.png)
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/034.png)
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/035.png)Please refer to the *Dosing Order Checks User Manual* for a detailed description of dosing order checks.
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/036.png)
...
<span id="p117" class="anchor"></span>Example: Handling a Rejected New Order for ePharmacy Billing
...
Birth Sex: M Self-Identified Gender:
...
<span id="EDITING_MAIL_EXEMPTION" class="anchor"></span>Editing the Mail Exemption*<u>OP Medications screen</u>*

Patch PSO\*7.0\*753 adds a new Mail Exemption field (22) on the OP Medications screen. The Mail Exemption provides the ability to select on an individual basis, whether a prescription in the PRESCRIPTION (#52) file should be filled locally or be filled through CMOP. The baseline system capability is that the mail preferences (window only, regular including CMOP, certified including CMOP, regular local only, certified local only) are a patient level property stored in the PHARMACY PATIENT (#55) file. This enhancement retains the same baseline capability of the PHARMACY PATIENT file, and additionally offers an exemption at the prescription level as an exemption to the baseline.

To edit the Mail Exemption field, enter 22 on the OP Medications screen. In example below the mail property for the prescription has been changed from Local – Regular to Local – Certified. The mail property for the prescription is now Local – Certified regardless of what the baseline patient level mail property is.

OP Medications (ACTIVE) Jan 31, 2024@14:14:31 Page: 1 of 3

PSOPATIENT,ONE \<NO ALLERGY ASSESSMENT\>

PID: 666-00-0714 Ht(cm): \_\_\_\_\_\_\_ (\_\_\_\_\_\_)

DOB: JAN 23,1950 (74) Wt(kg): \_\_\_\_\_\_\_ (\_\_\_\_\_\_)

SEX: MALE

CrCL: \<Not Found\> (CREAT: 122mg/dL 11/5/98) BSA (m2): \_\_\_\_\_\_\_

Rx \#: 100002952

\(1\) \*Orderable Item: ASPIRIN TAB

\(2\) Drug: ASPIRI 325MG TAB
...
SIG: TAKE ONE TABLET EVERY EVENING OTHER

\(5\) Patient Status: SC LESS THAN 50%

\(6\) Issue Date: 01/26/24 (7) Fill Date: 01/26/24

Last Fill Date: 01/26/24 (Window)

Last Release Date: (8) Lot \#:

Expires: 02/25/24 MFG:

\(9\) Days Supply: 30 (10) QTY ( ): 30

\(11\) \# of Refills: 0 Remaining: 0

\(12\) Provider: PROVIDER,ONE

\(13\) Routing: WINDOW (14) Copies: 1

Method of Pickup:

\(15\) Clinic: BECKY'S CLINIC
...
\(22\) Mail Exemption: LOCAL - REGULAR

Finished By: BRICKER,BURTON DENNIS

Entry By: BRICKER,BURTON DENNIS Entry Date: 01/26/24 12:36:29
...
Select Action: Quit// 22

MAIL EXEMPTION: LOCAL - REGULAR// ?

Choose the Mail Exemption for patient's Rx.
...
MAIL EXEMPTION: LOCAL - REGULAR// 4 LOCAL - CERTIFIED

Are You Sure You Want to Update Rx 100002952? Yes//

*<u>Medication Profile – OTH OP Actions - EX</u>*

Patch PSO\*7.0\*753 adds a new sub-action, Mail Exemption for Prescription \[EX\], to the hidden action Other OP Actions \[OTH\] on the Medication Profile screen to allow the user to override the patient level mail preference for one or more prescriptions. In the example below, the patient level mail preference is displayed for context. Orders \#3 and \#4 currently do not have Mail Exemptions and are selected. Mail Exemption 2 DO NOT MAIL is selected and applied to the orders. Note: Exemption additions and updates are logged in the Rx Activity Log.
...
Select Item(s): EX Mail Exemption for Prescription

Prescription Mail Delivery(patient level): Certified Mail

\# RX \# DRUG MAIL EXEMPTION

-------------------------------------ACTIVE-------------------------------------

1 300476x ACETIC ACID 2% OTIC SOL 15 ML 2-DO NOT MAIL

2 300472x ASPIRIN 325MG TAB 3-LOCAL - REGULAR

3 300458J ATORVASTATIN CALCIUM 10MG TAB

4 300473 FISH OIL 1000MG (500MG DHA/EPA) CAP,ORAL

Select Orders by number: (1-4): 3,4

For Pharmacy Order Mail Exemptions enter:
...
@ for DELETE EXEMPTION VALUE

^ or Enter for Exit

Select Mail Exemption: 2 DO NOT MAIL
...
3 300458Jx ATORVASTATIN CALCIUM 10MG TAB 2-DO NOT MAIL

4 300473x FISH OIL 1000MG (500MG DHA/EPA) CAP,ORAL 2-DO NOT MAIL

*<u>Medication Profile – Indicator 'x'</u>*
...
1 300476x ACETIC ACID 2% OTIC SOL 15 ML 1 A\> 06-14 06-14 5 31

2 300488x ASPIRIN 325MG TAB 31 A 06-26 06-26 5 31

*<u>Patient Update Screen</u>*

Patch PSO\*7.0\*753 added a feature to delete existing prescription level Mail Exemption for prescriptions in the status of Active, Non-Verified, Refill, Hold, Drug Interactions, or Suspended when the patient level mail preference field is changed using the Patient Update (PU) action. Prescription Mail Exemption deletions are logged in the Rx Activity Log. An informational message depicting the edited prescriptions along their deleted Mail Exemption information is displayed to the user when there are existing prescription level mail exemptions, and a change is made to the patient level mail preference as shown in the example below:

MAIL: DO NOT MAIL// 1 CERTIFIED MAIL

The patient-level MAIL preference has been changed to CERTIFIED MAIL.

Exemptions set on the following prescriptions will be removed.

Edit these prescriptions to reinstate the exemptions if necessary.

300476 ACETIC ACID 2% OTIC SOL 15 ML REGULAR MAIL

300472 ASPIRIN 325MG TAB CERTIFIED MAIL

300458J ATORVASTATIN CALCIUM 10MG TAB LOCAL - REGULAR

300473 FISH OIL 1000MG (500MG DHA/EPA) CAP,ORAL LOCAL - CERTIFIED
...
> ![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/037.png) If the order utilizes the <span id="p477_133_Except_no_copy_ref" class="anchor"></span>EXCEPT conjunction, copy will no longer be allowed. The message bar will display: Cannot COPY. Invalid 'except' conjunction!
...
PID: 000-24-0000 Ht(cm): 177.80 (02/08/1999)
...
PID: 000-01-0022P Ht(cm): \_\_\_\_\_\_\_ (\_\_\_\_\_\_)
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/038.png)
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/039.png)
...
PID: 000-00-0286 Ht(cm): \_\_\_\_\_\_\_ (\_\_\_\_\_\_)
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/040.png)
...
## Adding Indication to a New Order

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

With patch PSO\*7\*441, the user will be prompted for Indication. The list of indications listed is retrieved from the Pharmacy Orderable item file (#50.7) field \#14 MOST COMMON INDICATION FOR USE and field \#13 INDICATION FOR USE subfile (#50.713). Indication is not a required field in backdoor but is a required field in CPRS. Once an indication is selected or free text entered, the user is prompted to copy the indication to the SIG. Patch PSS\*1\*187 added the prompt for Copy INDICATION into the SIG? YES/NO. The prompt is retrieved from the Pharmacy System file (#59.7) field \#96 COPY INDICATION TO SIG.
...
1 TO LOWER CHOLESTEROL

2 FOR CHOLESTEROL

3 FOR CHOLESTEROL TREATMENT

99 Free Text entry

Select INDICATION from the list: 1 TO LOWER CHOLESTEROL

TO LOWER CHOLESTEROL

Copy INDICATION into the Sig? YES//

(TAKE ONE TABLET BY MOUTH EVERY MORNING TO LOWER CHOLESTEROL)

Patch PSO\*7\*441 added if Park is enabled, then Mail/Window Routing will list Park as an option.
...
MAIL/WINDOW/PARK: WINDOW// \<Enter\> WINDOW

## Update an Indication on an Active Order

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

When updating an Indication on an Active Order, the Indication field can be edited using the PATIENT INSTRUCTION item 4 in the screen below.

Example: Updating an Indication on an Active Order

OP Medications (ACTIVE) Feb 04, 2022@08:16:27 Page: 1 of 3

CPRSPATIENT,ONE \<A\>

PID: 000-06-0000 Ht(cm): \_\_\_\_\_\_\_ (\_\_\_\_\_\_)

DOB: APR 15,1953 (68) Wt(kg): \_\_\_\_\_\_\_ (\_\_\_\_\_\_)

SEX: MALE Non-VA Meds on File Last entry on 02/02/22
...
Indications: TO REDUCE CHOLESTEROLSIG: TAKE ONE TABLET BY MOUTH EVERY EVENING TO REDUCE CHOLESTEROL

\(5\) Patient Status: SC

\(6\) Issue Date: 02/02/22 (7) Fill Date: 02/04/22

Last Fill Date: 02/04/22 (Mail)
...
Select Action: Next Screen// 4

PATIENT INSTRUCTIONS:

INDICATION:1 REDUCE CHOLESTEROL2 TO TREAT HIGH CHOLESTEROL99 Free Text entry

Select INDICATION from the list: 99// 2 TO TREAT HIGH CHOLESTEROL

TO TREAT HIGH CHOLESTEROL

Copy INDICATION into the Sig? YES//

Are You Sure You Want to Update Rx 502569? Yes// OP Medications (ACTIVE) Feb 04, 2022@08:18:59 Page: 1 of 3

CPRSPATIENT,ONE \<A\>

PID: 666-06-1001 Ht(cm): \_\_\_\_\_\_\_ (\_\_\_\_\_\_)
...
Indications: TO TREAT HIGH CHOLESTEROLSIG: TAKE ONE TABLET BY MOUTH EVERY EVENING TO TREAT HIGH CHOLESTEROL
...
## Park and UnPark a Prescription
...
AL Activity Logs (OP) OTH Other OP Actions \> Shift View to Right

VF Verify (OP) REJ View REJECT ADPL Auto Display(On/Off)

CO Copy (OP) VER View ePharmacy Rx DN Down a Line

TR Convert Titration Rx RES Resubmit Claim FS First Screen

TM Titration Mark/UnmarkREV Reverse Claim GO Go to Page

RP Reprint (OP) IN Intervention Menu LS Last Screen

HD Hold (OP) DA Display Drug AllergiesPL Preg/Lact Display

UH Unhold (OP) DIN Drug Restr/Guide (OP)PS Print Screen

PK Park (OP) EP Print eRx PT Print List

UPK Unpark (OP) ECS Edit Claim Submitted QU Quit

PI Patient Information JE Jump to eRx RD Re Display Screen

PP Pull Rx (OP) + Next Screen SL Search List

IP Inpat. Profile (OP) - Previous Screen UP Up a Line

BY Bypass 3/4 Day Supply\< Shift View to Left

Type \<Enter\> to continue or '^' to exit:

Use the Park (PK) action to put a prescription that is part of the patient's current expected medication regimen on hold until the fill is requested. Use the Unpark (UPK) action to remove a prescription from hold and fill the prescription.

![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/041.png)Park is only valid for drugs that are not marked as 'D' in the DEA Special Handling field in the drug file.

> ![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/042.png) If a <span id="parked_note_tech_um" class="anchor"></span>Parked prescription original fill or the refill is not released (i.e., the label not printed, or it is not processed by CMOP) the refill options through backdoor, CPRS, Audiocare, MyHealtheVet, and Customer Relationship Manager (CRM) etc., are processed and the prescription status is set to Suspended. Otherwise, the current logic in refilling the prescription is followed.

Only key holders of the PSORPH security key or the PSO TECH ADV security key can Park or Unpark a prescription.

Each time a user Park or Unpark a prescription, an entry is created in the Activity Log.

Example: PARK Message on the Status Line with PSO TECH ADV or PSORPH Security Key

OP Medications (ACTIVE) Feb 04, 2022@07:46:24 Page: 1 of 3

CPRSPATIENT,ONE \<A\>

PID: 000-06-1001 Ht(cm): \_\_\_\_\_\_\_ (\_\_\_\_\_\_)
...
\(2\) CMOP Drug: SIMVASTATIN 80MG TAB
...
(4)Pat Instructions: PSO PAT INSTRUCTION

Indications: PSO PSO FOR CHLOLESTROL
...
Select Action: Next Screen// PK PK

----------------------

Medication Profile Feb 04, 2022@07:52:12 Page: 1 of 3
...
1 502174 DANTROLENE NA 25MG CAP 30 S\> 02-18 02-17 1 30

2 502175 FLUPHENAZINE HCL 1MG TAB 30 A\> 03-31 03-31 3 30

3 502476 LORATADINE 10MG TAB 117 AP\>12-27 - 3 30

4 502382 NIACIN 50MG TAB 90 AP\>04-13 - 3 90

5 502245 SIMVASTATIN 80MG TAB 30 AP\>05-21 - 2 30

6 502246 WARFARIN (C0UMADIN) NA 1MG TAB 30 AP 05-25 - 5 30

----------------------------------DISCONTINUED----------------------------------

7 502147 SIMVASTATIN 5MG TAB 30 DA\>10-09 10-09 3 30

------------------------------------PENDING-------------------------------------

\+ RX# 502245 placed in Active/Parked status.
...
Example: UNPARK Message on the Status Line with PSO TECH ADV or PSORPH Security Key

OP Medications (ACTIVE/PARKED)Feb 04, 2022@07:52:12 Page: 1 of 3
...
Select Action: Next Screen// UPK UPK

FILL DATE: FEB 4,2022// (FEB 04, 2022)
...
Medication Profile Feb 04, 2022@07:55:57 Page: 1 of 3
...
5 502245 SIMVASTATIN 80MG TAB 30 A\> 05-21 02-04 2 30
...
+ RX# 502245 removed from Park status.
...
A prescription can be marked as Park using the Label prompt

Example: PARK a Prescription using the Label Prompt

Label Printer: TELNET

LABEL: QUEUE/CHANGE PRINTER/HOLD/SUSPEND/PARK(PK) or '^' to bypass Q// ?

Enter 'Q' to queue labels to print

Enter 'H' to hold label until Rx can be filled

Enter 'PR' for Rx profile

Enter 'S' to suspend labels to print later

Enter 'PK' to Park prescription(s)
...
A prescription can be marked as Park using the Pickup Routing prompt.

Example: PARK a Prescription using the Pickup Routing prompt
...
MAIL/WINDOW/PARK: WINDOW// \<Enter\> P

PARK

Are You Sure You Want To Update RX 502245? Yes//

Example: Activity Log Entry for Park
...
1 2/4/22@09:21:26 EDIT ORIGINAL PHARMACYUSER,ONE

Comments: Rx placed in Parked status (02-04-22)(W)

2 2/4/22@09:21:26 EDIT ORIGINAL PHARMACYUSER,ONE

Comments: MAIL/WINDOW/PARKED (W),FILL DATE (02-04-22),
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/043.png) If the order utilizes the <span id="p477_143_Except_no_copy_ref" class="anchor"></span>EXCEPT conjunction, renew will no longer be allowed. The message bar will display: Cannot be renewed – invalid Except conjunction
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/044.png)
...
PID: 000-01-0000P Ht(cm): \_\_\_\_\_\_\_ (\_\_\_\_\_\_)
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/045.png)

Original Provider Comments are not carried over to any renewals in Outpatient Pharmacy.

# Chapter : Pull Early from Suspense
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/046.png)If the patient has remote prescriptions, then the text "THIS PATIENT HAS PRESCRIPTIONS AT OTHER FACILITIES" will appear on the report as shown in the following example.
...
# Chapter : Queue CMOP Prescription
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/047.png)Important: This is a mandatory function that the pharmacy must use.
...
- <span id="p160" class="anchor"></span>The pending order screen will now display the provider's DEA/VA \# and the site address.
...
![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/048.png)Note: In patch PSO\*7\*99, a change was made for pending orders not to recalculate the quantity for CS drugs on selecting a different strength of the same drug and resulting in the same prescribed dosage. This change is removed in patch PSO\*7\*391.
...
# Chapter : Updating a Patient's Record
...
# # Chapter : Meds by Mail – Virtual Pharmacy Services
...
- When finishing a pending CS order, if the user does not hold the new PSDRPH security key, the order will be marked as 'Non-Verified'. To verify a 'Non-Verified' CS order, the PSDRPH security key is now required. To discontinue a pending CS order, the PSDRPH security key is now required.
- <span id="p170" class="anchor"></span>The pending order screen will now display the provider's DEA/VA \# and the site address.
- When finishing a new pending CS order, the dosage, provider name, or the number of refills will not be allowed editing; however, the user will be allowed to select other possible dosages for the same drug if available. If the changes to the dispense drug results in creating a new order, the user will be notified by the message "Digitally Signed Order - No such changes allowed." If pharmacy wants to make such changes, then they have to discontinue (DC) the pending order and start a new order. However, the user will be allowed to select other possible dosages for the same drug that does not change the prescribed dosage.
- When finishing a new pending CS order, the day supply or the quantity will not be allowed to increase but can be decreased. If the day supply is decreased, the number of refills will also be adjusted accordingly depending on the drug setup (maximum refills, not refillable, etc.). The quantity may be auto-calculated to a higher quantity by the system only when the dosage remains the same, but the dispense drug strength is changed – i.e. 2mg tablets \#30 is changed to 1mg tablets, the Sig is updated, and the system changes the quantity to 60. A manual change to a higher quantity is not allowed.
- When finishing a pending CS order or verifying a CS order by the PSDRPH key holder, any edit to some of the key fields, such as dispense drug, dosage, dispense units, issue date, day's supply, quantity or number of refills, will now be captured and stored in the activity log.

![](outpatient-pharmacy-version-7-technician-s-user-manual-updated-pso-7-779/049.png)Note: In patch PSO\*7\*99, a change was made for pending orders not to recalculate the quantity for CS drugs on selecting a different strength of the same drug and resulting in the same prescribed dosage. This change is removed in patch PSO\*7\*391.

### Finishing a Pending Order with Indications

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

On finishing a pending order, the indication field is prompted along with Copy Indications into the SIG. The user can edit the indication and can add it to the SIG when prompted. Patch PSS\*1\*187 added a new field, COPY INDICATION TO SIG (#96) to PHARMACY SYSTEM File (#59.7) that allows the site to select the default for this prompt to be Y/N.

The Indication field can also be edited using the PATIENT INSTRUCTION item 4 in the screen below.

Example: Finishing a Pending Order with Indications

\*(1) Orderable Item: SIMVASTATIN TAB

\(2\) CMOP Drug: SIMVASTATIN 5MG TAB
...
\(4\) Pat Instruct: FOR CHOLESTEROL

Provider Comments:

Indications: TO REDUCE CHOLESTEROL

Instructions: TAKE ONE TABLET PO QPM
...
On finishing, here are new prompts:

Select Item(s): Next Screen// FN Finish

Indication: TO REDUCE CHOLESTEROL

Copy Indication into the Sig? YES//

(TAKE ONE TABLET BY MOUTH EVERY EVENING FOR CHOLESTEROL TO REDUCE

CHOLESTEROL)

Select Item(s): Next Screen// 4

PATIENT INSTRUCTIONS: FOR CHOLESTEROL// FOR CHOLESTEROL
...
# Chapter : Inbound ePrescribing

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

The Inbound ePrescribing functionality was released in December 2017 to enable the Department of Veterans Affairs (VA) to receive and process prescriptions from external providers. Given the complexity of this functionality it has been described in separate user manuals listed below, which can be found on the VA Software Document Library (VDL) at [www.va.gov/vdl](http://www.va.gov/vdl):

> Inbound ePrescribing User Manual (Unit 1 & Unit 2) 

> Inbound ePrescribing User Manual (Unit 3 & Part 1) 

> Inbound ePrescribing User Manual (Unit 3 & Part 2)

> Inbound ePrescribing User Manual (Unit 4 & Part 1) 

> Inbound ePrescribing User Manual (Unit 4 & Part 2)

> Inbound ePrescribing User Manual (Unit 5 & Part 1) 

> Inbound ePrescribing User Manual (Unit 5 & Part 2)

> Inbound ePrescribing User Manual (Unit 6) 

> Inbound ePrescribing User Manual (Unit 7 & Part 1) – eRx Holding Queue Processing Option – Part 1

> Inbound ePrescribing User Manual (Unit 7 & Part 2) – eRx Holding Queue Processing Option – Part 2
...
<tr class="even">
<td>Activity Log</td>
<td>A log, by date, of changes made to or actions taken on a prescription. An entry is made in this log each time the prescription is edited, canceled, reinstated after being canceled, or renewed. An entry will be made into this log each time a label is reprinted. A CMOP activity log will contain information related to CMOP dispensing activities. Patch PSO*7*753 adds an entry to the Rx Activity Log for each change to the prescription-level mail exemption.</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td>Third (3<sup>rd</sup>) Party Claims</td>
...
A
Allergy/ADR Order Check Display, 81
B
Batch Print Questionnaires, 23
Bingo Board User, 15
C
Check Drug Interaction, 21
Clinical Alerts, 6
Clinical Reminder Order Checks, 39
Clinical Reminders, 39
CPRS Order Checks, 101
CPRS Order Checks: How They Work, 163
D
DEA Certification, 164
Display Patient's Name on Monitor, 16
Dosing Order Checks, 101
DUE User, 23
Duplicate Drug Order Check, 43
E
Edit an Existing Answer Sheet, 23
Enhanced Drug-Drug Interactions, 40
Enter a New Answer Sheet, 23
Enter New Patient, 15
Entering a New Order, 74
Entering Actions, 8
Error Information, 168
Error Messages, 168
H
Hash Counts, 164
I
...
List Manager, 3
M
Medication Profile, 25
N
NDC Validation, 126
O
OneVA Pharmacy and the Medication Profile, 27
OneVA Pharmacy Processing within Patient Prescription Processing, 65
Order Check Data Caching, 163
...
Patient Lookup, 14
Patient Prescription Processing, 31
Processing a Prescription, i, 31
Pull Early from Suspense, 148, 150
Q
Queue CMOP Prescription, 150
R
Reject Resolution Required reject, 116
Release Medication, 151
Reminders, 39
Remove Patient's Name from Monitor, 16
S
Speed Actions, 11
Status of Patient's Order, 16
T
Therapeutic Duplication, 84
Titration, 73
Two Levels of Error Messages, 168
U
Update Patient Record, 160
Using List Manager with Outpatient Pharmacy, 7
Using the Bingo Board, 15
...
### From: Outpatient Pharmacy Version 7 Technician's User Manual (updated PSO*7*737)

## PSO Check Pharmacogenomic Interaction

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

Example 1: Check Pharmacogenomic Interaction by Patient

Select Order Check Management \<TEST ACCOUNT\> Option: Check Pharmacogenomic Interaction

PHARMACOGENOMIC (PGx) TEST OPTION

Do you want to use a specific patient? Y// ES

Select PATIENT NAME: ZZTESTPATIENT,PGX ZZZZTESTPATIENT,PGX DOB SSN NO NON-VETERAN (OTHER) CARE TEAM

WARNING : You may have selected a test patient.

Enrollment Priority: Category: NOT ENROLLED End Date:

The patient has the following PGx labs:

Activity

Lab Date Gene Score Phenotype

2/1/2021 CYP2C HIGH SENSITIVITY

2/1/2021 CYP2C19 INTERMEDIATE METABOLIZER

2/1/2021 CYP2C9 NORMAL METABOLIZER

2/1/2021 CYP2D6 1 INTERMEDIATE METABOLIZER

2/1/2021 CYP3A5 POOR METABOLIZER

Press Return to continue, '^' to exit list:

2/1/2021 CYP4F2 REDUCED ACTIVITY

2/1/2021 DPYD 2 NORMAL METABOLIZER

2/1/2021 IFNL3 UNFAVORABLE GENOTYPE RESPONSE

2/1/2021 SLCO1B1 NORMAL FUNCTION

2/1/2021 TPMT NORMAL METABOLIZER

2/1/2021 VKORC1 LOW WARFARIN SENSITIVITY

End of Gene list.

Press Return to continue:

Do you want to use the patient's pharmacogenomic eligible drug(s)

from their medication profile(s)? Y// ES

PGx eligible drugs on the profile:

ABACAVIR SULFATE 300MG TAB (Pending Inp., Rx)

AMITRIPTYLINE 100MG (Rx)

DAPSONE 25MG TAB (Rx)

WARFARIN 2MG TABSZZZ (UD, Rx)

Press Return to continue, '^' to exit:

WARFARIN SODIUM 5MG S.T. (Rx)

Do you want to add drugs to the list above? Y// NO

Inputs:

Drug: WARFARIN 2MG TABSZZZ

VA Product: WARFARIN NA 2MG TAB

GCNSEQNO: 6561

Drug: WARFARIN SODIUM 5MG S.T.

VA Product: WARFARIN NA 5MG TAB

GCNSEQNO: 6562

Drug: DAPSONE 25MG TAB

VA Product: DAPSONE 25MG TAB
...
Drug: AMITRIPTYLINE 100MG

Press Return to continue, '^' to exit:

VA Product: AMITRIPTYLINE HCL 100MG TAB

GCNSEQNO: 46044

Gene: CYP2C

Genotype: G.96405502G\>A G/A
...
Genotype: RS12979860 C/T

Press Return to continue, '^' to exit:

Activity Score:

Phenotype: UNFAVORABLE GENOTYPE RESPONSE
...
Genotype: -1639G\>A G/G

Activity Score:

Phenotype: LOW WARFARIN SENSITIVITY

Press Return to see PGx Findings, '^' to exit:

Pharmacogenomic HIGH Order Check:

GENOMIC FINDING: HLA-B \*57:01 no result on file, not currently ordered

IMPACTED MEDICATION: ABACAVIR SULFATE 300MG TAB

ACTION: Confirm HLA-B\*57:01 negative status prior to prescribing or choose

alternative antiretroviral. Alternative nucelos(t)ide reverse transcriptase

inhibitors (NRTIs) include tenofovir disoproxil fumarate, tenofovir

alafenamide, lamivudine and emtricitabine.

RATIONALE: HLA-B\*57:01 carriers are at high risk for severe hypersensitivity

reaction.

MONITORING: HLA-B\*57:01 testing is required prior to abacavir initiation.
...
GENOMIC FINDING: CYP2C19 intermediate metabolizer AND CYP2D6
...
higher) such as depression, consider a 25% reduction of the recommended

starting dose and use therapeutic drug monitoring to guide subsequent dose

adjustment.

RATIONALE: Reduced CYP2D6 activity results in higher concentrations of active

drug while reduced CYP2C19 activity results in reduced conversion to

nortriptyline. The combination of these effects may increase risk of adverse

reactions.

MONITORING: Monitor for symptom improvement as well as adverse reactions

(e.g., anticholinergic, central nervous system, and cardiac effects).
...
GENOMIC FINDING: VKORC1

IMPACTED MEDICATION: WARFARIN SODIUM 5MG S.T.

Reason(s): Gene test results for VKORC1 were screened but unable to be

interpreted by FDB. Additional information or testing is required for WARFARIN

2MG TABSZZZ and WARFARIN SODIUM 5MG S.T. guidance.
...
GENOMIC FINDING: CYP4F2

IMPACTED MEDICATION: WARFARIN SODIUM 5MG S.T.

Reason(s): Gene test results for CYP4F2 were screened but unable to be
...
Example 2: Check Pharmacogenomic Interaction by Drug

Select DRUG: WARFARIN
...
4 WARFARINZ 2MG TABS 05-04-15

CHOOSE 1-4: 1 WARFARIN 2MG TABS BL110
...
Examples: G.96405502G\>A A/A, or G.96405502G\>A G/G, etc.

Genotype selection for CYP2C (optional): G.96405502G\>A A/A

Phenotype selection for CYP2C

1\) HIGH SENSITIVITY

2\) LOW SENSITIVITY

3\) VARIANT ALLELE ABSENT

4\) VARIANT ALLELE PRESENT

Select CYP2C Phenotype: (1-4): 1 HIGH SENSITIVITY

Gene: CYP2C

Genotype: G.96405502G\>A A/A
...
No PGx Order Checks to display.

Press Return to continue:

## High PGx Order Check Warning Message

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

Technicians will receive a warning message (shown in the example below) when the Verification site parameter is set to No.

Example 1: High PGx Order Check Warning Message (Verification site parameter = No

Another New Order for ZZTESTPGX,PATIENT? YES//

Eligibility: SERVICE CONNECTION SC%: \##

RX PATIENT STATUS: OTHER//

DRUG:

DRUG:

DRUG: ABACAVIR SULFATE 300MG TAB AM800
...
ABACAVIR is hazardous to handle. Please notify pharmacy staff

and counsel patient to take the appropriate handling precautions.
...
\*\*\* THERAPEUTIC DUPLICATION(S) \*\*\* ABACAVIR SULFATE 300MG TAB with

Clinic Order: ABACAVIR SULFATE 300MG TAB (ACTIVE)

Schedule: BID

Dosage: TESTTESTTEST

Start Date: JUL 06, 2025@16:01

Stop Date: JUL 20, 2025@16:01

Class(es) Involved in Therapeutic Duplication(s): Abacavir
...
> **WARNING:** Unlike other orders with Critical Order Checks, this order will

not be placed in a Non-Verified status for pharmacist verification after

you process it. If you are unsure about this order, please stop processing

by '^'ing out, and consult a pharmacist.
