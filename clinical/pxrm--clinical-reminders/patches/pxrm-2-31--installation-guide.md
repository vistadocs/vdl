...
description: 1. Retrieve the host file containing the patch 5 2. Install the build first in a training or test account 6 3. Load the distribution. 6 1. [Backup a Transport Global...
