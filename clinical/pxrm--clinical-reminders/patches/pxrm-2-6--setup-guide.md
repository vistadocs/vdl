...
description: '''- Contents - Introduction - [NOTE: In this document you will see references to both PXRM\2\6 and PXRM\2.0\6. The difference is that PXRM\2\6 is the name of the patch and PXRM\2.0\6 is the name of the...'''
audience: ''
keywords: []
file_numbers:
- '771'
