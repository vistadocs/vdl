...
description: '''1. INTRODUCTION 3 VA Links: 3 Veterans Choice web links: Error! Bookmark not defined. 2. INSTALLATION: 4 This patch can be installed with users on the system, but it should be done during non-peak [hours. Estimated Installation Time:...'''
