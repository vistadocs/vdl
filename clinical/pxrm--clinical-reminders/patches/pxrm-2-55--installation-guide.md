...
description: 1. Retrieve the host file from one of the following locations (with the ASCII file type) 9 2. Install the patch first in a training or test account 9 3. Load the distribution. 9 4. [Backup a Transport Global
