---
title: HL7 Interface Specification (Updated RA*5*203)
doc_type: INT
...
<td><p>RA*5.0*203</p>
<ul>
<li><p>Corrected spelling of “subelements” to “sub elements” throughout and updated table of contents.</p></li>
<li><p>Reviewed document for grammatical and spelling errors.</p></li>
</ul></td>
<td><p>35, 48, 53, 71</p>
<p>87, 88</p></td>
</tr>
...
<p>PV1-11 Temporary Location Table added.</p></td>
<td><p>17</p>
<p>37</p>
<p>39</p>
<p>40</p>
...
<blockquote>
<p>Added a Response message example</p>
</blockquote></td>
<td><p>15<br />
<br />
<br />
...
1.1 Organization of this Document [1](#organization-of-this-document)

1.2 Overview of HL7 Terminology [1](#overview-of-hl7-terminology)

1.2.1 Application Processing Rules [1](#_Toc167891500)

1.2.2 Communication Protocol [2](#communication-protocol)

1.2.3 Data Type [2](#data-type)

1.2.4 Escape Sequences in Data Fields [3](#escape-sequences-in-data-fields)

1.2.5 Fields [3](#fields)

1.2.6 File [4](#file)

1.2.7 Maximum Length [4](#maximum-length)

1.2.8 Messages [4](#messages)

1.2.9 HL7 Messages [4](#_Toc167891508)

1.2.10 Message Delimiters [5](#message-delimiters)

1.2.11 Position (sequence within the segment) [6](#_Toc167891510)

1.2.12 Segments [6](#segments)

1.2.13 Table [6](#_Toc167891512)

1.2.14 Usage [6](#_Toc167891513)

1.3 References [8](#references)

2 Overview of Trigger Events [9](#overview-of-trigger-events)

2.1 Patient Registration [9](#patient-registration)

2.2 Exam Edit [9](#exam-edit)

2.3 Exam Cancel [9](#exam-cancel)

2.4 Report Verified or Released/Not Verified [10](#report-verified-or-releasednot-verified)

3 Order Entry/Update Profile [11](#order-entryupdate-profile)

3.1 Use Case [11](#use-case)

3.1.1 Scope [11](#scope)

3.1.2 Actors and Roles [11](#actors-and-roles)

3.2 Interactions [12](#interactions)

3.3 Dynamic Definition [12](#dynamic-definition)

3.3.1 ORM - Order Message [12](#orm---order-message)

3.3.2 ACK - Acknowledgment Message [13](#ack---acknowledgment-message)

3.3.2.1 Return Original Mode ACK [13](#return-original-mode-ack)

3.3.2.2 Send MSA Segment for AE and AR conditions [13](#send-msa-segment-for-ae-and-ar-conditions)

3.4 Static Definition – Message Level [13](#static-definition-message-level)

3.4.1 Order Message (ORM) [13](#order-message-orm)

3.4.2 Acknowledgment Message (ACK) [14](#acknowledgment-message-ack)

3.5 Static Definition – Segment Level [15](#static-definition-segment-level)

3.5.1 MSH Segment [15](#msh-segment)

3.5.2 PID Segment [16](#pid-segment)

3.5.3 PV1 Segment [17](#pv1-segment)

3.5.4 ORC Segment [19](#orc-segment)

3.5.5 OBR Segment [21](#obr-segment)

3.5.6 ZDS Segment [23](#zds-segment)

3.5.7 OBX Segment [23](#_Toc167891540)

3.5.8 MSA Segment [24](#msa-segment)

3.6 Static Definition – Field Level [24](#static-definition-field-level)

3.6.1 MSH Segment Fields in ORM and ORU [24](#msh-segment-fields-in-orm-and-oru)

3.6.1.1 MSH-1-Field Separator [25](#_Toc167891544)

3.6.1.2 MSH-2-Encoding Characters [26](#msh-2-encoding-characters)

3.6.1.3 MSH-3-Sending Application [26](#msh-3-sending-application)

3.6.1.4 MSH-4-Sending Facility 5F [26](#msh-4-sending-facility-5f)

3.6.1.5 MSH-5-Receiving Application [26](#msh-5-receiving-application)

3.6.1.6 MSH-6-Receiving Facility [27](#msh-6-receiving-facility)

3.6.1.7 MSH-7-Date/Time of Message [27](#msh-7-datetime-of-message)

3.6.1.8 MSH-9-Message Type [27](#msh-9-message-type)

3.6.1.8.1 MSH-9.1-Message Type [27](#msh-9.1-message-type)

3.6.1.8.2 MSH-9.2-Trigger Event [28](#msh-9.2-trigger-event)

3.6.1.9 MSH-10-Message Control ID [28](#msh-10-message-control-id)

3.6.1.10 MSH-11-Processing ID [28](#_Toc167891555)

3.6.1.10.1 MSH-11.1-Processing ID [28](#msh-11.1-processing-id)

3.6.1.10.2 MSH-11.2-Processing Mode [28](#msh-11.2-processing-mode)

3.6.1.11 MSH-12-Version ID [29](#msh-12-version-id)

3.6.1.12 MSH-15-Accept Acknowledgment Type [29](#msh-15-accept-acknowledgment-type)

3.6.1.13 MSH-16-Application Acknowledgment Type [29](#msh-16-application-acknowledgment-type)

3.6.1.14 MSH-17-Country Code [30](#msh-17-country-code)

3.6.2 PID Segment Fields [30](#pid-segment-fields)

3.6.3 PID-2-Patient ID [31](#pid-2-patient-id)

3.6.3.1.1 PID-2.1-ID [32](#pid-2.1-id)

3.6.3.1.2 PID-2.4-Assigning Authority [32](#pid-2.4-assigning-authority)

3.6.3.1.3 PID-2.5-Identifier Type [32](#pid-2.5-identifier-type)

3.6.3.2 PID-3-Patient Identifier List [32](#pid-3-patient-identifier-list)

3.6.3.2.1 PID-3.1-ID [33](#pid-3.1-id)

3.6.3.2.2 PID-3.4-Assigning Authority [33](#pid-3.4-assigning-authority)

3.6.3.2.3 PID-3.5-Identifier Type [33](#pid-3.5-identifier-type)

3.6.3.3 PID-4-Alternate Patient ID [34](#pid-4-alternate-patient-id)

3.6.3.3.1 PID-4.1-ID [34](#pid-4.1-id)

3.6.3.3.2 PID-4.4-Assigning Authority [34](#pid-4.4-assigning-authority)

3.6.3.3.3 PID-4.5-Identifier Type [34](#pid-4.5-identifier-type)

3.6.3.4 PID-5-Patient Name [35](#pid-5-patient-name)

3.6.3.5 PID-7-Date/Time of Birth [35](#pid-7-datetime-of-birth)

3.6.3.6 PID-8-Sex [35](#pid-8-sex)

3.6.3.7 PID-10-Race [35](#pid-10-race)

3.6.3.7.1 PID-10.1-Identifier [36](#pid-10.1-identifier)

3.6.3.7.2 PID-10.3-Name of Coding System [36](#pid-10.3-name-of-coding-system)

3.6.3.7.3 PID-10.4-Alternate Identifier [36](#pid-10.4-alternate-identifier)

3.6.3.7.4 PID-10.6-Name of Coding System [36](#pid-10.6-name-of-coding-system)

3.6.3.8 PID-11-Patient Address [36](#pid-11-patient-address)

3.6.3.9 PID-13-Phone Number – Home [37](#pid-13-phone-number-home)

3.6.3.9.1 PID-13.1-\[NNN\] \[(999)\]999-9999 \[X99999\] \[B99999\] \[C any text\] [37](#pid-13.1-nnn-999999-9999-x99999-b99999-c-any-text)

3.6.3.9.2 PID-13.2-Telecommunication Use Code [37](#pid-13.2-telecommunication-use-code)

3.6.3.9.3 PID-13.3-Telecommunication Equipment Type [38](#pid-13.3-telecommunication-equipment-type)

3.6.3.10 PID-14-Phone Number – Business [38](#pid-14-phone-number-business)

3.6.3.10.1 PID-14.1-\[NNN\] \[(999)\]999-9999 \[X99999\] \[B99999\] \[C any text\] [38](#pid-14.1-nnn-999999-9999-x99999-b99999-c-any-text)

3.6.3.10.2 PID-14.2-Telecommunication Use Code [39](#pid-14.2-telecommunication-use-code)

3.6.3.10.3 PID-14.3-Telecommunication Equipment Type [39](#pid-14.3-telecommunication-equipment-type)

3.6.3.11 PID-19-SSN Number – Patient [39](#pid-19-ssn-number-patient)

3.6.3.12 PID-22-Ethnic Group [39](#pid-22-ethnic-group)

3.6.3.12.1 PID-22.1-Identifier [39](#pid-22.1-identifier)

3.6.3.12.2 PID-22.3-Name of Coding System [40](#pid-22.3-name-of-coding-system)

3.6.3.12.3 PID-22.4-Alternate Identifier [40](#pid-22.4-alternate-identifier)

3.6.3.12.4 PID-22.6-Name of Coding System [40](#pid-22.6-name-of-coding-system)

3.6.4 PV1 Segment Fields in ORM [40](#pv1-segment-fields-in-orm)

3.6.4.1 PV1-2-Patient Class [41](#pv1-2-patient-class)

3.6.4.2 PV1-3-Assigned Patient Location [41](#pv1-3-assigned-patient-location)

3.6.4.3 PV1-7-Attending Doctor [42](#pv1-7-attending-doctor)

3.6.4.4 PV1-8-Referring Doctor [43](#pv1-8-referring-doctor)

3.6.4.5 PV1-10-Hospital Service [43](#pv1-10-hospital-service)

3.6.4.6 PV1-11-Temporary Location [43](#pv1-11-temporary-location)

3.6.4.7 PV1-15-Ambulatory Status [44](#pv1-15-ambulatory-status)

3.6.4.8 PV1-16-VIP Indicator [45](#_Toc167891606)

3.6.4.9 PV1-19-Visit [45](#pv1-19-visit)

3.6.5 ORC Segment Fields in ORM [45](#orc-segment-fields-in-orm)

3.6.5.1 ORC-1-Order Control [46](#orc-1-order-control)

3.6.5.2 ORC-2-Placer Order Number [46](#orc-2-placer-order-number)

3.6.5.3 ORC-3-Filler Order Number [46](#orc-3-filler-order-number)

3.6.5.4 ORC-4-Placer Group Number [46](#orc-4-placer-group-number)

3.6.5.5 ORC-5-Order Status [47](#orc-5-order-status)

3.6.5.6 ORC-7-Quantity/Timing [47](#orc-7-quantitytiming)

3.6.5.6.1 ORC-7.4-Start Date/Time [48](#orc-7.4-start-datetime)

3.6.5.6.2 ORC-7.6-Priority [48](#orc-7.6-priority)

3.6.5.7 ORC-8-Parent [48](#orc-8-parent)

3.6.5.8 ORC-9-Date/Time of Transaction [48](#orc-9-datetime-of-transaction)

3.6.5.9 ORC-10-Entered By [48](#orc-10-entered-by)

3.6.5.10 ORC-12-Ordering Provider [49](#orc-12-ordering-provider)

3.6.5.11 ORC-13-Enterer’s Location [50](#orc-13-enterers-location)

3.6.5.12 ORC-14-Call Back Phone Number [50](#orc-14-call-back-phone-number)

3.6.5.12.1 ORC-14.1-\[NNN\] \[(999)\]999-9999 \[X99999\] \[B99999\] \[C any text\] [51](#orc-14.1-nnn-999999-9999-x99999-b99999-c-any-text)

3.6.5.12.2 ORC-14.2-Telecommunication Use Code [51](#orc-14.2-telecommunication-use-code)

3.6.5.12.3 ORC-14.3-Telecommunication Equipment Type [51](#orc-14.3-telecommunication-equipment-type)

3.6.5.13 ORC-17-Entering Organization [51](#orc-17-entering-organization)

3.6.5.13.1 ORC-17.1-Identifier [52](#orc-17.1-identifier)

*3.6.5.13.2* ORC-17.2-Text [52](#orc-17.2-text)

*3.6.5.13.3* ORC-17.3-Name of Coding System [52](#orc-17.3-name-of-coding-system)

3.6.6 OBR Segment Fields in ORM [52](#obr-segment-fields-in-orm)

3.6.6.1 OBR-1-Set ID [53](#obr-1-set-id)

3.6.6.2 OBR-2-Placer Order Number [53](#obr-2-placer-order-number)

3.6.6.3 OBR-3-Filler Order Number [54](#obr-3-filler-order-number)

3.6.6.4 OBR-4-Universal Service Identifier [54](#obr-4-universal-service-identifier)

3.6.6.4.1 OBR-4.1-Identifier [54](#obr-4.1-identifier)

3.6.6.4.2 OBR-4.2-Text [54](#obr-4.2-text)

3.6.6.4.3 OBR-4.3-Name of Coding System [54](#obr-4.3-name-of-coding-system)

3.6.6.4.4 OBR-4.4-Alternate Identifier [54](#obr-4.4-alternate-identifier)

3.6.6.4.5 OBR-4.5-Alternate Text [55](#obr-4.5-alternate-text)

3.6.6.4.6 OBR-4.6-Name of Alternate Coding System [55](#obr-4.6-name-of-alternate-coding-system)

3.6.6.5 OBR-5-Priority [55](#obr-5-priority)

3.6.6.6 OBR-15-Specimen Source [55](#_Toc167891642)

3.6.6.7 OBR-16-Ordering Provider [55](#obr-16-ordering-provider)

3.6.6.8 OBR-17-Order Callback Phone Number [56](#_Toc167891644)

3.6.6.8.1 OBR-17.1-\[NNN\] \[(999)\]999-9999 \[X99999\] \[B99999\] \[C any text\] [57](#obr-17.1-nnn-999999-9999-x99999-b99999-c-any-text)

3.6.6.8.2 OBR-17.2-Telecommunication Use Code [57](#obr-17.2-telecommunication-use-code)

3.6.6.8.3 OBR-17.3-Telecommunication Equipment Type [57](#obr-17.3-telecommunication-equipment-type)

3.6.6.9 OBR-18-Placer Field 1 [57](#obr-18-placer-field-1)

3.6.6.10 OBR-19-Placer Field 2 [57](#obr-19-placer-field-2)

3.6.6.11 OBR-20-Filler Field 1 [58](#obr-20-filler-field-1)

3.6.6.12 OBR-21-Filler Field 2 [58](#obr-21-filler-field-2)

3.6.6.13 OBR-24-Diagnostic Service Section ID [58](#obr-24-diagnostic-service-section-id)

3.6.6.14 OBR-27-Quantity/Timing [59](#obr-27-quantitytiming)

3.6.6.14.1 OBR-27.4-Start Date/Time [59](#obr-27.4-start-datetime)

3.6.6.14.2 OBR-27.6-Priority [59](#obr-27.6-priority)

3.6.6.15 OBR-29-Parent [59](#obr-29-parent)

3.6.6.16 OBR-30-Transportation Mode [60](#obr-30-transportation-mode)

3.6.6.17 OBR-31-Reason for Study [60](#obr-31-reason-for-study)

3.6.6.17.1 OBR-31.2-Reason for Study [60](#obr-31.2-reason-for-study)

3.6.7 ZDS Segment Fields in ORM and ORU [60](#_Toc167891660)

3.6.7.1 ZDS-1-Study Instance UID [61](#zds-1-study-instance-uid)

3.6.7.1.1 ZDS-1.1-Pointer [61](#zds-1.1-pointer)

3.6.7.1.2 ZDS-1.2-Application ID [61](#zds-1.2-application-id)

3.6.7.1.3 ZDS-1.3-Type of Data [61](#zds-1.3-type-of-data)

3.6.7.1.4 ZDS-1.4-Subtype [61](#zds-1.4-subtype)

3.6.8 OBX Segment Fields in ORM and ORU [61](#obx-segment-fields-in-orm-and-oru)

3.6.8.1 OBX-2-Value Type [62](#obx-2-value-type)

3.6.8.2 OBX-3-Observation Identifier [62](#obx-3-observation-identifier)

3.6.8.2.1 OBX-3.1-Identifier and OBX-3.2-Text [63](#obx-3.1-identifier-and-obx-3.2-text)

3.6.8.2.2 OBX-3.3-Name of Coding System [63](#obx-3.3-name-of-coding-system)

3.6.8.3 OBX-5-Observation Value [63](#obx-5-observation-value)

3.6.8.4 OBX-11-Observation Result Status [63](#obx-11-observation-result-status)

3.6.9 MSA Segment Fields [63](#msa-segment-fields)

4 Report Transmission/Storage Profile [65](#report-transmissionstorage-profile)

4.1 Use Case [65](#use-case-1)

4.1.1 Scope [65](#scope-1)

4.1.2 Actors and Roles [65](#actors-and-roles-1)

4.2 Interactions [66](#interactions-1)

4.3 Dynamic Definition [66](#dynamic-definition-1)

4.3.1 ORU – Unsolicited Observation Results [66](#oru-unsolicited-observation-results)

4.4 Static Definition – Message Level [67](#static-definition-message-level-1)

4.4.1 Observation Result–Unsolicited (ORU) [67](#observation-resultunsolicited-oru)

4.5 Static Definition – Segment Level [68](#static-definition-segment-level-1)

4.5.1 MSH Segment [68](#msh-segment-1)

4.5.2 PID Segment [68](#pid-segment-1)

4.5.3 OBR Segment [68](#obr-segment-1)

4.5.4 ZDS Segment [70](#zds-segment-1)

4.5.5 OBX Segment [71](#obx-segment-1)

4.5.6 MSA Segment [71](#_Toc167891689)

4.6 Static Definition – Field Level [71](#static-definition-field-level-1)

4.6.1 MSH Segment Fields in ORU Messages (Outbound and Inbound) [71](#msh-segment-fields-in-oru-messages-outbound-and-inbound)

4.6.2 PID Segment Fields in ORU Messages (Outbound and Inbound) [71](#pid-segment-fields-in-oru-messages-outbound-and-inbound)

4.6.3 OBR Segment Fields in ORU Messages (Outbound and Inbound) [71](#obr-segment-fields-in-oru-messages-outbound-and-inbound)

4.6.3.1 OBR-1-Set ID [73](#obr-1-set-id-1)

4.6.3.2 OBR-2-Placer Order Number [73](#obr-2-placer-order-number-1)

4.6.3.3 OBR-3-Filler Order Number [73](#obr-3-filler-order-number-1)

4.6.3.4 OBR-4-Universal Service Identifier [73](#obr-4-universal-service-identifier-1)

4.6.3.4.1 OBR-4.1-Identifier [74](#obr-4.1-identifier-1)

4.6.3.4.2 OBR-4.2-Text [74](#obr-4.2-text-1)

4.6.3.4.3 OBR-4.3-Name of Coding System [74](#obr-4.3-name-of-coding-system-1)

4.6.3.4.4 OBR-4.4-Alternate Identifier [74](#obr-4.4-alternate-identifier-1)

4.6.3.4.5 OBR-4.5-Alternate Text [74](#obr-4.5-alternate-text-1)

4.6.3.4.6 OBR-4.6-Name of Alternate Coding System [74](#obr-4.6-name-of-alternate-coding-system-1)

4.6.3.5 OBR-7-Observation Date/Time [74](#obr-7-observation-datetime)

4.6.3.6 OBR-15-Specimen Source [74](#obr-15-specimen-source-1)

4.6.3.7 OBR-16-Ordering Provider [75](#obr-16-ordering-provider-1)

4.6.3.8 OBR-17-Order Callback Phone Number [75](#obr-17-order-callback-phone-number-1)

4.6.3.8.1 OBR-17.1-\[NNN\] \[(999)\]999-9999 \[X99999\] \[B99999\] \[C any text\] [76](#obr-17.1-nnn-999999-9999-x99999-b99999-c-any-text-1)

4.6.3.8.2 OBR-17.2-Telecommunication Use Code [76](#obr-17.2-telecommunication-use-code-1)

4.6.3.8.3 OBR-17.3-Telecommunication Equipment Type [77](#obr-17.3-telecommunication-equipment-type-1)

4.6.3.9 OBR-18-Placer Field 1 [77](#obr-18-placer-field-1-1)

4.6.3.10 OBR-19-Placer Field 2 [77](#obr-19-placer-field-2-1)

4.6.3.11 OBR-20-Filler Field 1 [77](#obr-20-filler-field-1-1)

4.6.3.12 OBR-21-Filler Field 2 [77](#obr-21-filler-field-2-1)

4.6.3.13 OBR-22-Results Rpt/Status Chng – Date/Time [77](#obr-22-results-rptstatus-chng-datetime)

4.6.3.14 OBR-25-Result Status [78](#obr-25-result-status)

4.6.3.15 OBR-29-Parent [78](#obr-29-parent-1)

4.6.3.16 OBR-32-Principal Result Interpreter [78](#obr-32-principal-result-interpreter)

4.6.3.16.1 OBR-32.1-Name [79](#obr-32.1-name)

4.6.3.17 OBR-33-Assistant Result Interpreter [79](#obr-33-assistant-result-interpreter)

4.6.3.17.1 OBR-33.1-Name [80](#obr-33.1-name)

4.6.3.18 OBR-35-Transcriptionist [80](#obr-35-transcriptionist)

4.6.3.18.1 OBR-35.1-Name [81](#obr-35.1-name)

4.6.4 ZDS Segment Fields in ORU and ORM [81](#_Toc167891724)

4.6.4.1 ZDS-1-Study Instance UID [81](#zds-1-study-instance-uid-1)

4.6.4.1.1 ZDS-1.1-Pointer [81](#zds-1.1-pointer-1)

4.6.4.1.2 ZDS-1.2-Application ID [82](#zds-1.2-application-id-1)

4.6.4.1.3 ZDS-1.3-Type of Data [82](#zds-1.3-type-of-data-1)

4.6.4.1.4 ZDS-1.4-Subtype [82](#zds-1.4-subtype-1)

4.6.5 OBX Segment Fields in ORU Messages (Outbound and Inbound) [82](#obx-segment-fields-in-oru-messages-outbound-and-inbound)

4.6.5.1 OBX-2-Value Type [83](#obx-2-value-type-1)

4.6.5.2 OBX-3-Observation Identifier [83](#obx-3-observation-identifier-1)

4.6.5.2.1 OBX-3.1-Identifier and OBX-3.2-Text [83](#_Toc167891733)

4.6.5.2.2 OBX-3.3-Name of Coding System [84](#obx-3.3-name-of-coding-system-1)

4.6.5.3 OBX-5-Observation Value [84](#obx-5-observation-value-1)

4.6.5.4 OBX-6-Units [84](#obx-6-units)

4.6.5.5 OBX-11-Observation Result Status [85](#obx-11-observation-result-status-1)

4.7 ACK – General Acknowledgment Message [85](#ack-general-acknowledgment-message)

4.7.1 MSA Segment Fields in ACK Messages [85](#msa-segment-fields-in-ack-messages)

4.7.1.1 MSA-1-Acknowledgment Code [85](#msa-1-acknowledgment-code)

4.7.1.2 MSA-2-Message Control ID [86](#msa-2-message-control-id)

4.7.1.3 MSA-3-Text Message [86](#msa-3-text-message)

Appendix A – Message Examples [87](#_Toc167891743)

ORM Examples [87](#orm-examples)

ORM for new/registered order [87](#orm-for-newregistered-order)

ORM for registration of a Printset [88](#orm-for-registration-of-a-printset)

ORC-8-Parent and OBR-29-Parent [88](#orc-8-parent-and-obr-29-parent)

OBR-2-Placer and OBR-3-Filler [88](#obr-2-placer-and-obr-3-filler)

ORM for an edited order [90](#orm-for-an-edited-order)

ORM for a canceled order [90](#orm-for-a-canceled-order)

ORU Examples [91](#oru-examples)

ORU for report on a single procedure [91](#oru-for-report-on-a-single-procedure)

ORU for Printset (single report on multiple procedures) [92](#oru-for-printset-single-report-on-multiple-procedures)

ACK Example [92](#ack-example)

Appendix B – VistA Data Attributes [93](#appendix-b-vista-data-attributes)

MSH Segments [93](#msh-segments)

PID Segments [94](#pid-segments)

ORC Segments [96](#_Toc167891758)

OBR Segments [97](#obr-segments)

ZDS Segments ORM and ORU [102](#zds-segments-orm-and-oru)

OBX (ORU) Segments [102](#obx-oru-segments)

OBX (ORM) Segments [105](#obx-orm-segments)
...
| FT        | Formatted text                                    | See page [3](#escape-sequences-in-data-fields) for a list of escape sequences and allowed formatting commands.      |
...
For examples of ORM, ORU, and ACK messages, refer to [Appendix A](#_Appendix_A_–).
...
![](hl7-interface-specification-updated-ra-5-203/002.png)
...
![](hl7-interface-specification-updated-ra-5-203/003.png)
...
For examples of ORM messages, refer to [Appendix A](#_Appendix_A_–).
...
| 20  | 250 | CE  | X     | \[0..0\]    | [0339](\l) | 01310   | Advanced Beneficiary Notice Code |
...
The following is the field defined for the ZDS Segment in HL7. For a more detailed explanation of the fields used by VistA, refer to Section 3.6.6 on page [60](#_Ref232824764).
...
For an explanation of the MSH segment fields used in the VistA order and report messages, refer to 3.6.1 MSH Segment Fields on page [24](#msh-segment-fields-in-orm-and-oru).
...
For a listing of all the fields defined for the MSA segments in HL7, refer to 3.5.8 MSA Segment on page [24](#msa-segment).

For an explanation of the MSA segment fields used by VistA acknowledgment messages, refer to 4.7.1 MSA Segment Fields in ACK Messages on page [85](#msa-segment-fields-in-ack-messages).
...
![](hl7-interface-specification-updated-ra-5-203/004.png)
...
![](hl7-interface-specification-updated-ra-5-203/005.png)
...
- For an explanation of the MSH fields used in the VistA order and report messages, refer to 3.6.1 MSH Segment Fields in ORM and ORU on page [24](#msh-segment-fields-in-orm-and-oru).
...
- For an explanation of the PID fields used in the VistA order and report messages, refer to 3.2.6 PID Segment Fields on page [30](#pid-segment-fields).

### OBR Segment

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

For an explanation of the OBR fields used in the VistA order message, refer to 4.6.3 OBR Segment Fields on page [81](#_Fields_Used_in_6).
...
The following is the field defined for the ZDS Segment in HL7. For a more detailed explanation of the fields used by VistA, refer to Section 4.6.4 on page [81](#_Fields_Used_in_6).
...
- For a listing of all the fields defined for the OBX segment in HL7, refer to 3.5.7 OBX Segment on page [23](#_OBX_Segment).
- For an explanation of the OBX segment fields used by VistA order and report messages, refer to 4.6.4 OBX Segment Fields in ORU Messages on page [81](#_Fields_Used_in_6).
...
- For a listing of all the fields defined for the MSA segments in HL7, refer to 3.5.8 MSA Segment on page [24](#msa-segment).
- For an explanation of the MSA segment fields used by VistA acknowledgment messages, refer to 4.7.1 MSA Segment Fields on page[85](#msa-segment-fields-in-ack-messages) .
...
For an explanation of the PID segment fields used in the VistA order and report messages, refer to 3.6.2 PID Segment Fields on page [30](#pid-segment-fields).
...
For descriptions of MSH segment field elements in ORM and ORU messages, refer to MSH Segment Fields in ORM on page [24](#msh-segment-fields-in-orm-and-oru) and MSH Segment Fields in ORU on page [71](#msh-segment-fields-in-oru-messages-outbound-and-inbound).
...
For descriptions of PID segment field elements in ORM and ORU messages, refer to PID Segment Fields in ORM on page [30](#pid-segment-fields) and PID Segment Fields in ORU on page [71](#pid-segment-fields-in-oru-messages-outbound-and-inbound).
...
For descriptions of PV-1 segment field elements, refer to PV-1 Segment Fields in ORM on page [40](#pv1-segment-fields-in-orm).
...
For descriptions of ORC segment field elements in ORM messages, refer to ORC Segment Fields in ORM on page [45](#orc-segment-fields-in-orm).
...
For descriptions of OBR segment field elements in ORM and ORU messages, refer to OBR Segment Fields in ORM on page [52](#obr-segment-fields-in-orm) and OBR Segment Fields in ORU on page [71](#obr-segment-fields-in-oru-messages-outbound-and-inbound).
...
<td>OBR-16</td>
<td>ORDERING PROVIDER</td>
<td>RAD/NUC MED PATIENT (#70). EXAMINATIONS (#70.03) sub-file; field (#14)</td>
...
For descriptions of ZDS segment field elements in ORM and ORU messages, refer to ZDS Segment Fields in ORM on page [60](#_Ref232824764) and ORU on page [70](#zds-segment-1).
...
For descriptions of OBX segment field elements in ORU messages, refer to OBX Segment Fields in ORU Messages on page [81](#_Fields_Used_in_6).
...
For descriptions of OBX segment field elements in ORM messages, refer to OBX Segment Fields in ORM messages on page [61](#obx-segment-fields-in-orm-and-oru).
