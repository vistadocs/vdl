---
title: Drug Accountability/Inventory Interface Version 3 User Manual (Updated PSA*3*79)
doc_type: UM
...
- PSORPH
menu_options: 1
description: Each time this manual is updated, the Title Page lists the new revised date and this page describes the changes. Either update the existing manual with the Change Pages document, or replace it with the updated
...
docx_url: https://www.va.gov/vdl/documents/Clinical/Pharm-Drug_Accountability_Archive/psa_3_p79_um.docx
pdf_url: https://www.va.gov/vdl/documents/Clinical/Pharm-Drug_Accountability_Archive/psa_3_p79_um.pdf
app_url: https://www.va.gov/vdl/application.asp?appid=393
...
- Drug Accountability/Inventory Interface Version 3 User Manual
...
### From: Drug Accountability/Inventory Interface Version 3 User Manual
...
> ![](drug-accountability-inventory-interface-version-3-user-manual/002.png)
...
> ![](drug-accountability-inventory-interface-version-3-user-manual/003.png)
...
<span id="_Ref86063804" class="anchor"></span>Figure 2: Example of Broker Connection Connect To Dialog Box

![](drug-accountability-inventory-interface-version-3-user-manual/007.png)

> ![](drug-accountability-inventory-interface-version-3-user-manual/008.png) Note: The broker connection dialog box may not display if the PSA_MCKESSON_UPLOAD desktop shortcut is configured to connect to a specific VistA instance.
...
Figure 3: Security certificate window

![](drug-accountability-inventory-interface-version-3-user-manual/009.png)

After clicking OK the PIV PIN dialog box appears. Enter the associated PIV pin and click OK.

Figure 4: Example of PIV PIN dialog box

![](drug-accountability-inventory-interface-version-3-user-manual/010.png)

The System Use Notification dialog box appears, click OK.

<span id="_Ref86063808" class="anchor"></span>Figure 5: Example System Use Notification Dialog Box

![](drug-accountability-inventory-interface-version-3-user-manual/011.png)

The Select Division dialog box appears, select the correct division and click "OK".

<span id="_Ref86063812" class="anchor"></span>Figure 6: Example Select Division Dialog Box

![](drug-accountability-inventory-interface-version-3-user-manual/012.png)

![](drug-accountability-inventory-interface-version-3-user-manual/013.png) Note: The Select Division dialog box may not display if the user has only been assigned one division.
...
Figure 7: Example of Successful Upload Screen

![](drug-accountability-inventory-interface-version-3-user-manual/014.png)
...
Figure 8: Example of VistA MailMan Upload Status report

![](drug-accountability-inventory-interface-version-3-user-manual/015.png)
...
<span id="_Ref86063819" class="anchor"></span>Figure 9: Example Error Message, Unable to Find Invoice

![](drug-accountability-inventory-interface-version-3-user-manual/016.png)

The user should then select the Find Invoice option located under the File menu.

<span id="_Ref86063823" class="anchor"></span>Figure 10: Example Find Invoice

![](drug-accountability-inventory-interface-version-3-user-manual/017.png)

Navigate to where you stored the file on the workstation. When the appropriate folder is opened, the program will search for the Invoice file using predefined search parameters. If the file is found, the filename will display in the text box at the bottom of the screen. Click on the file name to select and click OPEN to continue processing. You can also Double Click on the file to select and continue processing.

<span id="_Ref86063826" class="anchor"></span>Figure 11: Example Invoice File Found

![](drug-accountability-inventory-interface-version-3-user-manual/018.png)

![](drug-accountability-inventory-interface-version-3-user-manual/019.png) Note: You can also Double Click the invoice file to select it and continue processing.
...
<span id="_Ref86063829" class="anchor"></span>

Figure 12: Example Invoice PO ID# Not Valid Length

![](drug-accountability-inventory-interface-version-3-user-manual/020.png)

<span id="_Ref86063832" class="anchor"></span>Figure 13: Example Invoice Failed Security Check

![](drug-accountability-inventory-interface-version-3-user-manual/021.png)
