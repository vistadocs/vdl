---
title: PSJ*5*260/268 Technical Manual/Security Guide Change Pages
doc_type: TM
...
<p>Fix page numbering to eliminate pages with number 70 Changed wording in Section 14.5</p>
<p>Added Integration Agreement Added three new Hidden Actions</p>
...
<td><p>Added new Routine Added new API</p>
<p>Added new Integration Agreement</p>
<p><mark>REDACTED</mark></p></td>
</tr>
<tr class="even">
<td>01/2012</td>
<td><p>i-ii, v-viii 22, 23</p>
<blockquote>
<p>69</p>
<p>94</p>
</blockquote></td>
...
<td><p>Updated Table of Contents Updated Routines</p>
<p>Added API</p>
...
<td>04/2011</td>
<td><blockquote>
<p>i, v, vi, vii, vii, 5- 8b, (changed flow) 22,</p>
</blockquote>
<p>23, 24,</p>
<blockquote>
<p>removed 25-26,</p>
...
<td><p>Changes to <em>Revision History</em>, <em>Table of Contents</em>; added new field to PHARMACY SYSTEM File (#59.7), added new field to the INPATIENT WARD PARAMETERS File (#59.6). Added</p>
...
<tr class="odd">
<td></td>
<td>PSODRDU2. Added the items DATUP, MOCHA, PECS, and</td>
</tr>
<tr class="even">
<td></td>
<td>PEPS in Glossary, which shifted all subsequent glossary items.</td>
</tr>
<tr class="odd">
<td></td>
...
<p>field.</p>
<p>In Section 9.5, made correction to include the priority of ASAP in notifications. Added information regarding the three</p></td>
</tr>
</tbody>
</table>
...
<td></td>
<td></td>
<td><p>notifications parameters.</p>
<p><mark>REDACTED</mark></p></td>
</tr>
<tr class="even">
<td>12/2005</td>
...
> CUSTODIAL PACKAGE: OUTPATIENT PHARMACY SUBSCRIBING PACKAGE: INPATIENT MEDICATIONS
...
> Select DBA Option: INTEGRATIon Agreements Menu Select Integration Agreements Menu Option: INQUIRe
...
<thead>
<tr class="header">
<th><strong>Patient/Order Action Prompts (continued)</strong></th>
<th><blockquote>
<p>RN</p>
</blockquote></th>
<th><blockquote>
...
> order entry procedure as the regular syringe IV type. Its administration may be continuous or intermittent. The pharmacist selects the type when the level of toxicity of the chemotherapy drug is low and needs to be infused
> directly into the patient within a short time interval (usually 1-2 minutes).
...
> Center’s pharmacy. Hospital supplied self med is only
> prompted for if the user answers Yes to the SELF MED prompt during order entry.
...
> Fluids order dialog. The duration may be specified in
> terms of volume (liters or milliliters), or time (hours or days). Inpatient Medications uses this value to calculate a default stop date/time for the order at the time the order is finished.
...
> manufacturing list will be run and IV orders prepared. This field in the *SIte Parameters (IV)* \[PSJI SITE
> PARAMETERS\] option (IV ROOM file (#59.5)) is for documentation only and does not affect IV processing.
...
> Possible Dosages Dosages that have a numeric dosage and numeric dispense units per dose appropriate for administration. For a drug to have possible dosages, it must be a single
> ingredient product that is matched to the VA PRODUCT file (#50.68). The VA PRODUCT file
...
> Quick Code An abbreviated form of the drug generic name (from one to ten characters) for IV orders. One of the three
> drug fields on which lookup is done to locate a drug. Print name and synonym are the other two. Use of quick codes will speed up order entry, etc.
