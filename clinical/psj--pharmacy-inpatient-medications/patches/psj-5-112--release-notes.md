---
title: PSJ*5*112 Release Notes-IMO-Phase I  II and IMR-Phase II
doc_type: RN
doc_label: Release Notes
doc_layer: patch
doc_subject: IMO-Phase I  II and IMR-Phase II
app_code: PSJ
...
revision_newest: 
revision_oldest: 
docx_url: "https://www.va.gov/vdl/documents/Clinical/Pharm-Inpatient_Med/psj_5_p112_rn.docx"
pdf_url: "https://www.va.gov/vdl/documents/Clinical/Pharm-Inpatient_Med/psj_5_p112_rn.pdf"
app_url: "https://www.va.gov/vdl/application.asp?appid=88"
---

> ![](psj-5-112-release-notes-imo-phase-i-ii-and-imr-phase-ii/001.png)

Inpatient Medication Orders for Outpatients – Phase I & IIandInpatient Medication Reqs for SFG IRA – Phase II
...
![](psj-5-112-release-notes-imo-phase-i-ii-and-imr-phase-ii/002.png)Note: PSI-03-060 "IV Fluid Dialog" has been addressed in CPRS GUI V. 25 by adding a new field "Duration or Total Volume" to the IV dialog per the CPRS Clinical Workgroup recommendation. By using this field, a user can specify administrative duration or total volume for the IV order. This new field, when utilized as a duration, however, will override the IV Room site parameter LVP'S GOOD FOR HOW MANY DAYS, as well as any other time restrictions on Orderable Items. Additional CPRS Clinical and Inpatient Medications Workgroup discussion is necessary to determine a resolution to this issue.
*(This page included for two-sided copying.)*
...
![](psj-5-112-release-notes-imo-phase-i-ii-and-imr-phase-ii/003.png)Note: No changes are forced for currently active orders. However, when an action other than discontinue is taken on the order, the software will require the user to select a schedule that meets the valid schedule conditions listed above.
