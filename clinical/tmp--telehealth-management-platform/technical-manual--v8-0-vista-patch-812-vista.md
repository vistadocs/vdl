---
title: TMP Version 8.0 Vista Patch 812 VistA Technical Manual
doc_type: TM
doc_label: Technical Manual
doc_layer: anchor
doc_subject: Vista Patch 812 VistA
app_code: TMP
...
revision_newest: 
revision_oldest: 
docx_url: "https://www.va.gov/vdl/documents/Clinical/Telehealth_Management_Platform/tmp_vista_technical_manual_v09.docx"
pdf_url: "https://www.va.gov/vdl/documents/Clinical/Telehealth_Management_Platform/tmp_vista_technical_manual_v09.pdf"
...
![](tmp-version-8-0-vista-patch-812-vista-technical-manual/001.png)

November 2021Version 1.1Revision History

| Date      | Version | Description                      | Author       |
|---------------|-------------|--------------------------------------|------------------|
| November 2021 | 1.1         | Add HL7 information for SD\*5.3\*780 | Mumps Team       |
| June 2019     | 1.0         | Initial version for submission       | Development Team |
# Introduction
...
![](tmp-version-8-0-vista-patch-812-vista-technical-manual/002.png)
...
| SEQ | LEN | DT  | OPT | RP/# | TBL# | ITEM# | ELEMENT NAME                            | VISTA DESCRIPTION                                                                          |
|-----|-----|-----|-----|------|------|-------|-----------------------------------------|--------------------------------------------------------------------------------------------|
| 1   | 4   | SI  | R   |      |      | 890   | Set ID - AIS                            |  Segment Sequence Number                                                                   |
