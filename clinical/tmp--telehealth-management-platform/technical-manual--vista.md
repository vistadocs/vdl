...
![](tmp-version-4-0-release-4-9-0-8-vista-technical-manual/001.png)

November 2021Version 1.1Revision History

| Date      | Version | Description                      | Author      |
|---------------|-------------|--------------------------------------|-----------------|
| November 2021 | 1.1         | Add HL7 information for SD\*5.3\*780 | Donald Finnie   |
| June 2019     | 1.0         | Initial version for submission       | Phil Burkhalter |
# Introduction
