---
title: TMP Version 9.4 Vista Emergency Patch 848 DIBRG
doc_type: DIBR
doc_label: Deployment, Installation, Back-Out, and Rollback Guide
doc_layer: patch
doc_subject: Vista Emergency Patch 848 DIBRG
app_code: TMP
...
pub_date: April 2023
revision_count: 1
revision_newest: 04/27/2023
revision_oldest: 04/27/2023
docx_url: "https://www.va.gov/vdl/documents/Clinical/Telehealth_Management_Platform/sd_5_3_848_dibrg.docx"
pdf_url: "https://www.va.gov/vdl/documents/Clinical/Telehealth_Management_Platform/sd_5_3_848_dibrg.pdf"
app_url: "https://www.va.gov/vdl/application.asp?appid=231"
---

Scheduling Package EnhancementPatch SD\*5.3\*848

Deployment, Installation, Back-Out, and Rollback Guide

![](tmp-version-9-4-vista-emergency-patch-848-dibrg/001.png)
...
|------------|---------|------------------------|----------|
| 04/27/2023 | 1.0.0   | Initial Document Draft | Redacted |
|            |         |                        |          |
...
The Deployment, Installation, Back-Out and Rollback Guide defines the ordered, technical steps required to install the product, back out the installation (if necessary), and roll back to the previously installed version of the product. It provides installation instructions for the SD\*5.3\*848 patch

## Purpose 

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

The purpose of this Guide is to provide installation steps for the SD\*5.3\*848 patch. The intended audience for this document is the Information Resource Management Systems (IRMS) staff. Some of the main features of this patch are the following:

This patch consists of the following:

- TMP-2224: Fix Appointment Request Type in Intra-Facility Appt

An issue has been identified with Intra-facility appointments that the patient side appointment is not correctly pointing to the APPOINTMENT REQUEST file (#409.85) entry.

> This patch fixes this issue and make sure data in not missing in Patient or Provider appointments.
...
1.  Select the Verify Checksums in Transport Global option to confirm the integrity of the routines that are in the transport global. When prompted for the INSTALL NAME enter the patch or build name (ex. SD\*5.3\*848).
...
2.  At the Select INSTALL NAME prompt, enter your build SD\*5.3\*848.
...
User Acceptance Testing will be completed by the time patch SD\*5.3\*848 is released.
...
If you have any questions concerning the implementation of this application, contact the VA Service Desk at 1-855-673-4357 directly or log a ticket via VA yourIT Service Portal application
