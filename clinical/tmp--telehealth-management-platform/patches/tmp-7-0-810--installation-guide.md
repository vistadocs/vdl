---
title: TMP Version 7.0 VistA Patch 810 DIBRG
doc_type: DIBR
doc_label: Deployment, Installation, Back-Out, and Rollback Guide
doc_layer: patch
doc_subject: VistA Patch 810 DIBRG
app_code: TMP
...
pub_date: March 2022
revision_count: 2
revision_newest: 3/29/2022
revision_oldest: 2/15/2022
docx_url: "https://www.va.gov/vdl/documents/Clinical/Telehealth_Management_Platform/SD_53_810_DIBRG.docx"
pdf_url: "https://www.va.gov/vdl/documents/Clinical/Telehealth_Management_Platform/SD_53_810_DIBRG.pdf"
app_url: "https://www.va.gov/vdl/application.asp?appid=231"
---

Scheduling Package EnhancementPatch SD\*5.3\*810

Deployment, Installation, Back-Out, and Rollback Guide

![](tmp-version-7-0-vista-patch-810-dibrg/001.png)
...
|-----------|---------|---------------------------------|---------------------|
| 2/15/2022 | 1.0.0   | Initial Document Draft          | Booz Allen Hamilton |
| 3/29/2022 | 1.0.1   | Updated for added functionality | Booz Allen Hamilton |
...
The Deployment, Installation, Back-Out and Rollback Guide defines the ordered, technical steps required to install the product, back out the installation (if necessary), and roll back to the previously installed version of the product. It provides installation instructions for the SD\*5.3\*810 patch

## Purpose 

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

The purpose of this Guide is to provide installation steps for the SD\*5.3\*810 patch. The intended audience for this document is the Information Resource Management Systems (IRMS) staff. Some of the main features of this patch are the following:

This patch consists of the following emergency correction to SD\*5.3\*773:

INC20687509 - TMP Appointments are sporadically coming into VistA with the wrong dates

This patch includes code to correctly translate appointment dates and times from TMP to VistA. These problems generally occurred with appointments after 5pm.

This patch also corrects an error when VistA was filing an appointment from TMP. A variable incorrectly defined in TMP code has been fixed.
...
1.  Select the Verify Checksums in Transport Global option to confirm the integrity of the routines that are in the transport global. When prompted for the INSTALL NAME enter the patch or build name (ex. SD\*5.3\*810).
...
2.  At the Select INSTALL NAME prompt, enter your build SD\*5.3\*810.
...
There is no post-install routine for SD\*5.3\*810
...
User Acceptance Testing will be completed by the time patch SD\*5.3\*810 is released.
...
If you have any questions concerning the implementation of this application, contact the VA Service Desk at REDACTED directly or log a ticket via VA yourIT Service Portal application REDACTED
