---
title: TMP Version 5.0 VistA Patch 806 DIBRG
doc_type: DIBR
doc_label: Deployment, Installation, Back-Out, and Rollback Guide
doc_layer: patch
doc_subject: VistA Patch 806 DIBRG
app_code: TMP
...
revision_count: 1
revision_newest: 1/28/2022
revision_oldest: 1/28/2022
docx_url: "https://www.va.gov/vdl/documents/Clinical/Telehealth_Management_Platform/SD_5p3_806_DIBRG.docx"
pdf_url: "https://www.va.gov/vdl/documents/Clinical/Telehealth_Management_Platform/SD_5p3_806_DIBRG.pdf"
app_url: "https://www.va.gov/vdl/application.asp?appid=231"
---

Scheduling Package EnhancementPatch SD\*5.3\*806

Deployment, Installation, Back-Out, and Rollback Guide

![](tmp-version-5-0-vista-patch-806-dibrg/001.png)
...
|-----------|---------|------------------------|--------|
| 1/28/2022 | 1.0.0   | Initial Document Draft | LTS    |
...
The Deployment, Installation, Back-Out and Rollback Guide defines the ordered, technical steps required to install the product, back out the installation (if necessary), and roll back to the previously installed version of the product. It provides installation instructions for the SD\*5.3\*806 patch

## Purpose 

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

The purpose of this Guide is to provide installation steps for the SD\*5.3\*806 patch. The intended audience for this document is the Information Resource Management Systems (IRMS) staff. Some of the main features of this patch are the following:

This patch includes code to prevent an error from occurring when restoring canceled clinic time in VistA. This error occurred when restoring canceled clinic time for a date that has a special pattern defined.

When a user deletes all appointment availability for a clinic for a day using SDBUILD, VistA will transmit a Reserve Resource transaction to TMP to block that day.

When a user adds appointment availability to a clinic for a day that did not previously have availability, VistA will transmit a Cancel Reserve Resource transaction to TMP to unblock that day.
...
1.  Select the Verify Checksums in Transport Global option to confirm the integrity of the routines that are in the transport global. When prompted for the INSTALL NAME enter the patch or build name (ex. SD\*5.3\*806).
...
2.  At the Select INSTALL NAME prompt, enter your build SD\*5.3\*806.
...
There is no post-install routine for SD\*5.3\*806
...
User Acceptance Testing will be completed by the time patch SD\*5.3\*806 is released.
