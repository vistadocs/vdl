---
title: TMP Version 9.1 VistA Patch 821 Technical Manual
doc_type: TM
...
revision_newest: 
revision_oldest: 
docx_url: "https://www.va.gov/vdl/documents/Clinical/Telehealth_Management_Platform/tmp_vista_technical_manual_821.docx"
pdf_url: "https://www.va.gov/vdl/documents/Clinical/Telehealth_Management_Platform/tmp_vista_technical_manual_821.pdf"
...
![](tmp-version-9-1-vista-patch-821-technical-manual/001.png)

October 2022Version 1.2Revision History

| Date      | Version | Description                      | Author |
|---------------|-------------|--------------------------------------|------------|
| October 2022  | 1.2         | SD\*5.3\*821 Updates                 | TMP Team   |
| November 2021 | 1.1         | Add HL7 information for SD\*5.3\*780 | TMP Team   |
| June 2019     | 1.0         | Initial version for submission       | TMP Team   |
# Introduction
...
- [VistA Clinic Schedule Edit Queuing](#vista-clinic-schedule-edit-queuing)
...
![](tmp-version-9-1-vista-patch-821-technical-manual/002.png)
...
<span id="_Toc115355196" class="anchor"></span>AX Cross Reference  
...
<span id="_Toc115355197" class="anchor"></span>AY Cross Reference  
...
<span id="_Toc115355198" class="anchor"></span>Style Cross Reference
...
# VistA Clinic Schedule Edit Queuing
...
The transactions will only be delayed while the clinic editor is working on a single clinic. Once they move on to the next clinic, the transactions are processed.

These transactions are held in a temporary global, XTMP. The lay out is as follows:

^XTMP(“SDTMPX”,JOB,SEQUENCE)=Clinic^time stamp (\$H)^Clinic Date^User DUZ^Transaction^Result

The tranaction can be C – BLOCK CLINIC DAY or UC – UNBLOCK CLINIC DAY  
Result can be P – Processed (sent) or O–Offset (not sent)