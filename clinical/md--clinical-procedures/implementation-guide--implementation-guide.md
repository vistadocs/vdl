...
Implementation GuideMD\*1.0\*42March 2016Department of Veterans AffairsOffice of Information &Technology (OI&T)Product Development
...
![](md-1-42-implementation-guide-cp-flowsheets/002.png)

Figure ‑ CP Gateway Service
...
![](md-1-42-implementation-guide-cp-flowsheets/003.png)

Figure ‑, CP Console Window
...
![](md-1-42-implementation-guide-cp-flowsheets/004.png)
...
![](md-1-42-implementation-guide-cp-flowsheets/005.png)
...
![](md-1-42-implementation-guide-cp-flowsheets/006.png)
...
![](md-1-42-implementation-guide-cp-flowsheets/007.png)

Figure ‑, Rename Flowsheet
...
![](md-1-42-implementation-guide-cp-flowsheets/008.png)

Figure ‑, CP Console Button Bar
...
![](md-1-42-implementation-guide-cp-flowsheets/009.png)

Figure ‑, Confirm Delete
...
![](md-1-42-implementation-guide-cp-flowsheets/010.png)
...
![](md-1-42-implementation-guide-cp-flowsheets/011.png)

Figure ‑, Console Find It Utility
...
![](md-1-42-implementation-guide-cp-flowsheets/012.png)

Figure ‑, Access Control List Manager
...
Figure ‑, CP Console Folder View Permissions
...
![](md-1-42-implementation-guide-cp-flowsheets/014.png)
...
![](md-1-42-implementation-guide-cp-flowsheets/015.png)

Figure ‑, CP Console Export Wizard

7.  Click Next. The CP Console Export Wizard asks you to select the type of items to export.

![](md-1-42-implementation-guide-cp-flowsheets/016.png)

Figure ‑, CP Console Export Wizard Select Type
...
![](md-1-42-implementation-guide-cp-flowsheets/017.png)
...
![](md-1-42-implementation-guide-cp-flowsheets/018.png)

Figure ‑, Export Filename and Comments
...
![](md-1-42-implementation-guide-cp-flowsheets/019.png)

Figure ‑, CP Console Export Wizard File Preview

2.  You can scroll to review the XML file. To export the file, click Next.

![](md-1-42-implementation-guide-cp-flowsheets/020.png)

Figure ‑, CP Console Export Wizard Success
...
![](md-1-42-implementation-guide-cp-flowsheets/021.png)
...
![](md-1-42-implementation-guide-cp-flowsheets/022.png)

Figure ‑, CP Console Tree View
...
![](md-1-42-implementation-guide-cp-flowsheets/023.png)

Figure ‑, Item Detail Area
...
![](md-1-42-implementation-guide-cp-flowsheets/025.png)

Figure ‑, CP Console Import Wizard

10. Click Next. The CP Console Import Wizard asks you to enter or select the name of the file to import.

![](md-1-42-implementation-guide-cp-flowsheets/026.png)

Figure ‑, CP Console Import Wizard Import Filename
...
![](md-1-42-implementation-guide-cp-flowsheets/027.png)

Figure ‑, CP Console Import Wizard File Header

12. Click Next. The CP Console Import Wizard asks you to select the components to import.

![](md-1-42-implementation-guide-cp-flowsheets/028.png)

Figure ‑, CP Console Import Wizard Select Components
...
![](md-1-42-implementation-guide-cp-flowsheets/029.png)

Figure ‑, CP Console Import Wizard Confirm
...
![](md-1-42-implementation-guide-cp-flowsheets/030.png)

Figure ‑, CP Console Import Wizard Progress Report

16. When the import is complete, click Finish.

![](md-1-42-implementation-guide-cp-flowsheets/031.png)

Figure ‑, Close Application Confirmation
...
![](md-1-42-implementation-guide-cp-flowsheets/032.png)

Figure ‑, Imported Views
...
![](md-1-42-implementation-guide-cp-flowsheets/033.png)

Figure ‑, Make Copy Button

19. The Confirm Copy pop-up appears.

![](md-1-42-implementation-guide-cp-flowsheets/034.png)

Figure ‑, Confirm Copy

20. Click Yes. The copied view appears in the tree view.

![](md-1-42-implementation-guide-cp-flowsheets/035.png)
...
![](md-1-42-implementation-guide-cp-flowsheets/036.png)

Figure ‑, Rename Button

22. The Rename Flowsheet window appears.
23. In the New Name field, rename your flowsheet view.

    ![](md-1-42-implementation-guide-cp-flowsheets/037.png)
...
![](md-1-42-implementation-guide-cp-flowsheets/038.png)

Figure ‑, Protecting an Imported or Exported View
...
![](md-1-42-implementation-guide-cp-flowsheets/039.png)

Figure ‑, Create New Flowsheet View
...
![](md-1-42-implementation-guide-cp-flowsheets/040.png)

Figure ‑ Flowsheet View Worksheet
...
14. If the Active check box is not selected, the view does not load and you cannot enter data. A pop-up appears to indicate that the view is not active. The inactive view may display in the report.  
    In the tree view, an active view appears with ![](md-1-42-implementation-guide-cp-flowsheets/041.png).

![](md-1-42-implementation-guide-cp-flowsheets/042.png)
...
![](md-1-42-implementation-guide-cp-flowsheets/043.png)

Figure ‑, View Terminology Editor
...
35. Click ![](md-1-42-implementation-guide-cp-flowsheets/044.png). The View Terminology Editor window appears.

![](md-1-42-implementation-guide-cp-flowsheets/045.png)
...
47. Click ![](md-1-42-implementation-guide-cp-flowsheets/046.png) to move the term up in the display order or click ![](md-1-42-implementation-guide-cp-flowsheets/047.png) to move the term down in the display order.
48. Click Save.
...
![](md-1-42-implementation-guide-cp-flowsheets/048.png)

Figure ‑, Terminology List

49. Click ![](md-1-42-implementation-guide-cp-flowsheets/049.png). The View Terminology Editor window appears.

![](md-1-42-implementation-guide-cp-flowsheets/050.png)
...
51. If the term has qualifiers, change any or all of the qualifiers/descriptors in the Qualifiers section.
    ...
    ![](md-1-42-implementation-guide-cp-flowsheets/051.png)

> Figure ‑, Inactive Term
...
![](md-1-42-implementation-guide-cp-flowsheets/052.png)

Figure ‑, Terminology List

55. Click ![](md-1-42-implementation-guide-cp-flowsheets/053.png). Confirm pop-up appears.

![](md-1-42-implementation-guide-cp-flowsheets/054.png)

Figure ‑, Confirm Pop-up
...
![](md-1-42-implementation-guide-cp-flowsheets/055.png)

Figure ‑, Create New Flowsheet
...
![](md-1-42-implementation-guide-cp-flowsheets/056.png)

Figure ‑, New Flowsheet Worksheet
...
1.  Select the Pages tab and click ![](md-1-42-implementation-guide-cp-flowsheets/057.png). The New Flowsheet Page window appears.

![](md-1-42-implementation-guide-cp-flowsheets/058.png)

Figure ‑, New Flowsheet Page
...
![](md-1-42-implementation-guide-cp-flowsheets/059.png)
...
![](md-1-42-implementation-guide-cp-flowsheets/060.png)

Figure ‑, Pages Tab

71. Click ![](md-1-42-implementation-guide-cp-flowsheets/061.png). The Edit Flowsheet Page window appears.
...
![](md-1-42-implementation-guide-cp-flowsheets/062.png)

Figure ‑, Highlight View to Delete

78. Click ![](md-1-42-implementation-guide-cp-flowsheets/063.png).
79. Click Save.
...
![](md-1-42-implementation-guide-cp-flowsheets/064.png)

Figure ‑, Highlight View to Move

80. Click ![](md-1-42-implementation-guide-cp-flowsheets/065.png) to move the view up in the display order or click ![](md-1-42-implementation-guide-cp-flowsheets/066.png) to move the view down in the display order.
81. Click Save.
...
![](md-1-42-implementation-guide-cp-flowsheets/067.png)

Figure ‑, Active Date Ranges
...
![](md-1-42-implementation-guide-cp-flowsheets/068.png)

Figure ‑, Create a Flowsheet Total

![](md-1-42-implementation-guide-cp-flowsheets/069.png)

Figure ‑, Totals Display from CP Flowsheets
...
![](md-1-42-implementation-guide-cp-flowsheets/070.png)

Figure ‑, Create a New Flowsheet Total
...
1.  To move a term from the Available Terms list, select the term and click ![](md-1-42-implementation-guide-cp-flowsheets/071.png) to move it into the Selected Terms list.
89. To move a term from the Selected Terms list, select the term and click ![](md-1-42-implementation-guide-cp-flowsheets/072.png) to move it into the Available Terms list.
90. Repeat steps 1 and 2 as many times as is necessary.
91. To arrange the list of Selected Terms in a specific display order, select a term and click ![](md-1-42-implementation-guide-cp-flowsheets/073.png) to move the term up the display order or ![](md-1-42-implementation-guide-cp-flowsheets/074.png) to move the term down the display order.
...
![](md-1-42-implementation-guide-cp-flowsheets/075.png)
...
94. Click ![](md-1-42-implementation-guide-cp-flowsheets/076.png). The total moves to the Assigned Totals list.
95. Click Save.
...
96. Click ![](md-1-42-implementation-guide-cp-flowsheets/077.png). The total returns to the Available Totals list.
97. Click Save.
...
98. Click ![](md-1-42-implementation-guide-cp-flowsheets/078.png) to move the total up in the display order or click ![](md-1-42-implementation-guide-cp-flowsheets/079.png) to move the total down in the display order.
99. Click Save.
...
![](md-1-42-implementation-guide-cp-flowsheets/080.png)

Figure ‑, Create New Flowsheet Total

2.  In the Name box, type a name for the new Flowsheet Total and click OK
3.  The new Flowsheet Total worksheet appears.

![](md-1-42-implementation-guide-cp-flowsheets/081.png)

Figure ‑, Build a Flowsheet Total
...
25. If the Active check box is not selected, the flowsheet total does not load and you cannot enter data. A pop-up appears to indicate that the flowsheet total is not active. The inactive flowsheet total may display in the report.  
    In the tree view, an active flowsheet total appears ![](md-1-42-implementation-guide-cp-flowsheets/082.png).

![](md-1-42-implementation-guide-cp-flowsheets/083.png)

Figure ‑, Active Flowsheet
...
26. If the Active check box is not selected, you cannot use the shift in your flowsheets.  
    In the tree view, an active shift appears ![](md-1-42-implementation-guide-cp-flowsheets/084.png).

![](md-1-42-implementation-guide-cp-flowsheets/085.png)
...
![](md-1-42-implementation-guide-cp-flowsheets/086.png)

Figure ‑, Create New Shift
...
![](md-1-42-implementation-guide-cp-flowsheets/087.png)

Figure ‑, Shift Worksheet
...
![](md-1-42-implementation-guide-cp-flowsheets/089.png)

Figure ‑, Background Tasks

Select one of the background tasks and its properties appear.

![](md-1-42-implementation-guide-cp-flowsheets/090.png)

Figure ‑, CliO Cleanup Background Task Properties
...
![](md-1-42-implementation-guide-cp-flowsheets/091.png)

Figure ‑, Create New Instrument
...
![](md-1-42-implementation-guide-cp-flowsheets/092.png)

Figure ‑, New Instrument Worksheet
...
![](md-1-42-implementation-guide-cp-flowsheets/093.png)

Figure ‑, Selected Instrument
...
![](md-1-42-implementation-guide-cp-flowsheets/094.png)

Figure ‑, Make Copy Button

127. The Confirm Copy dialog box is displayed.

![](md-1-42-implementation-guide-cp-flowsheets/095.png)
...
![](md-1-42-implementation-guide-cp-flowsheets/096.png)

Figure ‑, Rename Button

2.  The Rename Instrument window appears.

![](md-1-42-implementation-guide-cp-flowsheets/097.png)

Figure ‑, Rename Instrument
...
![](md-1-42-implementation-guide-cp-flowsheets/098.png)

Figure ‑, Active Instrument
...
![](md-1-42-implementation-guide-cp-flowsheets/099.png)

Figure ‑, CP Console Parameters
...
![](md-1-42-implementation-guide-cp-flowsheets/100.png)

Figure ‑, Clinical Procedures Common Parameter Set
...
![](md-1-42-implementation-guide-cp-flowsheets/101.png)

Figure ‑, Notification List Editor
...
Use ![](md-1-42-implementation-guide-cp-flowsheets/102.png) to browse to the appropriate location in the directory.
...
Use ![](md-1-42-implementation-guide-cp-flowsheets/103.png) to browse to the appropriate location.
...
![](md-1-42-implementation-guide-cp-flowsheets/104.png)

Figure ‑, ADT Feed Configuration
...
![](md-1-42-implementation-guide-cp-flowsheets/105.png)

Figure ‑, Add ADT Target
...
![](md-1-42-implementation-guide-cp-flowsheets/106.png)

Figure ‑, CP Gateway Configuration Settings
...
![](md-1-42-implementation-guide-cp-flowsheets/107.png)

Figure ‑, Edit Procedure
...
![](md-1-42-implementation-guide-cp-flowsheets/108.png)

Figure ‑, Create New Procedure
...
![](md-1-42-implementation-guide-cp-flowsheets/109.png)

Figure ‑, Procedure Worksheet
...
![](md-1-42-implementation-guide-cp-flowsheets/110.png)

Figure ‑, Make Copy Button

4.  The Confirm Copy dialog box is displayed.

![](md-1-42-implementation-guide-cp-flowsheets/111.png)
...
![](md-1-42-implementation-guide-cp-flowsheets/112.png)

Figure ‑, Rename Button

6.  The Rename Procedure window appears.

![](md-1-42-implementation-guide-cp-flowsheets/113.png)

Figure ‑, Rename Procedure
...
![](md-1-42-implementation-guide-cp-flowsheets/114.png)

Figure ‑, Treating Specialty
...
35. If the Active check box is not selected, you cannot use the procedure in your flowsheets.  
    In the tree view, an active procedure appears ![](md-1-42-implementation-guide-cp-flowsheets/115.png).

![](md-1-42-implementation-guide-cp-flowsheets/116.png)

Figure ‑, Active Procedure
...
![](md-1-42-implementation-guide-cp-flowsheets/117.png)
...
![](md-1-42-implementation-guide-cp-flowsheets/118.png)

Figure ‑, Allowable Instruments
...
> About 20
> Access Control List Manager 13
> Add a Procedure 70
> Add a Shift 54
> Add a User 14
> Add a View to a Flowsheet 44
> Add an ADT Target 67
> Add an Instrument 59
> Add Permissions 14
> Add Terms to a View 34
> Add Terms to Flowsheet Totals 50
> Add Totals to a Flowsheet 51
...
> Change the Display Order of Terms 50
> Change the Display Order of Terms in a View 38 Change the Display Order of Totals in a
> Flowsheet 52
> Change the Display Order of Views in a Flowsheet 47
> CliO Database 2
> Contents 20
> CP ADT Feed Configuration
> Add ADT target 67
> Current ADT targets 66
> CP Console 3
> CP Console Button Bar
> Permissions 13
> CP Console Detail Area 21
> CP Console Functionality
> Creating a flowsheet total 48
> Creating a flowsheet view 32
> CP Console Menu Bar 9
> File menu 9
> Help menu 20
> CP Console Tree View 20
> Flowsheet total 52
> Parameters 60
> Procedure 69
> CP Flowsheets 3
> CP Gateway 1
> CP Gateway Configuration
> Gateway server settings 68
> VistA server settings 68
> CP Gateway Service 1
> CP Parameters
> Allow CliO cached queries 65
> Allow external attachments 64, 65
> Bypass CRC check 65
> Clinical procedures system on line 65
> CP common parameter set 64
> Imaging network transfer directory 64, 65

####### Instrument data retention 65

> Observation retrieval batch size 65

####### Unverified observation retention 65
...
> Gateway Server Settings
> CP/imaging xfer directory 69
> Days to retain data 69
> Log directory 69
> Log level 69
> Notify port 69
> Polling interval 69
> Gateway Server Settings
> Data retrieval mechanism 69
> H
> Help Menu
> About 20
> Contents 20
> I
> Instrument Add 59
> Default file extension 61
> Delete when submitted 61
> HL7 instrument ID 62
> HL7 link 62
> HL7 universal service ID 62
> IP address 62
> M routine 61
> Pkg code 61
> Port 62
> Serial number 61
> Valid attachment types 61
> K
> Key
> MD ADMINISTRATOR 15
> MD MANAGER 16
> M
> Modify an Existing Procedure 71
> Modify an Existing Shift 55
> N
> New 10
> P
> Parameters 60
> Adding an ADT target 67
> CP ADT feed configuration 65
> CP gateway configuration 67
> CP parameters 63
> Permissions 13
> Access control list manager 13
> Adding a user 14
> Adding permissions 14
> Person Lookup 14
> Removing user 15
> Person Lookup 14
> Procedure 69
> Add 70
> Allowable instruments 73
> Auto submit to VistA imaging 72
> External attachment directory 72
> High volume instrument 73
> Hospital location 72
> Modifying existing 71
> Processed results 73
> Processing application 73
> Require external data 72
> TIU note title 72
> Treating specialty 72
> Product Benefits 1
...
> Qualifiers 37
> Use dropdown 36
> Terminology Mapping 3
> Tools Menu
> Export to XML 16, 17, 18, 19, 23, 25, 27
> Refresh roles 15
> Search 12
> U
> User
