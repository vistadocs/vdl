---
title: Clinical Procedures Version 1 User Manual
doc_type: UM
...
![](clinical-procedures-version-1-user-manual/001.png)

Version 1.0May 2008Revised August 2014Department of Veterans AffairsOffice of Information and Technology (OI&T)Product Development
...
<tbody>
<tr class="odd">
<td><p><a href="#fn1" class="footnote-ref" id="fnref1" role="doc-noteref"><sup>1</sup></a>Patch MD*1.0*29 – Updated for ICD-10 release.</p>
<p>Updated Title page</p>
<p>Added Revision History pp. i-ii</p>
<p>pp. <a href="#icd101">3-24</a>: Updated Summary Tab section to include ICD-10 code and added a note and updated screenshot.</p>
<p>pp.<a href="#icd102">4-2</a>: Updated to include ICD-10 code reference.</p></td>
<td>August 2014</td>
...
<tr class="odd">
<td><p><a href="#fn3" class="footnote-ref" id="fnref3" role="doc-noteref"><sup>3</sup></a>Patch MD*1.0*19 released.</p>
...
<tr class="even">
<td><a href="#fn4" class="footnote-ref" id="fnref4" role="doc-noteref"><sup>4</sup></a>Patch MD*1.0*6 released.</td>
<td>May 2008</td>
<td><mark>REDACTED</mark></td>
</tr>
</tbody>
...
<hr />
<ol>
<li id="fn1"><p>MD*1.0*29 August 2014 ICD-10 Patch 29 release added.<a href="#fnref1" class="footnote-back" role="doc-backlink">↩︎</a></p></li>
<li id="fn2"><p>MD*1.0*20 November 2010 Patch 20 release added.<a href="#fnref2" class="footnote-back" role="doc-backlink">↩︎</a></p></li>
<li id="fn3"><p>MD*1.0*19 March 2009 Patch 19 release added.<a href="#fnref3" class="footnote-back" role="doc-backlink">↩︎</a></p></li>
<li id="fn4"><p>MD*1.0*6 May 2008 Patch 6 release added.<a href="#fnref4" class="footnote-back" role="doc-backlink">↩︎</a></p></li>
</ol>
</aside>
# Introduction
...
![](clinical-procedures-version-1-user-manual/002.png)
...
![](clinical-procedures-version-1-user-manual/003.png)

Figure 2‑2

3.  Click the Consults tab at the bottom of the window (Figure 2‑3).

![](clinical-procedures-version-1-user-manual/004.png)
...
> ![](clinical-procedures-version-1-user-manual/005.png)
...
![](clinical-procedures-version-1-user-manual/006.png)
...
> ![](clinical-procedures-version-1-user-manual/007.png)
...
![](clinical-procedures-version-1-user-manual/008.png)
...
> ![](clinical-procedures-version-1-user-manual/009.png)

Figure 2‑8

14. The Electronic Signature window displays (Figure 2‑9). Enter your signature code, then click OK.

![](clinical-procedures-version-1-user-manual/010.png)
...
![](clinical-procedures-version-1-user-manual/011.png)
...
![](clinical-procedures-version-1-user-manual/012.png)
...
![](clinical-procedures-version-1-user-manual/013.png)
...
Double-click the Hemodialysis icon on your desktop. If you are not currently logged into the VistA system, you need to enter your access and verify codes. Click OK. The main Hemodialysis window is displayed with the Hemodialysis Study List displaying in the foreground, Figure 3‑1.

![](clinical-procedures-version-1-user-manual/014.png)
...
> ![](clinical-procedures-version-1-user-manual/015.png)
...
![](clinical-procedures-version-1-user-manual/016.png)

Figure 3‑3

> Notes: If the IN USE icon ![](clinical-procedures-version-1-user-manual/017.png) displays in the column to the left of a Study \#, that patient’s record has already been opened. You are limited to viewing this record in read-only mode.

> The DISABLED icon ![](clinical-procedures-version-1-user-manual/018.png) displays in the column to the left of a study \# of each patient record that has been disabled. You are limited to viewing this record in read-only mode.
...
![](clinical-procedures-version-1-user-manual/019.png)
...
2.  Click Disable. The DISABLED icon ![](clinical-procedures-version-1-user-manual/020.png) displays in the column to the left of the Study \#. Other users may open this study, but they cannot save changes to it.
...
> ![](clinical-procedures-version-1-user-manual/021.png)
...
> ![](clinical-procedures-version-1-user-manual/022.png)
...
> ![](clinical-procedures-version-1-user-manual/023.png)

Figure 3‑7

- Close: Exit the Study List without selecting a patient.

![](clinical-procedures-version-1-user-manual/024.png)
...
![](clinical-procedures-version-1-user-manual/025.png)
...
![](clinical-procedures-version-1-user-manual/026.png)
...
![](clinical-procedures-version-1-user-manual/027.png)
...
![](clinical-procedures-version-1-user-manual/028.png) or ![](clinical-procedures-version-1-user-manual/029.png)
...
![](clinical-procedures-version-1-user-manual/030.png) or ![](clinical-procedures-version-1-user-manual/031.png)
...
![](clinical-procedures-version-1-user-manual/032.png)

- <u>P</u>rint

Rx and Lab Tab Assessments Menu

![](clinical-procedures-version-1-user-manual/033.png)
...
![](clinical-procedures-version-1-user-manual/034.png)
...
![](clinical-procedures-version-1-user-manual/035.png)
...
![](clinical-procedures-version-1-user-manual/036.png)
...
![](clinical-procedures-version-1-user-manual/037.png)
...
![](clinical-procedures-version-1-user-manual/038.png)
...
![](clinical-procedures-version-1-user-manual/039.png)
...
![](clinical-procedures-version-1-user-manual/040.png)
...
![](clinical-procedures-version-1-user-manual/041.png)
...
![](clinical-procedures-version-1-user-manual/042.png)
...
![](clinical-procedures-version-1-user-manual/043.png) Select: Displays the Hemodialysis Study List, from which you can open a new patient record.

![](clinical-procedures-version-1-user-manual/044.png) Save: Saves information on the current treatment.
...
![](clinical-procedures-version-1-user-manual/045.png)
...
![](clinical-procedures-version-1-user-manual/046.png)
...
![](clinical-procedures-version-1-user-manual/047.png)
...
![](clinical-procedures-version-1-user-manual/048.png)
...
![](clinical-procedures-version-1-user-manual/049.png)
...
![](clinical-procedures-version-1-user-manual/050.png)
...
![](clinical-procedures-version-1-user-manual/051.png)
...
![](clinical-procedures-version-1-user-manual/052.png)
...
You can enter/view summary information, vascular access monitoring, and billing information about the dialysis treatment on the Summary tab (Figure 3‑22). Under Billing Information, you can enter associated CPT and ICD-9 or ICD-10<span id="icd101" class="anchor"></span> codes, clinical indicators and associate providers with this treatment session. Notes dealing with billing and environmental conditions can be entered into the Comments area.
...
![](clinical-procedures-version-1-user-manual/053.png)
...
![](clinical-procedures-version-1-user-manual/054.png)
...
![](clinical-procedures-version-1-user-manual/055.png)
...
![](clinical-procedures-version-1-user-manual/056.png)
...
ESRD Diagnosis: Select the ICD-9 or ICD-10<span id="icd102" class="anchor"></span> Code associated with the ESRD diagnosis.
...
![](clinical-procedures-version-1-user-manual/057.png)
...
> ![](clinical-procedures-version-1-user-manual/058.png)
...
![](clinical-procedures-version-1-user-manual/059.png)
...
![](clinical-procedures-version-1-user-manual/060.png)
...
![](clinical-procedures-version-1-user-manual/061.png)
...
![](clinical-procedures-version-1-user-manual/062.png)
...
![](clinical-procedures-version-1-user-manual/063.png)
...
> ![](clinical-procedures-version-1-user-manual/064.png)
...
> ![](clinical-procedures-version-1-user-manual/065.png)
...
2.  A LOCKED comment has a special indicator (padlock icon).![](clinical-procedures-version-1-user-manual/066.png)
...
![](clinical-procedures-version-1-user-manual/067.png)
...
![](clinical-procedures-version-1-user-manual/068.png)
...
![](clinical-procedures-version-1-user-manual/069.png)
...
![](clinical-procedures-version-1-user-manual/070.png)
...
![](clinical-procedures-version-1-user-manual/071.png)
...
![](clinical-procedures-version-1-user-manual/072.png)
...
![](clinical-procedures-version-1-user-manual/073.png) Yellow Circle – Site is available, but not assessed.

![](clinical-procedures-version-1-user-manual/074.png) Green Circle – Site has been assessed and is available for use.

![](clinical-procedures-version-1-user-manual/075.png) Green Checkmark – Site has been assessed and selected for use.

![](clinical-procedures-version-1-user-manual/076.png) Red X – Site has been removed and cannot be used anymore.
...
![](clinical-procedures-version-1-user-manual/077.png)
...
> ![](clinical-procedures-version-1-user-manual/078.png)
...
![](clinical-procedures-version-1-user-manual/079.png)
...
> ![](clinical-procedures-version-1-user-manual/080.png)
...
![](clinical-procedures-version-1-user-manual/081.png)
...
> ![](clinical-procedures-version-1-user-manual/082.png)
...
> ![](clinical-procedures-version-1-user-manual/083.png)
...
![](clinical-procedures-version-1-user-manual/084.png)
...
![](clinical-procedures-version-1-user-manual/085.png)
...
![](clinical-procedures-version-1-user-manual/086.png)
...
![](clinical-procedures-version-1-user-manual/087.png)
...
![](clinical-procedures-version-1-user-manual/088.png)
...
![](clinical-procedures-version-1-user-manual/089.png)
...
![](clinical-procedures-version-1-user-manual/090.png) - Indicates hand-entered data.

![](clinical-procedures-version-1-user-manual/091.png) - Indicates machine-entered data.
...
![](clinical-procedures-version-1-user-manual/092.png)
...
![](clinical-procedures-version-1-user-manual/093.png)
...
> ![](clinical-procedures-version-1-user-manual/094.png)
...
![](clinical-procedures-version-1-user-manual/095.png)
...
![](clinical-procedures-version-1-user-manual/096.png)
...
![](clinical-procedures-version-1-user-manual/097.png)
...
- Procedures and Diagnoses (CPT/ICD Codes)
- Service Connected Conditions
- Confirming PCE Data Without Changing Anything
- Comments

![](clinical-procedures-version-1-user-manual/098.png)
...
![](clinical-procedures-version-1-user-manual/099.png)
...
![](clinical-procedures-version-1-user-manual/100.png)
...
![](clinical-procedures-version-1-user-manual/101.png)
...
![](clinical-procedures-version-1-user-manual/102.png)

Figure 10‑5

4.  Highlight a name from the list of available providers, and then click the Move Right button. ![](clinical-procedures-version-1-user-manual/103.png) The selected name displays in the list of selected providers (Figure 10‑6).

![](clinical-procedures-version-1-user-manual/104.png)
...
6.  To remove a name from the list of selected providers, highlight the name, then click the Move Left button. ![](clinical-procedures-version-1-user-manual/105.png)
...
![](clinical-procedures-version-1-user-manual/106.png)

Figure 10‑7

1.  Expand treeview nodes, if necessary. Highlight a diagnosis, and then click the Move Right button. ![](clinical-procedures-version-1-user-manual/107.png) The selected diagnosis displays in the list of selected diagnoses. Repeat as needed.  
...
![](clinical-procedures-version-1-user-manual/108.png)
...
3.  Expand treeview nodes, if necessary. Highlight a procedure, and then click the Move Right button. ![](clinical-procedures-version-1-user-manual/109.png) The selected procedure displays in the list of selected procedures. Repeat as needed.  
...
![](clinical-procedures-version-1-user-manual/110.png)
...
![](clinical-procedures-version-1-user-manual/111.png)
...
> ![](clinical-procedures-version-1-user-manual/112.png)
...
![](clinical-procedures-version-1-user-manual/113.png)
...
![](clinical-procedures-version-1-user-manual/114.png)
...
![](clinical-procedures-version-1-user-manual/115.png)
...
![](clinical-procedures-version-1-user-manual/116.png)

Figure 11‑2

Submit Tab Menu

![](clinical-procedures-version-1-user-manual/117.png)
...
![](clinical-procedures-version-1-user-manual/118.png)
...
> ![](clinical-procedures-version-1-user-manual/119.png) Red question mark: Check for missing data on the specified tab.

> ![](clinical-procedures-version-1-user-manual/120.png) Green checkmark: Data looks OK.
...
![](clinical-procedures-version-1-user-manual/121.png)
...
![](clinical-procedures-version-1-user-manual/122.png)
...
![](clinical-procedures-version-1-user-manual/123.png)
...
![](clinical-procedures-version-1-user-manual/124.png)
...
> ![](clinical-procedures-version-1-user-manual/125.png)
...
![](clinical-procedures-version-1-user-manual/126.png)
...
![](clinical-procedures-version-1-user-manual/127.png)
...
![](clinical-procedures-version-1-user-manual/128.png)
...
![](clinical-procedures-version-1-user-manual/129.png)
...
![](clinical-procedures-version-1-user-manual/130.png)
...
![](clinical-procedures-version-1-user-manual/133.png)
...
![](clinical-procedures-version-1-user-manual/134.png)
...
![](clinical-procedures-version-1-user-manual/135.png)
...
![](clinical-procedures-version-1-user-manual/136.png)
...
![](clinical-procedures-version-1-user-manual/137.png)

Figure 13‑5

5.  Type the new item in the Value field, then click OK. The new item displays in the data list.

![](clinical-procedures-version-1-user-manual/138.png)
...
> ![](clinical-procedures-version-1-user-manual/139.png)
...
![](clinical-procedures-version-1-user-manual/140.png)

Figure 13‑8

4.  A Confirm dialog displays. Click Yes.

![](clinical-procedures-version-1-user-manual/141.png)
...
![](clinical-procedures-version-1-user-manual/142.png)
...
![](clinical-procedures-version-1-user-manual/143.png)
...
![](clinical-procedures-version-1-user-manual/144.png)
...
![](clinical-procedures-version-1-user-manual/145.png)
...
![](clinical-procedures-version-1-user-manual/146.png)
...
![](clinical-procedures-version-1-user-manual/147.png)
...
![](clinical-procedures-version-1-user-manual/148.png)
...
> ![](clinical-procedures-version-1-user-manual/149.png)
...
4.  Click the "+" sign to the left of the Report List node of the options tree to expand the node. The Summary Report node displays (Figure 13‑18).
    ...
    ![](clinical-procedures-version-1-user-manual/150.png)
...
6.  Scroll through the template text to find the FLOWSHEET section of the report.
    ...
    ![](clinical-procedures-version-1-user-manual/151.png)
...
![](clinical-procedures-version-1-user-manual/152.png)
...
7.  The report template text is available for editing. Modify the template text to include the \<Flowsheet Notes\> keyword. You may copy and paste the template text or type it manually.
    ...
    ![](clinical-procedures-version-1-user-manual/153.png)
...
![](clinical-procedures-version-1-user-manual/154.png)
...
8.  Click the Verify button to verify that all keywords are correct. If not, those keywords will display in red Figure 13‑23.
    ...
    ![](clinical-procedures-version-1-user-manual/155.png)
...
9.  To verify that the new keyword works, click the Report tab at the bottom-left corner of the template editor (Figure 13‑24).
    ...
    ![](clinical-procedures-version-1-user-manual/156.png)
...
10. Click the Process Template button at the top-right corner of the template editor panel. The application generates a report based on the selected template.
    ...
    ![](clinical-procedures-version-1-user-manual/157.png)
...
12. If the report text is correct, save the updated template for future use. To do so, first click the Template tab at the bottom-left corner of the template editor (Figure 13‑26).
    ...
    ![](clinical-procedures-version-1-user-manual/158.png)
...
16. Click the Report List node on the options tree. A list of all existing report templates displays in the panel to the right of the options tree. (Double-click the Report List node to expand it, if it isn’t already.)
    ...
    ![](clinical-procedures-version-1-user-manual/159.png)

Figure 13‑27

17. Click the Add button. The Option window displays.

    ![](clinical-procedures-version-1-user-manual/160.png)
...
22. Click the new template in the options tree.
    ...
    ![](clinical-procedures-version-1-user-manual/161.png)
...
25. Highlight the name of the existing report template in the Summary Report Name row.
    ...
    ![](clinical-procedures-version-1-user-manual/162.png)

Figure 13‑30

26. Type the new template name, then click Save To DB.

    ![](clinical-procedures-version-1-user-manual/163.png)
...
![](clinical-procedures-version-1-user-manual/164.png)
...
![](clinical-procedures-version-1-user-manual/165.png)
...
![](clinical-procedures-version-1-user-manual/166.png)
...
![](clinical-procedures-version-1-user-manual/167.png)
...
![](clinical-procedures-version-1-user-manual/168.png)
...
![](clinical-procedures-version-1-user-manual/169.png)
...
![](clinical-procedures-version-1-user-manual/170.png) Jump to the first row of the table.

![](clinical-procedures-version-1-user-manual/171.png) Select the previous row.

![](clinical-procedures-version-1-user-manual/172.png) Select the next row.

![](clinical-procedures-version-1-user-manual/173.png) Jump to the last row of the table.
...
> ![](clinical-procedures-version-1-user-manual/174.png)
...
![](clinical-procedures-version-1-user-manual/175.png)
...
![](clinical-procedures-version-1-user-manual/176.png)
