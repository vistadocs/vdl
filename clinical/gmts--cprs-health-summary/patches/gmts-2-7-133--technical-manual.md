---
title: GMTS*2.7*133 Health Summary - Technical Manual
doc_type: TM
...
<tr class="even">
<td>09/14/2018</td>
<td><a href="#Patch_GMTS_2_7_94_Updates">3</a>, <a href="#GMTS_2_7_94_patch_release">29</a>, <a href="#GMTS_2_7_94_PS_MED_RECON_CONFIG_CHK">43</a>, <a href="#GMTS_2_7_94_PS_MED_RECON_CONFIG_CHK2">78</a></td>
...
<tr class="odd">
<td>11/03/2017</td>
<td><a href="#TitlePage">i</a>, <a href="#Preface">ii</a>, <a href="#RevHist">iii</a>, <a href="#TOC">v</a>, <a href="#patch88">12</a>, and <a href="#patch92">14</a></td>
<td>Updated for GMTS*2.7*120</td>
<td></td>
</tr>
<tr class="even">
<td>09/08/2015</td>
<td><a href="#icd10">27</a></td>
...
<tr class="odd">
<td>Apr-June 2012</td>
<td><a href="#gmts104">22</a></td>
<td>Added description of GMTS*2.7*104</td>
<td></td>
</tr>
<tr class="even">
<td>Nov 2011</td>
<td><a href="#patch102">22</a></td>
<td>Added description of GMTS*2.7*102</td>
<td></td>
</tr>
<tr class="odd">
<td>Aug. 2011</td>
<td><a href="#patch88">12</a>, <a href="#gmts88ex">34</a>, misc</td>
...
- [# Appendix C: CPRS Program Operations and Maintenance Responsible, Accountable, Consulted and Informed (RACI)](#appendix-c-cprs-program-operations-and-maintenance-responsible-accountable-consulted-and-informed-raci)
    - [# Appendix D: Historical Documentation Shift from GMTS\2.7\133 (Do Not Update)](#appendix-d-historical-documentation-shift-from-gmts27133-do-not-update)
...
<p>(Fromdate,</p>
<p>Todate)</p></td>
<td><p>Gets Demographic data from VADPT</p>
<p>Receives: DFN</p>
...
<p>format)</p>
<p>Returns: NM=Lastname,First(name/initial) to specified</p>
<p>length.</p>
<p>Receives: Fromdate and Todate which are variables (passed</p>
<p>by reference) that will return the From date and</p>
<p>the To date in inverted order.</p>
<p>Fromdate Inverted date to be used as stop date for displaying most recent data first.</p>
...
> 2\. Include a description, sample of the report, and the routines to produce the report. The routine should be under the name-space assigned to your station; e.g., Madison=ALW, Cincinnati=AFR. Send to: <span class="mark">REDACTED</span>
...
\*\*\* END \*  CONFIDENTIAL Essential Med List for Review SUMMARY   pg. 1 \*\*\*\*\*\*\*\*\*Example of the Essential Med List for Review showing Rx# for existing and renewed medications ![](gmts-2-7-133-health-summary-technical-manual/002.png)
...
![](gmts-2-7-133-health-summary-technical-manual/003.png)
...
![](gmts-2-7-133-health-summary-technical-manual/004.png)

  
Example of the Essential Med List for Review showing a remote medication on hold

![](gmts-2-7-133-health-summary-technical-manual/005.png)
...
![](gmts-2-7-133-health-summary-technical-manual/006.png)
...
![](gmts-2-7-133-health-summary-technical-manual/007.png)
...
![](gmts-2-7-133-health-summary-technical-manual/008.png)

<span id="icd10" class="anchor"></span>ICD-10 Example

![](gmts-2-7-133-health-summary-technical-manual/009.png)
