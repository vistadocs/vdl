---
title: DG*5.3*884 ICD-10 PTF Modifications Installation Guide
doc_type: IG
...
docx_url: "https://www.va.gov/vdl/documents/Clinical/Admis_Disch_Transfer_(ADT)_Archive/dg_5_3_884_icd_10_ptf_modifications_ig.docx"
pdf_url: "https://www.va.gov/vdl/documents/Clinical/Admis_Disch_Transfer_(ADT)_Archive/dg_5_3_884_icd_10_ptf_modifications_ig.pdf"
...
![](dg-5-3-884-icd-10-ptf-modifications-installation-guide/001.png)
...
<span id="_Toc428787960" class="anchor"></span>Table : 401 Sub-File Fields From Which AO Cross-References Will Be Removed
...
- The ‘REDACTED’ entry is required in the DOMAIN (#4.2) file. Prior to installation, the installer should check the DOMAIN file to make certain this entry exists. If it does not, the user should follow the instructions in the XM\*999\*179 patch to create it. This patch installation will not run until this DOMAIN file entry exists.
...
<span id="_Toc428787961" class="anchor"></span>Table : DG\*5.3\*884 Required Builds

- Since it is possible for the installer to skip running the environment check routine, the pre-installation routine also checks for the existence of the REDACTED entry in the DOMAIN (#4.2) file. If it does not exist, this patch installation will stop until it is created.
...
- The PTF125 entry in the TRANSMISSION ROUTERS (#407.7) file is modified to send PTF record messages to the new REDACTED domain at the AITC. The existing REDACTED domain will no longer be used to send PTF record messages. If the PTF125 entry does not exist, it will be created. If, for any reason, the PTF125 entry cannot be created or modified, an error message will be displayed to the installer, and the patch installation will stop.
...
| XM\*999\*179   | NEW DOMAIN REDACTED ADDED TO DOMAIN (#4.2) FILE | 7/30/2015                   |

<span id="_Toc428787962" class="anchor"></span>Table : GMTS\*2.7\*111 Required Builds
...
<span id="_Toc428787963" class="anchor"></span>Table : IB\*2.0\*522 Required Builds
...
<span id="_Toc428787964" class="anchor"></span>Table : LR\*5.2\*442 Required Builds
...
<span id="_Toc428787965" class="anchor"></span>Table : OR\*3.0\*406 Required Builds
...
<span id="_Toc428787966" class="anchor"></span>Table : ROR\*1.5\*25 Required Builds
...
<span id="_Toc428787967" class="anchor"></span>Table : Anonymous Directories

# ICD-10 PTF Modifications Installation Instructions

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

![](dg-5-3-884-icd-10-ptf-modifications-installation-guide/002.png)
...
<span id="_Toc428787968" class="anchor"></span>Table : Updated Documents
...
<span id="_Toc428787969" class="anchor"></span>Table : Software Files to Download
...
<table>
<caption><p><span id="_Toc428787970" class="anchor"></span>Table : CCR Command Line Switches</p></caption>
<colgroup>
<col style="width: 22%" />
<col style="width: 43%" />
<col style="width: 34%" />
...
<span id="_Toc428787970" class="anchor"></span>Table : CCR Command Line Switches
...
- Verify that the REDACTED entry exists in the DOMAIN (#4.2) file.
...
<span id="_Toc428787950" class="anchor"></span>Figure : Programs and Features, Uninstall or Change a Program

![](dg-5-3-884-icd-10-ptf-modifications-installation-guide/003.png)
...
<span id="_Toc428787951" class="anchor"></span>Figure : Clinical Case Registries Uninstall Pop-Up

![](dg-5-3-884-icd-10-ptf-modifications-installation-guide/004.png)
...
<span id="_Toc428787952" class="anchor"></span>Figure : CCR Setup Wizard Welcome Message

![](dg-5-3-884-icd-10-ptf-modifications-installation-guide/005.png)

4.  Click Next to continue the installation.

> The Select Destination Location dialog displays:

<span id="_Toc428787953" class="anchor"></span>Figure : Select Destination Location Dialog Box

![](dg-5-3-884-icd-10-ptf-modifications-installation-guide/006.png)
...
<span id="_Toc428787954" class="anchor"></span>Figure : Select Start Menu Folder Dialog Box

> ![](dg-5-3-884-icd-10-ptf-modifications-installation-guide/007.png)
...
<span id="_Toc428787955" class="anchor"></span>Figure : Select Additional Tasks Dialog Box

> ![](dg-5-3-884-icd-10-ptf-modifications-installation-guide/008.png)
...
<span id="_Toc428787956" class="anchor"></span>Figure : Ready to Install Dialog Box

![](dg-5-3-884-icd-10-ptf-modifications-installation-guide/009.png)
...
<span id="_Toc428787957" class="anchor"></span>Figure : CCR Finish Installation Message

![](dg-5-3-884-icd-10-ptf-modifications-installation-guide/010.png)
...
3 Division DIV \[REDACTED\]

4 System SYS \[<span class="mark">REDACTED</span>\]
...
<span id="_Toc428787958" class="anchor"></span>Figure : Configuring CCR Desktop Parameters

![](dg-5-3-884-icd-10-ptf-modifications-installation-guide/011.png)
...
<span id="_Toc428787959" class="anchor"></span>Figure : CCR Command Line Switches

![](dg-5-3-884-icd-10-ptf-modifications-installation-guide/012.png)

<table>
<caption><p><span id="_Toc428787971" class="anchor"></span>Table : DG*5.3*884 Checksums</p></caption>
<colgroup>
<col style="width: 32%" />
<col style="width: 67%" />
</colgroup>
...
<span id="_Toc428787971" class="anchor"></span>Table : DG\*5.3\*884 Checksums
...
\>\>\> Checking for 'REDACTED entry in DOMAIN (#4.2)...Successful
...
Setting TRANSMIT=NO for (existing) receiving user@REDACTED.

Creating new receiving user@REDACTED.
...
<span id="_Toc428787972" class="anchor"></span>Table : GMTS\*2.7\*111 Checksums
...
<span id="_Toc428787973" class="anchor"></span>Table : IB\*2.0\*522 Checksums
...
<span id="_Toc428787974" class="anchor"></span>Table : LR\*5.2\*442 Checksums
...
<span id="_Toc428787975" class="anchor"></span>Table : OR\*3.0\*406 Checksums
...
<span id="_Toc428787976" class="anchor"></span>Table : ROR\*1.5\*25 Checksums
...
<span id="_Toc414369012" class="anchor"></span>Table : Acronyms and Definitions
