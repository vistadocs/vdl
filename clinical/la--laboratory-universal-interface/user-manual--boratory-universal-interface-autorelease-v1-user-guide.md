---
title: '''Laboratory: Universal Interface AutoRelease Version 1 User Guide'''
doc_type: UG
...
patch_id: null
group_key: LA::1
description: '''| Date | Revision | Description | Author | |------------|----------|--------------------------------------------------------------------------|------------------------------------| | 12/1/16 | 0.6 | Added Warranty Release: LA\*5.2\*94 & LR\*5.2\*475 information | REDACTED | | 6/28/2016 | 0.5 |...'''
...
revision_count: 6
revision_newest: 12/1/16
revision_oldest: 05/11/2016
docx_url: https://www.va.gov/vdl/documents/Clinical/Lab-Universal_Interface/labautorelease1_0_userguide.docx
pdf_url: https://www.va.gov/vdl/documents/Clinical/Lab-Universal_Interface/labautorelease1_0_userguide.pdf
app_url: https://www.va.gov/vdl/application.asp?appid=120
audit_applied: '2026-05-31'
---

VistA Lab Enhancements

Auto Verification / Auto Release

Lab Auto Release 1.0 (LR\*5.2\*458 & LA\*5.2\*88)

And Warranty Release Patches: LA\*5.2\*94 & LR\*5.2\*475

User Guide

![](laboratory-universal-interface-autorelease-version-1-user-guide/001.png)
...
|------------|----------|--------------------------------------------------------------------------|------------------------------------|
| 12/1/16    | 0.6      | Added Warranty Release: LA\*5.2\*94 & LR\*5.2\*475 information           | <span class="mark">REDACTED</span> |
| 6/28/2016  | 0.5      | Final peer review; remove template’s instructional text (blue)           | <span class="mark">REDACTED</span> |
| 6/24/2016  | 0.4      | Updated support information, clarified as necessary                      | <span class="mark">REDACTED</span> |
| 06/23/2016 | 0.3      | Merge edits from peer reviews; formatted examples of screen/print shots. | <span class="mark">REDACTED</span> |
| 6/10/16    | 0.2      | Updates                                                                  | SME input                          |
| 05/11/2016 | 0.1      | Draft                                                                    | VLE_PMO                            |
...
- [System Summary](#system-summary)
  ...
  - [System Configuration](#system-configuration)
    - [Configuration Considerations for External Generic Interface Manager (GIM)](#configuration-considerations-for-external-generic-interface-manager-gim)
    - [Initial Configuration to Activate VistA Auto Release](#initial-configuration-to-activate-vista-auto-release)
...
- [Getting Started](#getting-started)
  ...
  - [System Menu](#system-menu)
    - [Modifications to the AUTO INSTRUMENT (#62.4) option.](#modifications-to-the-auto-instrument-624-option)
    - [New Auto Release System Parameter Option](#new-auto-release-system-parameter-option)
    - [New Summary List (Patient) Report Option](#new-summary-list-patient-report-option)
...
- [Troubleshooting](#troubleshooting)
  ...
  - [Result Acknowledgements](#result-acknowledgements)
    - [Troubleshooting VistA Generated Application Error Codes](#troubleshooting-vista-generated-application-error-codes)
    - [Example of Error Messages on Instrument Manager Console](#example-of-error-messages-on-instrument-manager-console)
...
| Symbol                                                                                                                                                                                                                                 | Description                                                                                             |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
| ![](laboratory-universal-interface-autorelease-version-1-user-guide/002.png)                                                        | NOTE: Used to inform the reader of general information including references to additional reading material. |
| ![](laboratory-universal-interface-autorelease-version-1-user-guide/003.png) | CAUTION: Used to caution the reader to take special notice of critical information.                     |
...
![](laboratory-universal-interface-autorelease-version-1-user-guide/004.png)
...
![](laboratory-universal-interface-autorelease-version-1-user-guide/005.png)
...
![](laboratory-universal-interface-autorelease-version-1-user-guide/006.png)
...
Figure4: VistA Lab System Configuration

![](laboratory-universal-interface-autorelease-version-1-user-guide/007.png)

### Configuration Considerations for External Generic Interface Manager (GIM)

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

1.  Ensure the minimum version level meets specifications
    1.  i.e. (8.13.03) of Data Innovations (DI) Instrument Manager and the latest DI VA driver (currently V 8.00.0017). Follow vendor provided instructions to properly configure for Auto Verification.
2.  Make sure all Laboratory Techs have the LRVERIFY security key in VistA. If not done, and a user manually verifies a result on IM and sends to VistA it will fail and generate an interface Application Error. See item \#5 in section 2.2.2 below for a report that will list users and related security keys to be used as source document to configure generic interface manager (GIM). Also the Troubleshooting section in this guide.
...
> ![](laboratory-universal-interface-autorelease-version-1-user-guide/008.png)
...
> ![](laboratory-universal-interface-autorelease-version-1-user-guide/009.png) Failure to do so will cause all results to generate a user division error in VistA
...
> ![](laboratory-universal-interface-autorelease-version-1-user-guide/010.png) There should only be one profile flagged per load list.
...
![](laboratory-universal-interface-autorelease-version-1-user-guide/011.png) There should only be one profile flagged per load list.
...
<p><mark>DEFAULT REFERENCE LABORATORY: ZZ ALBANY//</mark></p>
<p><mark>AUTO RELEASE: YES//</mark></p>
...
> ![](laboratory-universal-interface-autorelease-version-1-user-guide/012.png) For multi-division sites: All users in the division will populate the report, not just facility.
...
![](laboratory-universal-interface-autorelease-version-1-user-guide/013.png)The parameter is distributed pre-configured at the package level as
...
7.  ![](laboratory-universal-interface-autorelease-version-1-user-guide/014.png)Once the GIM has been updated to implement enhanced acknowledgement mode (check with your vendor for the correct enhanced acknowledgement version), the following option is used to enable enhanced acknowledgement mode for LAB UI 1.6.

> ![](laboratory-universal-interface-autorelease-version-1-user-guide/015.png)![](laboratory-universal-interface-autorelease-version-1-user-guide/016.png)
...
![](laboratory-universal-interface-autorelease-version-1-user-guide/017.png)
...
1)  Laboratory Information Manager (LIM) – responsible for initial configuration and ongoing support, including troubleshooting of Application Errors.
2)  Medical Technologists authorized to verify results external to VistA on the COTS package – these users will need to have the LRVERIFY key and an active VistA account and have appropriate security settings in the COTS GIM system.
...
1.  Summary list (extended supervisors')
2.  Summary List (Patient)
3.  Summary list (supervisors')
...
![](laboratory-universal-interface-autorelease-version-1-user-guide/018.png) For results, the GIM will populate MSH.15 and MSH.16 to indicate the Commit Acknowledgment and the Application Acknowledgement conditions.
...
![](laboratory-universal-interface-autorelease-version-1-user-guide/019.png) For additional Error Codes, see File 62.485
...
<p>![](laboratory-universal-interface-autorelease-version-1-user-guide/020.png) *NOTE* A single “previously verified” or “previously cancelled” result will invalidate Auto Release for ALL results present in a given data packet, regardless of their Auto Verification status or eligibility</p></td>
...
![](laboratory-universal-interface-autorelease-version-1-user-guide/021.png)

![](laboratory-universal-interface-autorelease-version-1-user-guide/022.png)Check with your vendor for examples of error messages
