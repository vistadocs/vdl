---
title: PIMS Version 5.3 Means Test Supervisor User Manual (Updated DG*5.3*858)
doc_type: UM
doc_label: User Manual
doc_layer: patch
doc_subject: Means Test Supervisor  (Updated DG*5.3*858)
app_code: SD
app_name: Scheduling
section: CLI
app_status: archive
...
revision_newest: 
revision_oldest: 
docx_url: "https://www.va.gov/vdl/documents/Clinical/Scheduling_Archive/dg_5_3_p858_mts_um.docx"
pdf_url: "https://www.va.gov/vdl/documents/Clinical/Scheduling_Archive/dg_5_3_p858_mts_um.pdf"
...
## Table of Contents
  ...
  - [Means Test Signature Reports](#means-test-signature-reports)
    - [Means Test Signature Summary Report](#means-test-signature-summary-report)
    - [Means Test Signature Detail Report](#means-test-signature-detail-report)
...
<ul>
<li><blockquote>
<p>Updated the <em>GMT Thresholds Lookup by Zip Code</em> option with the new priority 8 sub-categories ‘b’ and ‘d’.</p>
</blockquote></li>
</ul></td>
<td><mark>REDACTED</mark></td>
<td><mark>REDACTED</mark></td>
...
<ul>
<li><p>Modified Screen 1 - <em>Marital Status/Dependent</em> section of <em>Means Test User Menu/Add a New Means Test</em> section.</p></li>
</ul></td>
<td><mark>REDACTED</mark></td>
<td><mark>REDACTED</mark></td>
</tr>
...
> This option is used to make changes to existing Means Tests. This is the only option which allows changes to completed Means Tests less than 1 year old from the effective date.
...
> This option allows the user to grant, edit, and delete hardships for the current Means Test when the test is less than 1 year old from the effective date.
...
<tbody>
<tr class="odd">
<td><strong>Report Heading</strong></td>
...
Please Note - No Action required in reference to the deceased reports.
...
This option replaces the Change a Patient’s Means Test Category option. It allows users to grant, edit, and delete hardships for the current Means Test when the test is less than 1 year old from the effective date.
