---
title: PIMS Version 5.3 Menus, Intro & Orientation User Manual
doc_type: UM
doc_label: User Manual
doc_layer: anchor
doc_subject: Menus, Intro & Orientation
app_code: SD
app_name: Scheduling
section: CLI
app_status: archive
...
revision_newest: 
revision_oldest: 
docx_url: "https://www.va.gov/vdl/documents/Clinical/Scheduling_Archive/PIMS_User_Manual-Menus_Intros_Orientation.docx"
pdf_url: "https://www.va.gov/vdl/documents/Clinical/Scheduling_Archive/PIMS_User_Manual-Menus_Intros_Orientation.pdf"
...
![](pims-version-5-3-menus-intro-orientation-user-manual/001.png)
...
<span id="_Toc54883336" class="anchor"></span>Table 1: Intended Audience
...
<span id="_Toc54883337" class="anchor"></span>Table 2: Disclaimers

|                                                                                                                                   |                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|-----------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](pims-version-5-3-menus-intro-orientation-user-manual/002.png) | DISCLAIMER: The appearance of any external hyperlink references in this manual does not constitute endorsement by the Department of Veterans Affairs (VA) of this Website or the information, products, or services contained therein. The VA does not exercise any editorial control over the information you can find at these locations. Such links are provided and are consistent with the stated purpose of this VA Intranet Service. |
...
<span id="_Toc54883338" class="anchor"></span>Table 3: Documentation Conventions
...
<tr class="even">
<td>![](pims-version-5-3-menus-intro-orientation-user-manual/003.png)</td>
...
<tr class="odd">
<td>![](pims-version-5-3-menus-intro-orientation-user-manual/004.png)</td>
...
|                                                                                                                                         |                                                                                                                                          |
|-----------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|
| ![](pims-version-5-3-menus-intro-orientation-user-manual/005.png) | NOTE: Callout boxes refer to labels or descriptions usually enclosed within a box that point to specific areas of a displayed image. |
...
<span id="_Toc54883339" class="anchor"></span>Table 4: Related Manuals
...
Table 5: Documentation Website Locations
...
| ![](pims-version-5-3-menus-intro-orientation-user-manual/006.png) | NOTE: These reports are not part of the Scheduling Menus, Introduction & Orientation Module, they are Stand-Alone Menu Options. |
|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](pims-version-5-3-menus-intro-orientation-user-manual/007.png) | NOTE: The Scheduling Reports appear in the primary and secondary menu options. |
|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
...
<thead>
<tr class="header">
<th>![](pims-version-5-3-menus-intro-orientation-user-manual/008.png)</th>
...
<span id="_Toc54883341" class="anchor"></span>Table 6: Scheduling Outputs Menu
...
<thead>
<tr class="header">
<th>![](pims-version-5-3-menus-intro-orientation-user-manual/009.png)</th>
...
<span id="_Toc54883342" class="anchor"></span>Table 7: Mental Health No Show Options & Features
...
<span id="_Toc54883343" class="anchor"></span>Table 8: ACRP Database Conversion Parameters
...
<span id="_Toc54883344" class="anchor"></span>Table 9: Actions Available from the CST Master List Screen
...
<span id="_Toc54883345" class="anchor"></span>Table 10: Actions Available from the CST Detail Screen
...
<span id="_Toc54883346" class="anchor"></span>Table 11: Military Time Conversion Table
...
<span id="_Toc54883347" class="anchor"></span>Table 12: Glossary
<table>
<colgroup>
<col style="width: 31%" />
<col style="width: 68%" />
