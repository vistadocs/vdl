---
title: Emergency Dept Integration Software GUI (EDIS) Version 2.1.2 Technical Manual
doc_type: TM
...
- PSJ RNURSE
menu_options: 8
description: 5/2018 2.11 Patch EDP*2.0*9 Updated the Discharge Diagnosis Files Removed reference of $$ICDONE^LEXU and corrected ICD9 CODE to remove the 9 Updated title page and footers. HPS Clinical Sustainment
...
revision_newest: ''
revision_oldest: ''
docx_url: https://www.va.gov/vdl/documents/Clinical/Emergency_Dept_Integration_Software_Archive/EDIS_2_1_2_tm.docx
pdf_url: https://www.va.gov/vdl/documents/Clinical/Emergency_Dept_Integration_Software_Archive/EDIS_2_1_2_tm.pdf
...
![](emergency-dept-integration-software-gui-edis-version-2-1-2-technical-manual/001.png)
...
<table>
<caption><p><span id="_Toc513207224" class="anchor"></span>Table 1: Anonymous Software Directories</p></caption>
<colgroup>
<col style="width: 11%" />
<col style="width: 8%" />
<col style="width: 55%" />
...
<p><a href="#EDP_2_9">Updated the Discharge Diagnosis Files</a></p>
...
<p>Added information on EDPLEX routine (p. <a href="#page12">12</a>)</p>
<p>Updated to ICD-10 reference (p. <a href="#pg13">13</a>)</p>
<p>Added and updated routine names and checksums (p.16).</p>
<p>Updated to reference ICD-10 codes and text in the Discharge Diagnosis Files (p. <a href="#page30">30</a>)</p>
<p>Updated to reference ICD-10 codes and text in the Tracking Area File (p<a href="#display-board-configuration-subfile-231.94">. 47</a>)</p></td>
<td><mark>REDACTED</mark></td>
</tr>
<tr class="even">
<td>07/17/2013</td>
...
<span id="_Toc513207224" class="anchor"></span>Table 1: Anonymous Software Directories
...
[Figure 1: The EDIS Topology [5](#_Toc513207275)](#_Toc513207275)
...
- [General Information](#general-information)
  ...
  - [EDIS KIDS Install](#edis-kids-install)
    - [Retrieve patch EDP\2\2](#retrieve-patch-edp22)
    - [Install patch EDP\2\2](#install-patch-edp22)
...
- EDIS Glossary
- EDIS Installation Zip File (contains Launch_EDIS.bat and edisautologon.reg)
...
<table>
<caption><p><span id="_bookmark0" class="anchor"></span>Table 2: Document Files</p></caption>
<colgroup>
<col style="width: 27%" />
<col style="width: 43%" />
<col style="width: 28%" />
...
<span id="_bookmark0" class="anchor"></span>Table 2: Document Files

The documents appear on the Anonymous software directories under the file names listed in the table below.

<table>
<caption><p><span id="_Toc513207226" class="anchor"></span>Table : Adobe Flash Minimum Hardware Requirements</p></caption>
<colgroup>
<col style="width: 65%" />
<col style="width: 24%" />
<col style="width: 10%" />
...
<span id="_Toc513207226" class="anchor"></span>Table : Adobe Flash Minimum Hardware Requirements
...
When EDIS is running in your site's production account, use <https://vaww.edisprod2.med.va.gov/main> for user access to the main application and [<u>https://vaww.edisprod2.med.va.gov/main/board.html</u>](https://vaww.edisprod2.med.va.gov/main/board.html) for your main big-board display.

For secondary big-board displays, append the following argument: board=your_secondary_board_name. Your institution must be placed in the sitecode parameter. For example, if your site has a secondary display board named *Lab;* its URL would be: <https://vaww.edisprod2.med.va.gov/main/board.html?sitecode=442&board=Lab>.

#### EDIS in Test Accounts

When EDIS is running in your site's test account, use [<u>https://preprod.edispreprod2.med.va.gov/main</u>](https://preprod.edispreprod2.med.va.gov/main) for user access to the main application.

![](emergency-dept-integration-software-gui-edis-version-2-1-2-technical-manual/002.png)

> <span id="_Toc513207275" class="anchor"></span>Figure : The EDIS Topology
...
Workstations should comply with VA Desktop Minimum Acceptable Configurations ([<u>http://vaww. vairm. vaco.va. go v/VADesktop</u>](http://vaww.vairm.vaco.va.gov/VADesktop)). In addition, users' workstations should meet the minimum hardware requirements for running Adobe Flash Player; see table below.

<table style="width:100%;">
<caption><p><span id="_Toc513207227" class="anchor"></span>Table : Optimal Viewing Requirements</p></caption>
<colgroup>
<col style="width: 17%" />
<col style="width: 70%" />
<col style="width: 11%" />
...
<tr class="odd">
<td>Windows</td>
<td>Intel Pentium II 450MHz or faster processor (or equivalent), AMD Athlon 600MHz or faster processor (or equivalent)</td>
<td>128 MB</td>
</tr>
<tr class="even">
<td>Macintosh</td>
<td>PowerPC G3 500MHz or faster processor or Intel Core Duo 1.33GHz or faster processor</td>
<td>128 MB</td>
</tr>
</tbody>
</table>

<span id="_Toc513207227" class="anchor"></span>Table : Optimal Viewing Requirements

See table below for Optimal Viewing Requirements.

<table>
<caption><p><span id="_bookmark4" class="anchor"></span>Table : Parameters</p></caption>
<colgroup>
<col style="width: 37%" />
<col style="width: 37%" />
<col style="width: 25%" />
...
<span id="_bookmark4" class="anchor"></span>Table : Parameters
...
<table>
<caption><p><span id="_Toc513207229" class="anchor"></span>Table 6: EDIS Routine Checksums</p></caption>
<colgroup>
<col style="width: 20%" />
<col style="width: 79%" />
</colgroup>
...
<td><p>NOTE: This parameter is no longer used as of EDIS v.2.1.1/EDP*2.0*6.</p>
...
<td>This holds the number of seconds until the application times out. If set, this value over rides the user's DTIME value.</td>
</tr>
</tbody>
</table>

<span id="_Toc513207229" class="anchor"></span>Table 6: EDIS Routine Checksums
...
7.  At the Are you adding \[*your time range or sequence*\] as a new Time Range or Sequence? Yes// prompt, press the \<Enter\> key to accept the time range or sequence—or, if you've made a mistake, type the letter *n* (for *No*) and press the \<Enter\> key.
...
- <span id="pg13" class="anchor"></span>EDPLOG updates the EDIS log in response to timestamp changes. It also processes diagnoses and checks for the presence of data in required fields before letting users remove patients from the system.
...
<table>
<caption><p><span id="_bookmark5" class="anchor"></span>Table : Global Placement and Protection</p></caption>
<colgroup>
<col style="width: 25%" />
<col style="width: 22%" />
<col style="width: 25%" />
...
<tr class="header">
<th><blockquote>
<p>Updated with EDIS v2.1.2/ EDP*2.0*2</p>
</blockquote></th>
<th><blockquote>
<p>Routine Name</p>
</blockquote></th>
...
<span id="_bookmark5" class="anchor"></span>Table : Global Placement and Protection
...
<table>
<caption><p><span id="_Toc513207231" class="anchor"></span>Table : XE Files</p></caption>
<colgroup>
<col style="width: 11%" />
<col style="width: 9%" />
<col style="width: 51%" />
...
<span id="_Toc513207231" class="anchor"></span>Table : XE Files
...
<table>
<caption><p><span id="_bookmark7" class="anchor"></span>Table : File Descriptions</p></caption>
<colgroup>
<col style="width: 11%" />
<col style="width: 43%" />
<col style="width: 19%" />
...
<span id="_bookmark7" class="anchor"></span>Table : File Descriptions
...
<table>
<caption><p><span id="_bookmark8" class="anchor"></span>Table : Subfile – Discharge Diagnosis Files</p></caption>
<colgroup>
<col style="width: 12%" />
<col style="width: 15%" />
<col style="width: 14%" />
...
<p>If sites set EDIS parameters to require coded diagnoses, the text in this field will match either ICD-9-CM or ICD-10-CM (after ICD-10 activation date) text from Clinical Lexicon entries; some entries map to more than one ICD code.</p></td>
</tr>
<tr class="even">
<td>.02</td>
<td><span id="EDP_2_9" class="anchor"></span>ICD CODE</td>
...
<span id="_bookmark9" class="anchor"></span>Table : Subfile – XE Orders
...
<table>
<caption><p><span id="_bookmark10" class="anchor"></span>Table : Record Indices for File #230</p></caption>
<colgroup>
<col style="width: 13%" />
<col style="width: 11%" />
<col style="width: 12%" />
...
<span id="_bookmark10" class="anchor"></span>Table : Record Indices for File \#230

#### Record Indices for File \#230

<table>
<caption><p><span id="_bookmark11" class="anchor"></span>Table : XE ED Log History Files (#230.1)</p></caption>
<colgroup>
<col style="width: 13%" />
<col style="width: 20%" />
<col style="width: 65%" />
...
<p>IEN (active entries only)</p></td>
<td>EDIS uses this index to see if patients are already on the display board in cases where patients don't have DFNs and users are identifying these patients by their SSNs</td>
</tr>
<tr class="odd">
<td>ATI (#794)</td>
...
<span id="_bookmark11" class="anchor"></span>Table : XE ED Log History Files (#230.1)
...
<table>
<caption><p><span id="_bookmark12" class="anchor"></span>Table : XE File Record Indices (230.1)</p></caption>
<colgroup>
<col style="width: 13%" />
<col style="width: 16%" />
<col style="width: 16%" />
...
<span id="_bookmark12" class="anchor"></span>Table : XE File Record Indices (230.1)

#### Record Indices for File (230.1)

<table>
<caption><p><span id="_bookmark13" class="anchor"></span>Table : XE Files – Tracking Staff (#231.7)</p></caption>
<colgroup>
<col style="width: 16%" />
<col style="width: 17%" />
<col style="width: 65%" />
...
<span id="_bookmark13" class="anchor"></span>Table : XE Files – Tracking Staff (#231.7)
...
<table>
<caption><p><span id="_bookmark14" class="anchor"></span>Table : XE Files Record Indices (231.7)</p></caption>
<colgroup>
<col style="width: 13%" />
<col style="width: 13%" />
<col style="width: 15%" />
...
<span id="_bookmark14" class="anchor"></span>Table : XE Files Record Indices (231.7)

#### Record Indices for File (231.7)

<table>
<caption><p><span id="_bookmark15" class="anchor"></span>Table : XE Files – Tracking Room Bed (#231.8)</p></caption>
<colgroup>
<col style="width: 13%" />
<col style="width: 15%" />
<col style="width: 70%" />
...
<span id="_bookmark15" class="anchor"></span>Table : XE Files – Tracking Room Bed (#231.8)
...
<table>
<caption><p><span id="_bookmark16" class="anchor"></span>Table : XE Files – Record Indices (#231.8)</p></caption>
<colgroup>
<col style="width: 13%" />
<col style="width: 14%" />
<col style="width: 14%" />
...
<span id="_bookmark16" class="anchor"></span>Table : XE Files – Record Indices (#231.8)

#### Record Indices for (#231.8)

<table>
<caption><p><span id="_bookmark17" class="anchor"></span>Table : XE Files – Tracking Area (#231.9)</p></caption>
<colgroup>
<col style="width: 14%" />
<col style="width: 23%" />
<col style="width: 61%" />
...
<span id="_bookmark17" class="anchor"></span>Table : XE Files – Tracking Area (#231.9)
...
<table>
<caption><p><span id="_Toc513207243" class="anchor"></span>Table : XE Files Display Board Configuration Subfile</p></caption>
<colgroup>
<col style="width: 13%" />
<col style="width: 15%" />
<col style="width: 16%" />
...
<li><p>1 (yes—ICD-9-CM, or ICD-10-CM after ICD-10 activation date)</p></li>
</ul>
<p>A setting of <em>1</em> indicates that users must enter diagnoses using ICD-9-CM or ICD-10-CM (after ICD-10 activation date) codes before removing patients from the board; otherwise, users may enter free-text diagnoses.</p></td>
</tr>
<tr class="even">
<td>1.3</td>
...
<span id="_Toc513207243" class="anchor"></span>Table : XE Files Display Board Configuration Subfile

#### Display Board Configuration Subfile (231.94)

<table>
<caption><p><span id="_Toc513207244" class="anchor"></span>Table : Files and Fields that Point to Tracking Code File</p></caption>
<colgroup>
<col style="width: 16%" />
<col style="width: 13%" />
<col style="width: 13%" />
...
<span id="_Toc513207244" class="anchor"></span>Table : Files and Fields that Point to Tracking Code File
...
<span id="_Toc513207245" class="anchor"></span>Table : Tracking Code (#233.1)

<table style="width:100%;">
<caption><p><span id="_Toc513207246" class="anchor"></span>Table : Tracking Code File Indices (#233.1)</p></caption>
<colgroup>
<col style="width: 13%" />
<col style="width: 16%" />
<col style="width: 16%" />
...
<span id="_Toc513207246" class="anchor"></span>Table : Tracking Code File Indices (#233.1)

#### Tracking Code File Indices (#233.1)

<table>
<caption><p><span id="_bookmark21" class="anchor"></span>Table : Tracking Code Set (#233.2)</p></caption>
<colgroup>
<col style="width: 13%" />
<col style="width: 22%" />
<col style="width: 63%" />
...
<span id="_bookmark21" class="anchor"></span>Table : Tracking Code Set (#233.2)
...
<table>
<caption><p><span id="_bookmark22" class="anchor"></span>Table : Subfile – Tracking Code Set File – Codes (#233.21)</p></caption>
<colgroup>
<col style="width: 15%" />
<col style="width: 12%" />
<col style="width: 14%" />
...
<span id="_bookmark22" class="anchor"></span>Table : Subfile – Tracking Code Set File – Codes (#233.21)

#### Codes (233.21)

<table>
<caption><p><span id="_bookmark23" class="anchor"></span>Table : CPE Role (#232.5)</p></caption>
<colgroup>
<col style="width: 13%" />
<col style="width: 17%" />
<col style="width: 16%" />
...
<span id="_bookmark23" class="anchor"></span>Table : CPE Role (#232.5)
...
<table>
<caption><p><span id="_bookmark24" class="anchor"></span>Table : EDP Worksheet Specification (#232.6)</p></caption>
<colgroup>
<col style="width: 13%" />
<col style="width: 17%" />
<col style="width: 18%" />
...
<span id="_bookmark24" class="anchor"></span>Table : EDP Worksheet Specification (#232.6)
...
<table>
<caption><p><span id="_Toc513207251" class="anchor"></span>Table : Subfile – Sections (#232.62)</p></caption>
<colgroup>
<col style="width: 14%" />
<col style="width: 22%" />
<col style="width: 18%" />
...
<span id="_Toc513207251" class="anchor"></span>Table : Subfile – Sections (#232.62)

#### Subfile: Sections (#232.62)

<table>
<caption><p><span id="_Toc513207252" class="anchor"></span>Table : Subfile – Components (#232.622)</p></caption>
<colgroup>
<col style="width: 14%" />
<col style="width: 0%" />
<col style="width: 21%" />
...
<tr class="odd">
<td>.01</td>
<td colspan="2">SECTION SEQUENCE</td>
<td></td>
<td></td>
<td>Number</td>
</tr>
...
<tr class="odd">
<td>.03</td>
<td colspan="2">INITIALLY OPEN</td>
<td></td>
<td></td>
<td><p>Set of codes:</p>
<ul>
...
<span id="_Toc513207252" class="anchor"></span>Table : Subfile – Components (#232.622)

#### Subfile: Components (#232.622)

<table>
<caption><p><span id="_Toc513207253" class="anchor"></span>Table : Subfile – Roles (#232.63)</p></caption>
<colgroup>
<col style="width: 14%" />
<col style="width: 22%" />
<col style="width: 17%" />
...
<span id="_Toc513207253" class="anchor"></span>Table : Subfile – Roles (#232.63)
...
<span id="_bookmark25" class="anchor"></span>Table : EDP Worksheet Section (#232.71)
...
<table>
<caption><p><span id="_Toc513207255" class="anchor"></span>Table : Subfile – Components (#232.711)</p></caption>
<colgroup>
<col style="width: 15%" />
<col style="width: 18%" />
<col style="width: 18%" />
...
<span id="_Toc513207255" class="anchor"></span>Table : Subfile – Components (#232.711)
...
<span id="_Toc513207256" class="anchor"></span>Table : Subfile – Roles (#232.712)
...
<span id="_bookmark26" class="anchor"></span>Table : EDP Worksheet Component (#232.72)
...
<table>
<caption><p><span id="_Toc513207258" class="anchor"></span>Table : Subfile – Parameters (#232.725)</p></caption>
<colgroup>
<col style="width: 15%" />
<col style="width: 18%" />
<col style="width: 17%" />
...
<span id="_Toc513207258" class="anchor"></span>Table : Subfile – Parameters (#232.725)

#### Subfile: Parameters (#232.725)

<table>
<caption><p><span id="_Toc513207259" class="anchor"></span>Table : Subfile – Components (#232.727)</p></caption>
<colgroup>
<col style="width: 15%" />
<col style="width: 18%" />
<col style="width: 18%" />
...
<span id="_Toc513207259" class="anchor"></span>Table : Subfile – Components (#232.727)
...
<span id="_Toc513207260" class="anchor"></span>Table : Subfile – Roles (#232.728)
...
<span id="_Toc513207261" class="anchor"></span>Table : Subfile – Validator (#232.729)

#### Subfile: Validator (#232.729)

<table>
<caption><p><span id="_Toc513207262" class="anchor"></span>Table : EDP Worksheet Component Type (#232.73)</p></caption>
<colgroup>
<col style="width: 15%" />
<col style="width: 18%" />
<col style="width: 18%" />
...
<span id="_Toc513207262" class="anchor"></span>Table : EDP Worksheet Component Type (#232.73)
...
<span id="_bookmark27" class="anchor"></span>Table : NHAMCS Reason for Visit (#233.8)
...
<table>
<caption><p><span id="_bookmark28" class="anchor"></span>Table : NHAMCS Reason for Visit Display (#233.81)</p></caption>
<colgroup>
<col style="width: 15%" />
<col style="width: 18%" />
<col style="width: 18%" />
...
<span id="_bookmark28" class="anchor"></span>Table : NHAMCS Reason for Visit Display (#233.81)
...
<table>
<caption><p><span id="_bookmark29" class="anchor"></span>Table : ED Complaint (#233.82)</p></caption>
<colgroup>
<col style="width: 15%" />
<col style="width: 18%" />
<col style="width: 18%" />
...
<span id="_bookmark29" class="anchor"></span>Table : ED Complaint (#233.82)
...
<table>
<caption><p><span id="_bookmark30" class="anchor"></span>Table : Attribute (#233.821)</p></caption>
<colgroup>
<col style="width: 15%" />
<col style="width: 18%" />
<col style="width: 18%" />
...
<span id="_bookmark30" class="anchor"></span>Table : Attribute (#233.821)

#### Attribute (233.821)

<table>
<caption><p><span id="_bookmark31" class="anchor"></span>Table : Possible Value (#233.8211)</p></caption>
<colgroup>
<col style="width: 15%" />
<col style="width: 18%" />
<col style="width: 18%" />
...
<span id="_bookmark31" class="anchor"></span>Table : Possible Value (#233.8211)

#### Possible Value (#233.8211)

<table>
<caption><p><span id="_bookmark32" class="anchor"></span>Table : Associated Symptom (#233.822)</p></caption>
<colgroup>
<col style="width: 15%" />
<col style="width: 18%" />
<col style="width: 18%" />
...
<span id="_bookmark32" class="anchor"></span>Table : Associated Symptom (#233.822)

#### Associated Symptom (#233.822)

<table>
<caption><p><span id="_bookmark33" class="anchor"></span>Table : Clinical Events (#234)</p></caption>
<colgroup>
<col style="width: 15%" />
<col style="width: 18%" />
<col style="width: 18%" />
...
<span id="_bookmark33" class="anchor"></span>Table : Clinical Events (#234)
...
<table>
<caption><p><span id="_Toc513207270" class="anchor"></span>Table : EDP Report Template (#232.1)</p></caption>
<colgroup>
<col style="width: 15%" />
<col style="width: 18%" />
<col style="width: 18%" />
...
<span id="_Toc513207270" class="anchor"></span>Table : EDP Report Template (#232.1)

#### EDP Report Template (#232.1)

<table>
<caption><p><span id="_Toc513207271" class="anchor"></span>Table : Subfile – Sequence (#232.12)</p></caption>
<colgroup>
<col style="width: 15%" />
<col style="width: 18%" />
<col style="width: 18%" />
...
<span id="_Toc513207271" class="anchor"></span>Table : Subfile – Sequence (#232.12)
...
<span id="_Toc513207272" class="anchor"></span>Table : Subfile – Roles (#232.13)
...
<span id="_Toc513207273" class="anchor"></span>Table : EDP Report Elements (#232.11)
...
<span id="_bookmark36" class="anchor"></span>Table : EDIS Options
...
<td>Menu</td>
<td><p>Provides access to the EDPF TRACKING VIEW options associated with signing in patients to the emergency department (the Sign In and Display Board views)</p>
<p>Timestamp: 61055,41714</p>
...
<td>Menu</td>
<td><p>Provides access to the EDPF TRACKING VIEW options associated with triaging patients (the Triage and Display Board views)</p>
<p>Timestamp: 61055,41714</p>
...
https://vaww.<span class="mark">REDACTED</span>/board/index.jsf?sitecode=442
...
https://vaww.<span class="mark">REDACTED</span>/board/index.jsf?sitecode=442&board=Lab
