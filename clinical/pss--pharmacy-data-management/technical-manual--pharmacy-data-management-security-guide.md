---
title: Pharmacy Data Management Version 1 Technical Manual/Security Guide (PSS*1*262)
doc_type: TM
...
- PSS PADE INIT
menu_options: 7
description: Pharmacy Data Management (PDM) provides tools for managing Pharmacy data. It includes tools for creating Pharmacy Orderable Items and maintaining files necessary for the Computer Patient Record System (CPRS). PDM consolidates tools for managing the various Pharmacy software products. It provides Pha
...
docx_url: https://www.va.gov/vdl/documents/Clinical/Pharm-Data_Mgmnt_(PDM)/PSS_1_0_P262_TM.docx
pdf_url: https://www.va.gov/vdl/documents/Clinical/Pharm-Data_Mgmnt_(PDM)/PSS_1_0_P262_TM.pdf
...
![](pharmacy-data-management-version-1-technical-manual-security-guide-pss-1-262/001.png)
...
<table>
<caption><p><span id="_Toc192155180" class="anchor"></span>Table 1: HL7 Drug Message Segment Definition Table</p></caption>
<colgroup>
<col style="width: 13%" />
<col style="width: 13%" />
<col style="width: 16%" />
...
<tr class="odd">
<td>08/2025</td>
<td><a href="#_File_List">2</a>, <a href="#file-descriptions">5</a>, <a href="#menu-options">6</a>, <a href="#Item_PSS">13</a>, <a href="#PP_PSS">16</a>, <a href="#standards-and-conventions-committee-sacc-exemptions">31</a>, <a href="#_Toc192155186">43</a>, <a href="#new-functionality">47</a>, <a href="#modified-and-new-routines">48</a></td>
<td>PSS*1*262</td>
<td><ul>
<li><blockquote>
<p><a href="#_File_List">Updated File List</a></p>
</blockquote></li>
<li><blockquote>
<p>Updated <a href="#file-descriptions">File Description</a> with <a href="#Patch_262">PSS*1*262 File Descriptions</a></p>
</blockquote></li>
<li><blockquote>
<p>Updated <a href="#menu-options">Menu Options</a> added <a href="#CDI">Check Drug Interaction</a> and <a href="#check_pharmacogenomic_interaction">Check Pharmacogenomic Interaction</a></p>
</blockquote></li>
<li><blockquote>
<p>Updated <a href="#Item_PSS">Option Description Example</a></p>
</blockquote></li>
<li><blockquote>
<p><a href="#PP_PSS">Updated XPAR Parameters section with PSS* 1*262.</a></p>
</blockquote></li>
</ul>
<ul>
<li><p>Added new routines, PSS262PO, PSS262PR PSSHDPG1,PSSP254A, PSSP254R, PSSP254U</p></li>
<li><p>PSSP254V, PSSPGX, PSSPGX1, PSSPGX2, PSSPGXOR, PSSPGXP2, PSSPGXPR , PSSPGXT1</p></li>
<li><p>PSSPGXTS, PSSPGXU2, and PSSPGXUT to <a href="#routines">Routine List</a></p></li>
<li><p>Updated <a href="#standards-and-conventions-committee-sacc-exemptions">Standards and Convention Committee (SACC) Exemptions</a></p></li>
<li><p>Updated <a href="#_Toc192155186">Table 7: PDM Files</a></p></li>
<li><p>Updated <a href="#new-functionality">New Functionality</a></p></li>
<li><p>Updated <a href="#modified-and-new-routines">Modified and New Routines for PSS*1*262</a></p></li>
</ul></td>
</tr>
<tr class="even">
<td>03/2024</td>
<td>1, 11, 15</td>
<td>PSS*1.0*259</td>
<td><p>Added "Exclude Start/Stop override for ONE-TIME schedules" to the <a href="#PSS_EXCLUDE_1TIME_Options">Option Descriptions</a> and <a href="#Exclude_start_stop">Menu/Options</a> sections, and <a href="#PSSEXLST">PSSEXLST</a> to the Routines section</p>
<p>Fixed table accessibility issues, especially tables 4 and 5, and the Revision History table. Changed the Styles so that the document would conform to 508-accessibility standards.</p></td>
</tr>
<tr class="odd">
<td>09/2022</td>
<td>4, 7</td>
<td>PSS*1.0*187</td>
<td>Updated section <a href="#data-dictionary-changes">2.1.1</a> with list of new fields.<br />
Added <a href="#Indication_Usage_Report">Indication Usage Report</a> to the Menu/Options section.</td>
</tr>
<tr class="even">
<td>01/2022</td>
<td>15</td>
<td>PSS*1.0*252</td>
<td>Added routine PSSNDCUT2</td>
</tr>
<tr class="odd">
<td>07/2021</td>
<td>i, 4, 10, 13</td>
...
<td><ul>
<li><blockquote>
<p>Added PSS MED INST MED ROUTE REPORT option for Medication Instruction Management</p>
</blockquote></li>
<li><blockquote>
<p>Added PSS MED INST MED ROUTE REPORT option for Medication Routes Management</p>
</blockquote></li>
<li><blockquote>
<p>Added the item PSS MED INST MED ROUTE REPORT</p>
</blockquote></li>
<li><blockquote>
<p>Added the item PSS MED INST MED ROUTE REPORT</p>
</blockquote></li>
...
<span id="_Toc192155180" class="anchor"></span>Table 1: HL7 Drug Message Segment Definition Table
...
> Example: Type Y for Yes or N for No and press \<Enter\>\<Tab\> indicates that the Tab key must be pressed.

> Example: Press \<Tab\> to move the cursor to the next field.

- ![](pharmacy-data-management-version-1-technical-manual-security-guide-pss-1-262/002.png) Indicates especially important or helpful information.
- ![](pharmacy-data-management-version-1-technical-manual-security-guide-pss-1-262/003.png) Options are locked with a particular security key. The user must hold the particular security key to be able to perform the menu option.

Example: ![](pharmacy-data-management-version-1-technical-manual-security-guide-pss-1-262/004.png) Without the PSXCOMPMGR key, the Consolidated Mail Outpatient Pharmacy options cannot be accessed.
...
![](pharmacy-data-management-version-1-technical-manual-security-guide-pss-1-262/005.png) Note: The Clinical Alert Enter/Edit \[PSO CLINICAL ALERT ENTER/EDIT\] option in the Outpatient Pharmacy package is used to add, modify, or delete Clinical Alerts.
...
<span id="Patch_262" class="anchor"></span>Patch PSS\*1.0\*262 adds the following files:
...
- <span id="_Toc286934503" class="anchor"></span>VA PHARMACOGENOMICS URL field (#103) to PHARMACY SYSTEM file (#59.7) – the field is a free-text field with a character limit of 1 to 100 characters. The data in this new field will be referenced in the last line of every PGx order check displayed in the PSS CHECK PGX INTERACTION option.
...
<span id="PP_PSS" class="anchor"></span>Patch PSS\*1\*262 moved the Check Drug Interaction \[PSS CHECK DRUG INTERACTION\] option under the Order Check Management \[PSS ORDER CHECK MANAGEMENT\] and added the Check Pharmacogenomic Interaction \[PSS CHECK PGX INTERACTION\]
...
- [Menu / Options](#menu-options)
  - [Option Descriptions](#option-descriptions)
    ...
    - [Callable Routines / Entry Points / Application Program Interfaces (APIs)](#callable-routines-entry-points-application-program-interfaces-apis)
...
> *CMOP Mark/Unmark (Single drug)* ![](pharmacy-data-management-version-1-technical-manual-security-guide-pss-1-262/006.png)
> \[PSSXX MARK\]
> *Dosages…*
...
> <span id="CDI" class="anchor"></span>*Check Drug Interaction*
> \[PSS CHECK DRUG INTERACTION\]
> <span id="check_pharmacogenomic_interaction" class="anchor"></span>*Check Pharmacogenomic Interaction*
...
> <span id="Indication_Usage_Report" class="anchor"></span>*Indication Usage Report*  
> \[PSS INDICATION USAGE REPORT\]
...
> \[PSS SCHEDULE REPORT\]
> <span id="Exclude_start_stop" class="anchor"></span>*Exclude Start/Stop override for ONE-TIME schedules*
...
![](pharmacy-data-management-version-1-technical-manual-security-guide-pss-1-262/007.png) Locked: PSXCMOPMGR
...
<span id="PSS_EXCLUDE_1TIME_Options" class="anchor"></span>ITEM: PSS EXCLUDE 1TIME STRSTP MODS
...
<span id="Item_PSS" class="anchor"></span>ITEM: PSS CHECK PGX INTERACTION
...
5.  At the "Drug Audit Retention MOS:" prompt, type the number of retention months and press \<Enter\>.
...
- PSSENV
- PSSENVN
- <span id="PSSEXLST" class="anchor"></span>PSSEXLST
- PSSFDBDI
- PSSFDBRT
- PSSFIL
- PSSFILED
...
DESCRIPTION: This protocol will be used as the ACK from the external interface for an MFN_M01 message.
...
<table>
<caption><p><span id="_Toc192155181" class="anchor"></span>Table 2: Segments Used in the Master File Update Message</p></caption>
<colgroup>
<col style="width: 13%" />
<col style="width: 8%" />
<col style="width: 23%" />
...
<td></td>
<td>4</td>
<td>IEN^DRUG NAME^99PSD</td>
<td></td>
<td>File 50 Entry</td>
</tr>
<tr class="odd">
<td><strong>ZPA</strong></td>
<td>1</td>
<td>NDC</td>
<td>ST</td>
...
<td></td>
<td>4</td>
<td>APPLICATION PACKAGE USE</td>
<td>ST</td>
<td>Used by what packages</td>
</tr>
<tr class="odd">
<td></td>
<td>5</td>
...
<td></td>
<td>7</td>
<td>DEA SPECIAL HDLG</td>
<td>ST</td>
<td>How drug is dispense based on DEA codes</td>
</tr>
<tr class="even">
<td></td>
<td>8</td>
...
<td>WARNING LABEL</td>
<td>ST</td>
<td>Drug Warnings for patient</td>
</tr>
<tr class="even">
<td></td>
<td>10</td>
<td>VISN NON-FORMULAR</td>
<td>CE</td>
<td>If '1' true</td>
</tr>
<tr class="odd">
<td><strong>ZPB</strong></td>
<td>1</td>
<td>PHARMACY ORDERABLE ITEM</td>
<td>CE</td>
<td>IEN^OI tied to dispense drug^PSD50.7</td>
</tr>
<tr class="even">
<td></td>
<td>2</td>
...
<span id="_Toc192155181" class="anchor"></span>Table 2: Segments Used in the Master File Update Message
...
<span id="_Toc192155182" class="anchor"></span>Table 3: Package Requirements
...
<span id="_Toc192155183" class="anchor"></span>Table 4: Waiver: OITIMB33554520 - Migration from M2J to VistA Web Services Client (VWSC)
...
<span id="_Toc192155184" class="anchor"></span>Table 5: Supporting Documentation for the Waiver
...
<span id="_Toc192155185" class="anchor"></span>Table 6: Security Keys
...
Example 1:Additives/Solution Dispense Drugs: Orderable Item:
...
![](pharmacy-data-management-version-1-technical-manual-security-guide-pss-1-262/009.png) Users can first check the new Dispense Drug, and if the Orderable Item does not change by rematching the Additive/Solution to the new Dispense Drug, they can choose the QUIT command.
...
This section relates only to options that are locked. For a complete listing of The PDM options listed in the PSS MGR Menu structure, refer to the [Menu/Options](#_Toc286934503) section of this document.

![](pharmacy-data-management-version-1-technical-manual-security-guide-pss-1-262/010.png) Locked: PSXCMOPMGR
...
<span id="_Toc192155186" class="anchor"></span>Table 7: PDM Files
...
<span id="_Toc192155187" class="anchor"></span>Table 8: Non-PDM Files
...
<span id="_Toc192155188" class="anchor"></span>Table 9: VistA Software

![](pharmacy-data-management-version-1-technical-manual-security-guide-pss-1-262/011.png)Please refer to the "Sending Security Codes." section of the Kernel V. 8.0 Systems Manual for more information concerning installation of security codes.
...
<span id="_Toc192155189" class="anchor"></span>Table 10: Glossary
...
- PSO_7_0_P737_MAN_UM
- PSJ_5_0_P447_PHAR_UM
- PSJ_5_0_P447_NURSE_UM
- CPRS User Guide_GUI Version
...
6.  The Send Entire Drug File to External Interface \[PSS MASTER FILE ALL\] option was modified to allow transmission of the drug file to an Inpatient Interface (PADE) depending on the PADE setup. It also provides the flexibility of sending all drugs marked for Unit Dose, IV or Ward Stock or send selected drugs to PADE.
7.  Since this option now allows to send all or selected drugs to PADE, the option name "Send Entire Drug File to External Interface" was changed to "Send Drug File Entries to External Interface"
8.  A new PSS PADE INIT security key was added so that holders of this key can only send "all" drugs to PADE noted in item 2.
9.  Option Drug Enter/Edit \[PSS DRUG ENTER/EDIT\] was modified to send an addition/update/both or none to PADE provided it is set up to receive such updates.
...
![](pharmacy-data-management-version-1-technical-manual-security-guide-updated-pss-1/005.png) Note: The Clinical Alert Enter/Edit \[PSO CLINICAL ALERT ENTER/EDIT\] option in the Outpatient Pharmacy package is used to add, modify, or delete Clinical Alerts.
...
> *CMOP Mark/Unmark (Single drug)* ![](pharmacy-data-management-version-1-technical-manual-security-guide-updated-pss-1/006.png)
...
![](pharmacy-data-management-version-1-technical-manual-security-guide-updated-pss-1/007.png) Locked: PSXCMOPMGR
...
![](pharmacy-data-management-version-1-technical-manual-security-guide-updated-pss-1/008.png)The *Enable/Disable Vendor Database Link* option exists ONLY as a way for technical personnel to turn on/off the database connection if required for debugging. Normally, it is enabled and the Vendor Database updates are performed centrally on the MOCHA Servers, not at the individual sites. It is NOT exported as part of the main PDM menu \[PSS MGR\].
...
<table>
<caption><p><span id="_Toc92357039" class="anchor"></span>Table 3: Package Requirements</p></caption>
<colgroup>
<col style="width: 13%" />
<col style="width: 8%" />
<col style="width: 23%" />
...
<tbody>
<tr class="odd">
<td rowspan="4"><strong>MSH</strong></td>
<td>1</td>
<td>|</td>
<td>ST</td>
<td>Field Separator</td>
...
<tr class="odd">
<td rowspan="3"><strong>MFI</strong></td>
<td>1</td>
<td>50^DRUG^99PSD</td>
<td>0175</td>
<td>Master File ID</td>
...
<tr class="odd">
<td rowspan="2"><strong>MFE</strong></td>
<td>1</td>
<td>MUP/MAD</td>
<td>0180</td>
<td>UPDATE/ADD</td>
...
<tr class="odd">
<td rowspan="10"><strong>ZPA</strong></td>
<td>1</td>
<td>NDC</td>
<td>ST</td>
<td>National Drug Code</td>
...
<tr class="odd">
<td rowspan="9"><strong>ZPB</strong></td>
<td>1</td>
<td>PHARMACY ORDERABLE ITEM</td>
<td>CE</td>
<td>IEN^OI tied to dispense drug^PSD50.7</td>
...
<tr class="even">
<td rowspan="7"><strong>ZPC</strong></td>
<td>1</td>
<td>SPECIMEN TYPE</td>
<td>CE</td>
<td>IEN^ SPECIMEN TYPE^LAB61</td>
...
<tr class="odd">
<td rowspan="9"><strong>[{ZPD}]</strong></td>
<td>1</td>
<td>SYNONYM</td>
<td>ST</td>
<td>Trade Name</td>
...
<tr class="even">
<td rowspan="6"><strong>[{ZPE}]</strong></td>
<td>1</td>
<td>ACTIVITY LOG</td>
<td>DT</td>
<td>HL7 Format YYYYMMDDHHMM[SS]-ZZZZ</td>
...
<tr class="even">
<td rowspan="4"><strong>[{ZPF}]</strong></td>
<td>1</td>
<td>DISPENSE UNITS PER DOSE</td>
<td>NM</td>
<td></td>
...
<tr class="even">
<td rowspan="4"><strong>[{ZPG}]</strong></td>
<td>1</td>
<td>CLOZAPINE LAB TEST</td>
<td>CE</td>
<td>IEN^LAB TEST^LAB60</td>
...
<tr class="even">
<td rowspan="3"><strong>[{ZPH}]</strong></td>
<td>1</td>
<td>LOCAL POSSIBLE DOSAGE</td>
<td>ST</td>
<td>FREE TEXT</td>
...
<span id="_Toc92357039" class="anchor"></span>Table 3: Package Requirements
...
<span id="_Toc92357037" class="anchor"></span>Table 2: Segments Used in the Master File Update Message
...
<span id="_Toc92357040" class="anchor"></span>Table 4: Waiver
...
<table>
<caption><p><span id="_Toc92357043" class="anchor"></span>Table 6: PDM FIles</p></caption>
<colgroup>
<col style="width: 100%" />
</colgroup>
<thead>
<tr class="header">
<th><table>
<caption><p><span id="_Toc92357044" class="anchor"></span>Table 7: Non-PDM Files</p></caption>
<colgroup>
<col style="width: 22%" />
<col style="width: 77%" />
</colgroup>
...
<table>
<caption><p><span id="_Toc92357045" class="anchor"></span>Table 8: VistA Software</p></caption>
<colgroup>
<col style="width: 10%" />
<col style="width: 40%" />
<col style="width: 37%" />
...
<span id="_Toc92357043" class="anchor"></span>Table 6: PDM FIles
...
![](pharmacy-data-management-version-1-technical-manual-security-guide-updated-pss-1/009.png) Users can first check the new Dispense Drug, and if the Orderable Item does not change by rematching the Additive/Solution to the new Dispense Drug, they can choose the QUIT command.
...
![](pharmacy-data-management-version-1-technical-manual-security-guide-updated-pss-1/011.png)Please refer to the "Sending Security Codes." section of the Kernel V. 8.0 Systems Manual for more information concerning installation of security codes.
