---
title: PSS*1*87 Release Notes - Laser Printed Prescription Labels Phase II
doc_type: RN
...
![](pss-1-87-release-notes-laser-printed-prescription-labels-phase-ii/002.png)Note: The CMOP patch, PSX\*2\*54, will be released at a later date, when the CMOPs are ready to receive the format changes.
![](pss-1-87-release-notes-laser-printed-prescription-labels-phase-ii/003.png)Note: The Outpatient Pharmacy patch, PSO\*7\*200, will be released at a later date, when changes are made to the Outpatient Automation Interface processing to pass the new warning label text in English or Spanish.
...
![](pss-1-87-release-notes-laser-printed-prescription-labels-phase-ii/004.png)Note: The user running this utility must have their FileMan access set to “@” to have permission to execute this routine.
