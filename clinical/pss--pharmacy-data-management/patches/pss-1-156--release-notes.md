---
title: PSS*1*156 PSO*7*354 Outpatient Pharmacy Automation Interface Expansion (OPAI) Release Notes
doc_type: RN
...
Example: Orlando VAMC dispensing system printer and ADDs set-up.

The Orlando VAMC test site has configured seven (7) dispensing printers and two (2) automated dispensing devices to be used by seven (7) active divisions. Below is an example of the Orlando set-up in the OUTPATIENT SITE file (#59).

| DIVISION      | DISPENSING SYSTEM PRINTER | ADD       | CATEGORY |
|-------------------|-------------------------------|---------------|--------------|
| CLERMONT CBOC     | ORMCPTPHARM1                  | ORL-SCRIPTPRO | ANY          |
...
| DAYTONA BEACH OPC | ORMCPTPHARM1                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM2                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM3                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM4                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM5                  | ORL-SCRIPTPRO | ANY          |
|                   | ORVIPTPHARMP10                | VIE-SCRIPTPRO | ANY          |
|                   | ORVIPTPHARMP6                 | VIE-SCRIPTPRO | ANY          |
| KISSIMMEE CBOC    | ORMCPTPHARM1                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM2                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM3                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM4                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM5                  | ORL-SCRIPTPRO | ANY          |
|                   | ORVIPTPHARMP10                | VIE-SCRIPTPRO | ANY          |
|                   | ORVIPTPHARMP6                 | VIE-SCRIPTPRO | ANY          |
| LEESBURG CBOC     | ORMCPTPHARM1                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM2                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM3                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM4                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM5                  | ORL-SCRIPTPRO | ANY          |
|                   | ORVIPTPHARMP10                | VIE-SCRIPTPRO | ANY          |
|                   | ORVIPTPHARMP6                 | VIE-SCRIPTPRO | ANY          |
| ORANGE CITY CBOC  | ORMCPTPHARM1                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM2                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM3                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM4                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM5                  | ORL-SCRIPTPRO | ANY          |
|                   | ORVIPTPHARMP10                | VIE-SCRIPTPRO | ANY          |
|                   | ORVIPTPHARMP6                 | VIE-SCRIPTPRO | ANY          |
| ORLANDO VAMC      | ORMCPTPHARM1                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM2                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM3                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM4                  | ORL-SCRIPTPRO | ANY          |
|                   | ORMCPTPHARM5                  | ORL-SCRIPTPRO | ANY          |
