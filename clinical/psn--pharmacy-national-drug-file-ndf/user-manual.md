---
title: National Drug File Version 4 User Manual (Updated PSN*4*218)
doc_type: UM
...
- [Using the Inquire Options](#using-the-inquire-options)
  - [## Inquiry Options](#inquiry-options)
    ...
    - [> ![](national-drug-file-version-4-user-manual-updated-psn-4-218/007.png)For more information about the new fields, refer to the patch description for PSN\4.0\492 in Forum.](#national-drug-file-version-4-user-manual-updated-psn-4-218007pngfor-more-information-about-the-new-fields-refer-to-the-patch-description-for-psn40492-in-forum)
...
<td>12/2017</td>
<td><p>i-iv</p>
<p><a href="#menu">4-5</a>, <a href="#pps-n-menu">79-102</a>, <a href="#p107">108</a></p></td>
<td>PSN*4*513</td>
...
<td>07/2017</td>
<td><p>i-iv</p>
<p><a href="#national-drug-file-v.-4.0-menu">4-6</a>, 10-12,</p>
<p><a href="#PSN_4_169p40a">48-60</a>, <a href="#P057">63-69</a> , <a href="#glossary">80-81</a>, <a href="#p083">83-84</a></p></td>
<td>PSN*4.0*396</td>
...
<tr class="even">
<td>11/2016</td>
<td><a href="#p08">8</a>, <a href="#verify-matches">9</a>, <a href="#p044">44</a>, <a href="#p045">45</a>, <a href="#p046">46</a>, <a href="#PSN_4_169p40a">47</a>, <a href="#fixed-medication-copayment-tier">48</a>, <a href="#p049">49</a>, <a href="#P052">52</a>, <a href="#P053">53</a>, <a href="#fixed-medication-copay-tier-enhancements">55</a>, <a href="#p056">56</a>, <a href="#P057">57</a>-<a href="#p058">58</a>, <a href="#p068">68</a>, <a href="#p069">69</a></td>
<td>PSN*4.0*492</td>
...
![](national-drug-file-version-4-user-manual-updated-psn-4-218/002.png) Indicates the user should take note of the information.
...
Select DRUG GENERIC NAME: <u>VAPONEPHRINE</u> EPINEPHRINE RACEMIC 2.25% SOL.
...
<tr class="odd">
<td></td>
<td><p>If a drug entry has a</p>
<p>CS FEDERAL SCHEDULE of:</p></td>
<td>And its corresponding DEA, SPECIAL HDLG field is blank, the following DEA, SPECIAL HDLG code will be inserted:</td>
<td></td>
</tr>
<tr class="even">
...
<span id="p08" class="anchor"></span>Copay Tier: 3
...
![](national-drug-file-version-4-user-manual-updated-psn-4-218/003.png)This option should not be run until at least one merge using the menu option *Merge National Drug File Data Into Local File* has been executed.
...
![](national-drug-file-version-4-user-manual-updated-psn-4-218/004.png)To change the VA Drug Classification of a drug previously matched automatically by NDC, first attempt to rematch the drug using the *Rematch/Match Single Drugs* option. If that fails, classify the drug manually using this option.
...
> ![](national-drug-file-version-4-user-manual-updated-psn-4-218/005.png) This report should only be run *after* executing the NDF software.
...
<span id="PSN_4_169p40a" class="anchor"></span>In this example, the Dosage Form of ‘Oil’ is excluded from dosage checks, but since the Override DF Exclude from Dosage Checks is set to ‘Yes’, dosage checks will be performed for the VA Product, ‘Cod Liver Oil.’
...
<span id="p045" class="anchor"></span>Copay Tier: 0
...
> ![](national-drug-file-version-4-user-manual-updated-psn-4-218/006.png) For more information about the new fields, refer to PSN\*4\*261. For information on how the new fields affect auto-creation of possible dosages during the match and re-match process, refer to patch PSS\*1\*155. For more information about the supra-therapeutic dosages project, refer to the Release Notes for these patches.
...
### > ![](national-drug-file-version-4-user-manual-updated-psn-4-218/007.png)For more information about the new fields, refer to the patch description for PSN\*4.0\*492 in Forum.
...
> ![](national-drug-file-version-4-user-manual-updated-psn-4-218/008.png)For more information about the new fields, refer to PSN\*4\*261. For information on how the new fields affect auto-creation of possible dosages during the match and re-match process, refer to patch PSS\*1\*155.
...
<span id="P052" class="anchor"></span>Copay Tier: 1
...
<span id="P053" class="anchor"></span>Copay Tier: 1
...
<span id="p058" class="anchor"></span>Example 3: NDF Inquiry by CMOP ID Number (cont.)
...
> ![](national-drug-file-version-4-user-manual-updated-psn-4-218/009.png)For more information about the new fields, refer to the patch description on Forum for PSN\*4.0\*492.
...
<span id="p056" class="anchor"></span>Copay Tier: 2
...
<span id="P057" class="anchor"></span>Example 2: Fixed Medication Copay Tier by (N)DC
...
> ![](national-drug-file-version-4-user-manual-updated-psn-4-218/010.png)For more information about the new fields, refer to the patch description on Forum for PSN\*4.0\*396.
...
Select VA PRODUCT NAME:SIMVASTATIN

1 SIMVASTATIN 10MG TAB

2 SIMVASTATIN 10MG TAB,UD

3 SIMVASTATIN 20MG TAB

4 SIMVASTATIN 20MG TAB,UD

5 SIMVASTATIN 40MG TAB

Press \<RETURN\> to see more, '^' to exit this list, OR

CHOOSE 1-5: 1 SIMVASTATIN 10MG TAB
...
![](national-drug-file-version-4-user-manual-updated-psn-4-218/011.png)
...
![](national-drug-file-version-4-user-manual-updated-psn-4-218/012.png)
...
> ![](national-drug-file-version-4-user-manual-updated-psn-4-218/013.png)Before scheduling a download, the PPS-N Site Parameters and the Secure Shell (SSH) keys must be defined.
...
> ![](national-drug-file-version-4-user-manual-updated-psn-4-218/014.png)Before scheduling an install, the PPS-N Site Parameters and the Secure Shell (SSH) keys must be defined. In addition, the scheduled install will need to be scheduled an hour after the scheduled download. This gives time for the download to finish.
...
![](national-drug-file-version-4-user-manual-updated-psn-4-218/015.png)
...
![](national-drug-file-version-4-user-manual-updated-psn-4-218/016.png) The *PPS-N Site Parameters (Enter/Edit)* \[PSN PPS PARAM\] option requires the ‘PSN PPS ADMIN’ Security Key for editing the parameters.
...
![](national-drug-file-version-4-user-manual-updated-psn-4-218/017.png) An '\*' (asterisk) before the field name indicates that PSN PPS COORD security key is required for editing these fields/parameters.
...
![](national-drug-file-version-4-user-manual-updated-psn-4-218/018.png) The Manage Secure Shell (SSH) Keys \[PSN PPS SSH KEY MANAGEMENT\] option requires the PSN PPS COORD Security Key for creating or deleting SSH Key pairs.
...
- If you are not sure how to create and share the Public SSH Key invoke the Action ‘H’ for detailed information to help you successfully create and share the key with the state. It is recommended that you use RSA.
...
| ![](national-drug-file-version-4-user-manual-updated-psn-4-218/019.png) | <span class="mark">REDACTED</span> |
|---------------------------------------------------------------------------------------------------------------------------------|------------------------------------|

Example: A screen shot of a request

![](national-drug-file-version-4-user-manual-updated-psn-4-218/020.png)
...
<span id="p068" class="anchor"></span>Copay Tier This VistA field indicates the level of copayment a Pharmacy product has as it relates to the calculation of the copayment amount. The tier levels include Tier 0, Tier 1, Tier 2 and Tier 3. See Fixed Medication Copay Tier definition below for the types of products associated with each tier.
...
<span id="p069" class="anchor"></span>Fixed Medication Copay Tier Mandated Criteria specifying how copay amounts will be calculated determined by the Tier level designated for a Pharmacy Product including: Tier 1 - selected generic, Tier 2 - generic and Tier 3 - brand name products. A Tier 0 will be used for Supplies, and other exempt products.
...
<span id="p083" class="anchor"></span>TradeName This is the brand name. The name given to a generic product to distinguish it as one produced and sold by a specific manufacturer.
...
Allow Unmatched Drugs to be Classed (Loop) · 14
Allow Unmatched Drugs to be Classed (Single Drug) · 13
Attempt to Class Item already Matched, Classed, and Merged · 15
Automatic Match of Unmatched Drugs · 12
D
Drug-Drug Interaction Report · 34
E
Entering National Drug Codes · 3
F
Fixed Medication Copay Tier 55
I
Icons · 2
Inquire to Local Drug File · 38
Inquire to Local Drug File by Generic Name Chosen · 38
Inquire to National Files · 42
Inquire to VA Product Info For Local Drug · 40
Inquiry Options · 38
Introduction · 1
L
Local Drug File Report · 17
Local Drug/VA Print Name Report · 34
Local Drugs Excluded from Drug-Drug Interactions · 36
Local Drugs with No Match to NDF Report · 29
Local Drugs with No VA Drug Class Report · 22
Local Formulary Report · 30
Loop Interrupted When No Default Class and No Value Entered · 14
M
...
Print a PMI Sheet · 43
Printing an FDA Medication Guide · 45
Printing a Patient Medication Information Sheet · 43
R
Related Manuals · 1
...
VA Products Excluded from Drug-Drug Interactions · 37
VA Products Marked for CMOP Transmission · 35
Verify Matches · 8
Verify Single Match · 9
Verify Single Match, Drug Already Verified · 10
Verify Single Match, Drug Not Matched · 10
