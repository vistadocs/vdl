---
title: PSN*4*576 Deployment, Installation, Back-Out, and Rollback Guide
doc_type: DIBR
...
docx_url: https://www.va.gov/vdl/documents/Clinical/Pharm-National_Drug_File_(NDF)/PSN_4_0_576_DIBR.docx
pdf_url: https://www.va.gov/vdl/documents/Clinical/Pharm-National_Drug_File_(NDF)/PSN_4_0_576_DIBR.pdf
app_url: https://www.va.gov/vdl/application.asp?appid=89
audit_applied: '2026-05-31'
master_source: PSN*4*576 Deployment, Installation, Back-Out, and Rollback Guide
master_pub_date: August 2025
consolidated_from: 2 versions
prior_versions:
- PSN*4*567 Deployment, Installation, Back-Out, and Rollback Guide
consolidated_title: deployment, installation, back-out, and rollback guide
---

![](psn-4-576-deployment-installation-back-out-and-rollback-guide/001.png)
...
- ![](psn-4-576-deployment-installation-back-out-and-rollback-guide/002.png)
...
### From: PSN*4*567 Deployment, Installation, Back-Out, and Rollback Guide

### Test Site Information (Locations, Deployment Recipients)

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

The following test sites are participating in the testing of the National Drug File v4.0 patch PSN \*4.0\*567software:
