...
patch_id: PSN*4
group_key: PSN:PSN:4
description: '- # Enhancements - Redesigned National Drug File V. 4.0 Menu > The National Drug File (NDF) V. 4.0 software module provides standardization of the local drug files in all Department of Veterans Affairs Medical Centers (VAMCs)....'
