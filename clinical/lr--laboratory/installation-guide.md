...
patch_id: LR*5.2
group_key: LR:LR:5.2
description: The Laboratory Installation Guide Version 5.2 is designed to provide the Department of Veterans Affairs Medical Center (VAMC), Information Resource Management Service (IRM), and the Laboratory Information Manager (LIM) with the necessary technical information required to install and implement...
