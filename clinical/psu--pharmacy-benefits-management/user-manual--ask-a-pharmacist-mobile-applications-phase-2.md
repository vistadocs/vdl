---
title: Ask A Pharmacist User Manual (Mobile Applications Phase 2)
doc_type: UM
...
![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/001.png)
...
|------------|----------|-------------------------|--------|
| 3/4/2016   | 1.0      | Baselined after v 1.0   |        |
| 04/29/2015 | 0.1      | Create initial document |        |
...
- [Getting Started](#getting-started)
  - [Opening Ask a Pharmacist](#opening-ask-a-pharmacist)
  - [System Menu](#system-menu)
  - [Navigating Ask a Pharmacist](#navigating-ask-a-pharmacist)
    - [Navigating a Feature](#navigating-a-feature)
  - [Exit System](#exit-system)
  - [Image Library](#image-library)
  - [Caveats and Exceptions](#caveats-and-exceptions)
- [Using Ask a Pharmacist](#using-ask-a-pharmacist)
  - [Home Screen](#home-screen)
  - [Home, Features, About, and Help](#home-features-about-and-help)
    - [Home](#home)
    - [Features](#features)
    - [About and Help](#about-and-help)
  - [My HealtheVet Pharmacy Services](#my-healthevet-pharmacy-services)
    - [FAQ – My HealtheVet](#faq-my-healthevet)
    - [Medication Articles on My HealtheVet](#medication-articles-on-my-healthevet)
    - [Medical Library](#medical-library)
    - [Prescription History](#prescription-history)
    - [Rx Refill](#rx-refill)
    - [Rx Refill Guide](#rx-refill-guide)
    - [Send a Secure Message](#send-a-secure-message)
    - [Track My Medications](#track-my-medications)
  - [Pill and Bottle Information](#pill-and-bottle-information)
    - [Pill Bottle Information](#pill-bottle-information)
    - [Pill Identification](#pill-identification)
  - [VA Trusted Medication Resources](#va-trusted-medication-resources)
    - [Consumer Drug, Herbal & Supplement Information](#consumer-drug-herbal-supplement-information)
    - [Drug Interactions and Adverse Drug Events](#drug-interactions-and-adverse-drug-events)
    - [FAQ – VA National Medication Formulary](#faq-va-national-medication-formulary)
    - [Know Your Medication Label](#know-your-medication-label)
    - [Medication Administration](#medication-administration)
    - [Medication Disposal](#medication-disposal)
    - [Pill Identification](#pill-identification-1)
  - [About VA Pharmacies](#about-va-pharmacies)
    - [Find My Facility](#find-my-facility)
    - [How VA Pharmacies Operate](#how-va-pharmacies-operate)
    - [How VA Pharmacists Help Veterans](#how-va-pharmacists-help-veterans)
  - [Send a Secure Message](#send-a-secure-message-1)
...
AAP also allows Veterans with verified My Health*e*Vet (MHV) accounts to access pharmacy services and secured messaging through their MHV account.
...
<span id="_Toc422124594" class="anchor"></span>Figure : Data Flow

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/002.png)
...
<td>View content, Navigate links</td>
<td><p><u>All Account Types</u>: Access My Medications</p>
<p><u>Advanced Account</u>: Access all Pharmacy Features</p>
<p><u>Premium Account</u>: Access all Pharmacy Features, Access Secure Messaging (Opt-in Required)</p></td>
</tr>
<tr class="even">
<td>Secondary Users</td>
<td>Clinical Providers</td>
<td>View content, Navigate links</td>
<td></td>
</tr>
<tr class="odd">
<td>Secondary Users</td>
<td>Ask A Pharmacist Mobile App SMEs (Administrator)</td>
<td>View content, Navigate links</td>
<td>Update AAP FAQ content</td>
</tr>
</tbody>
</table>
...
<span id="_Ref418147979" class="anchor"></span>Figure : AAP Home Screen, Tablet View

![Figure 3 provides an illustration of the phone view of the AAP Home screen (shown on the left side of the figure). The image on the right side of the figure displays how to access ‘About’ and ‘Help’ by tapping the menu icon in the upper right.](ask-a-pharmacist-user-manual-mobile-applications-phase-2/003.png)
...
<span id="_Ref418148020" class="anchor"></span>Figure : AAP Home Screen, Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/004.png) ![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/005.png)

## Navigating Ask a Pharmacist
...
<span id="_Toc422124597" class="anchor"></span>Figure : Home Screen

Tablet View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/006.png)

Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/007.png)
...
<span id="_Toc422124598" class="anchor"></span>Figure : Feature Menu

Tablet View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/008.png)

Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/009.png)

Using the phone view, tap the icon next to each related link to open its description.

<span id="_Toc422124599" class="anchor"></span>Figure : Feature Menu, Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/010.png)
...
<span id="_Ref418148256" class="anchor"></span>Figure : AAP Article, Tablet View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/011.png)
...
<span id="_Toc422124601" class="anchor"></span>Figure : AAP Article, Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/012.png)
...
<span id="_Ref418150013" class="anchor"></span>Figure : Leaving AAP

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/013.png)
...
<span id="_Toc422124603" class="anchor"></span>Figure : Information icon

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/014.png)
...
<span id="_Toc422124604" class="anchor"></span>Figure : Fading Bottom of Screen

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/015.png)
...
<span id="_Toc422124605" class="anchor"></span>Figure : Menu Icon

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/016.png)

The menu icon is commonly referred to as the ‘Hamburger Icon’. Tap on it to view a drop-down menu list.

<span id="_Toc422124606" class="anchor"></span>Figure : Menu Arrow and Back Arrow

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/017.png)![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/018.png)
...
# Using Ask a Pharmacist

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

Many of the features and related links offered by Ask A Pharmacist (AAP), including My Health*e*Vet (MHV) resources and Secure Messaging, require registering with MHV as a VA Patient and acquiring a Premium Account via In-Person Authentication (IPA). Online Authentication is another option for users who have a connected eBenefits DS Logon (Department of Defense Self-Service Logon) and a MHV VA Patient account.
...
<span id="_Ref415061404" class="anchor"></span>Figure : Home Screen

Tablet View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/019.png)

Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/020.png)

## Home, Features, About, and Help
...
<span id="_Toc422124608" class="anchor"></span>Figure : Features Drop Down, Tablet View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/021.png)
...
<span id="_Ref415054990" class="anchor"></span>Figure : Features Drop Down, Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/022.png)
...
<span id="_Ref415055567" class="anchor"></span>Figure : About Window, Tablet View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/023.png)
...
<span id="_Ref415056457" class="anchor"></span>Figure : Help Window, Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/024.png)
...
My Health*e*Vet is the primary Internet connection between Veterans and their health care benefits. This section introduces the many services available through MHV.

On the Home screen, tap ‘My Health*e*Vet Pharmacy Services’ for a menu of related links. In order to have full access to all of this feature’s resources, you should be registered with MHV as a VA Patient and upgrade to a Premium account.

Figure 19 illustrates views of the related links available after tapping ‘My Health*e*Vet’ from your Home screen.

<span id="_Ref415125252" class="anchor"></span>Figure : My Health*e*Vet Pharmacy Services

Tablet View

Scroll down to view all related links in the menu.

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/025.png)

Phone View

Scroll down to view all related links in the menu.

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/026.png)

### FAQ – My Health*e*Vet

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

When you tap ‘FAQ – My Health*e*Vet’, a window pops up to inform you that you are leaving AAP to go to an external website. This window appears every time a link to an external website is tapped. You can tap ‘Continue’ to go to the website or ‘Cancel’ to remain on your current screen. You have the option of tapping the box next to the instruction ‘Do not show this message again’ if you do not want this window to pop up again.

Figure 20 illustrates the pop-up window informing you that you are leaving AAP.

<span id="_Toc422124613" class="anchor"></span>Figure : Leaving AAP Pop-up

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/027.png)

Tap ‘Continue’ to leave AAP and proceed to the “My Health*e*Vet Frequently Asked Questions” web page (shown in Figure 21) to access a collection of commonly asked questions and answers about features in MHV.

<span id="_Toc422124614" class="anchor"></span>Figure : My Health*e*Vet FAQ

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/028.png)
...
### Medication Articles on My Health*e*Vet
...
Tapping ‘Medication Articles on My Health*e*Vet’ opens another menu containing links to medication and pharmacy-related articles from MHV.

<span id="_Ref415145077" class="anchor"></span>Figure : Medication Articles Example

Tablet View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/029.png)

Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/030.png)
...
<span id="_Toc422124616" class="anchor"></span>Figure : Medical Library

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/031.png)
...
> Tap on the link <u>Veterans Health Library</u> to proceed there.

<span id="_Toc422124617" class="anchor"></span>Figure : Veterans Health Library

> ![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/032.png)
...
> Tap the <u>MedlinePlus ®</u> on the MHV Medical Library web page to proceed to another MHV web page as shown in Figure 25.

<span id="_Toc422124618" class="anchor"></span>Figure : MHV MedlinePlus Web Site

> ![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/033.png)

> *Note: This web site is external to AAP. It could look different than the example above.*

<span id="_Toc422124619" class="anchor"></span>Figure : MedlinePlus Homepage

> ![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/034.png)
...
<span id="_Toc422124620" class="anchor"></span>Figure : My Health*e*Vet Home Page

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/035.png)
...
<span id="_Toc422124621" class="anchor"></span>Figure : Rx Refill Guide

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/036.png)
...
To use the Secure Messaging feature, you must be receiving health care services from VA, have registered on My Health*e*Vet as a “VA Patient,” and have a Premium My Health*e*Vet account.
...
<span id="_Ref415128613" class="anchor"></span>Figure : Track My Medications Menu

Tablet View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/037.png)

Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/038.png)

- Prescription Tracker – FAQ  
  > Tap ‘Prescription Tracker – FAQ’, then tap ‘Continue’ to go to links on the MHV Frequently Asked Questions web page to view FAQ for the My Health*e*Vet Prescription Tracker. This can be used to track delivery of VA prescriptions filled by a VA Mail Order Pharmacy and mailed within the last 45 days.  
  > Tap your browser's Back Arrow, or close the current Tab or Window, to return to AAP.
- UPS My Choice
...
<span id="_Toc422124623" class="anchor"></span>Figure : UPS My Choice

> ![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/039.png)
...
> Here you can learn about and register for ‘My USPS.com’, a service that tracks the status of your deliveries if you choose to have them delivered by United States Postal Service (USPS).

> Tap ’USPS’, then tap ‘Continue’ to go to the USPS web site as shown in Figure 31.

<span id="_Toc422124624" class="anchor"></span>Figure : My USPS.com

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/040.png)
...
<span id="_Toc422124625" class="anchor"></span>Figure : Home Screen

Tablet View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/041.png)

Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/042.png)
...
<span id="_Toc422124626" class="anchor"></span>Figure : Pill Bottle Information

Tablet View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/043.png)

Tap your browser’s Back arrow to return, or tap ‘Home’ or ‘Features,’ to go to other AAP locations.

Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/044.png)
...
<span id="_Toc422124627" class="anchor"></span>Figure : Pillbox, Pill Identification

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/045.png)
...
<span id="_Ref418090175" class="anchor"></span>Figure : Home Screen

Tablet View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/046.png)

Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/047.png)

<span id="_Ref418090305" class="anchor"></span>Figure : VA Trusted Medication Resources Menu

Tablet View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/048.png)

Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/049.png)
...
> Tap ‘Drug Interactions Checker,’ then tap ‘Continue’ to proceed to Drugs.com web site’s Drug Interactions Checker page. Tap ‘I Agree’ on the End-user License Agreement (EULA) and proceed to the web page, shown in Figure 37, where you can learn about interactions between drugs that you’ve selected from the site’s database, the relative level of significance of a given interaction, and in certain cases, a recommended course of action to manage the interaction.

<span id="_Toc422124630" class="anchor"></span>Figure : Drug Interactions Checker

> ![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/050.png)  
> *Note: This web site is external to AAP. It could look different than the example above.*
...
<span id="_Toc422124631" class="anchor"></span>Figure : MedlinePlus Allergy Information

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/051.png)
...
<span id="_Toc422124632" class="anchor"></span>Figure : MedWatch Online Voluntary Reporting Form

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/052.png)
...
<span id="_Toc422124633" class="anchor"></span>Figure : Medical Product Safety Information

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/053.png)
...
<span id="_Toc422124634" class="anchor"></span>Figure : FDA, Avoiding Drug Interactions

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/054.png)
...
<span id="_Toc422124635" class="anchor"></span>Figure : SafeMedication, How to Administer

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/055.png)
...
<span id="_Toc422124636" class="anchor"></span>Figure : Medication Disposal

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/056.png)
...
<span id="_Toc422124637" class="anchor"></span>Figure : Home Screen

Tablet View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/057.png)

Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/058.png)

The “About VA Pharmacies” screen opens and provides the information as shown in Figure 45.

<span id="_Toc422124638" class="anchor"></span>Figure : About VA Pharmacies

Tablet View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/059.png)

Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/060.png)
...
<span id="_Toc422124639" class="anchor"></span>Figure : Find VA Locations

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/061.png)
...
<span id="_Toc422124640" class="anchor"></span>Figure : Home Screen

Tablet View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/062.png)

Phone View

![](ask-a-pharmacist-user-manual-mobile-applications-phase-2/063.png)
