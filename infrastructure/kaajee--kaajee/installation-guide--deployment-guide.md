---
title: KAAJEE 1.2.0 Deployment Guide (Weblogic 10.3.6)
doc_type: IG
doc_label: Installation Guide
doc_layer: anchor
doc_subject: Deployment Guide (Weblogic 10.3.6)
app_code: KAAJEE
app_name: KAAJEE
section: INF
app_status: archive
...
docx_url: https://www.va.gov/vdl/documents/Infrastructure/KAAJEE_Archive/kaajee_1_2_deployguide.docx
pdf_url: https://www.va.gov/vdl/documents/Infrastructure/KAAJEE_Archive/kaajee_1_2_deployguide.pdf
app_url: https://www.va.gov/vdl/application.asp?appid=298
audit_applied: '2026-05-31'
master_source: KAAJEE 1.2.0 Deployment Guide (Weblogic 10.3.6)
master_pub_date: July 2020
consolidated_from: 3 versions
prior_versions:
- KAAJEE 1.0.1 Deployment Guide (WebLogic 8.1)
- KAAJEE 1.1.0 Deployment Guide (WebLogic 9.2 and higher)
consolidated_title: kaajee deployment guide
---

![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/001.png)

KERNEL AUTHENTICATION & AUTHORIZATION FOR J2EE (KAAJEE) VERSION 1.2.0andSECURITY SERVICE PROVIDER INTERFACE (SSPI)VERSION 1.2.0FOR WEBLOGIC (WL) VERSIONS 10.3.6 AND HIGHERDEPLOYMENT GUIDE
...
<tr class="odd">
<td>07/2020</td>
<td><p>Software and documentation for KAAJEE 1.2.x.x, Single Sign-On Web Application Plugin (SSOWAP) 1.1.0.xxx and KAAJEE Security Service Provider Interface (SSPI) 1.2.0.005 referencing VistALink 1.6 and WebLogic 10.3.6 and higher.</p>
<p>Kernel Patches: XU*8.0*694 and XU*8.0*696</p></td>
<td><p>HPS Admin</p>
<p>REDACTED</p></td>
</tr>
<tr class="even">
...
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/002.png) <strong>REF:</strong> For a description of the current KAAJEE software version numbering scheme, please review the readme.txt file distributed with the KAAJEE software.</p></td>
...
|                                                                                                                |                                                                                                                                                                                            |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/003.png) | NOTE: Kernel is the designated custodial software application for KAAJEE; however, KAAJEE comprises multiple patches and software releases from several HealtheVet-VistA applications. |
...
Appendix A-[1](#figure_a_4)](#figure_a_4)

[Figure A-3. Sample KAAJEE Deployment Descriptor: weblogic.xml file (e.g., KAAJEE Sample Web Application) Appendix A-[5](#_Toc287867682)](#_Toc287867682)
...
| Symbol                                                                                                        | Description                                                                                                     |
|-------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/004.png)    | NOTE/REF: Used to inform the reader of general information including references to additional reading material. |
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/005.png) | CAUTION or DISCLAIMER: Used to inform the reader to take special notice of critical information.                |
...
|                                                                                                                |                                                                                                                                            |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/006.png) | NOTE: Callout boxes refer to labels or descriptions usually enclosed within a box, which point to specific areas of a displayed image. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/007.png)</td>
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/008.png)</td>
...
|                                                                                                             |                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|-------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/009.png) | DISCLAIMER: The appearance of any external hyperlink references in this manual does not constitute endorsement by the Department of Veterans Affairs (VA) of this Web site or the information, products, or services contained therein. The VA does not exercise any editorial control over the information you may find at these locations. Such links are provided and are consistent with the stated purpose of this VA Intranet Service. |
...
SSOWAP depends on the Personal Identification Verification (PIV) authentication by the Identity and Access Management (IAM) services, it then proceeds to authenticate further against a (Secure Token Service (STS) Service cloud, followed by the selected VistA M Server. If the user has been properly authenticated against a VistA M Server, SSOWAP dynamically creates a temporary username and password and populates this into a Structured Query Language (SQL) database via custom Security Service Provider Interfaces (SSPIs). This username and password is needed for the second level/phase/pass authentication for the J2EE container.

|                                                                                                                |                                                                                                                                                                                 |
|----------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/010.png) | REF: For more information on SSPIs and the overall KAAJEE-related AA process please refer to the "Security Service Provider Interfaces (SSPI)" topic in this documentation. |
...
- Allows the use of an existing credential—the Access and Verify code (KAAJEE Classic) or an authorization token (SSOWAP)—for Authentication and Authorization, rather than introducing a new security credential.
...
|                                                                                                                |                                                                                                                                                                                           |
|----------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/011.png) | REF: KAAJEE Classic and SSOWAP do *not* currently use the Department of Veterans Affairs Personal Identification (VPID), since this field is not currently populated enterprise-wide. |
...
SSOWAP provides the following high-level features and functionality:

- Accepts validation by the IAM services
- Validates against the SSOi STS cloud
- Validates at the M system/division selected by the user at logon.
...
|                                                                                                                |                                                                                                                                   |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/012.png) | REF: For more information on groups and roles, please refer to Chapter 5, "Role Design/Setup/Administration," in this manual. |
...
|                                                                                                                |                                                                                                                                                                                                                                            |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/013.png) | REF: For a sample spreadsheet showing a mapping between WebLogic group names (i.e., principals) with J2EE security role names, please refer to "Appendix B—Mapping WebLogic Group Names with J2EE Security Role Names" in this manual. |
...
|                                                                                                                |                                                                                                                                                                      |
|----------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/014.png) | REF: For more information on formatting J2EE usernames, please refer to the "J2EE Username Format" topic in Chapter 7, "Programming Guidelines," in this manual. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/015.png)</td>
...
|                                                                                                                |                                                                                                                        |
|----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/016.png) | REF: For more information on the SIGN-ON LOG file (#3.081), please refer to the *Kernel Systems Management Guide*. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/017.png)</td>
...
|                                                                                                                |                                                                                                |
|----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/018.png) | REF: For specific VistA M Server patch details, please refer to the Patch Module on FORUM. |

|                                                                                                                |                                                                                                                                                                                    |
|----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/019.png) | REF: For a list of the Commercial-Off-The-Shelf (COTS) software required for KAAJEE, please refer to Table 8‑5 in Chapter 8, "Implementation and Maintenance," in this manual. |
...
|                                                                                                                |                                                                                                                                                           |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/020.png) | NOTE: KAAJEE (Iteration 1) does *not* use WebLogic's embedded LDAP server. It uses an Oracle 11*g* database to store users and groups by using SSPIs. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/021.png)</td>
...
<span id="_Toc287867638" class="anchor"></span>Figure 1‑1. KAAJEE & J2EE Web-based application process overview diagram

![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/022.png)
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/023.png)</td>
...
![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/024.png)
...
|                                                                                                                |                                                                          |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/025.png) | NOTE: The container remembers the URL the user originally requested. |
...
![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/026.png)

|                                                                                                             |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|-------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/027.png) | CAUTION: As per the Software Engineering Process Group/Software Quality Assurance (SEPG/SQA) Standard Operating Procedure (SOP) 192-039—Interface Control Registration and Approval (effective 01/29/01, see http://vista.med.va.gov/SEPG_lib/Standard%20Operating%20Procedures/192-039%20Interface%20Control%20Registration%20and%20Approval.htm), application programmers developing HealtheVet VistA J2EE Web-based applications that are KAAJEE-enabled *must* use the KAAJEE login Web page (i.e., login.jsp) as delivered (see Figure 1‑3). Developers *must not* customize the login Web page or alter the KAAJEE software code in any way. |

|                                                                                                             |                                                                                                                                                                                                                                       |
|-------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/028.png) | CAUTION: In a domain consisting of an Administration Server and several Managed Servers, the Administration Server *must* always be running, as new logins through KAAJEE will *not* succeed while the Administration Server is down. |
...
> ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/029.png)
...
|                                                                                                                |                                                                                                                                                                                                                        |
|----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/030.png) | REF: For more information on distribution of the login.js file, please refer to "Section 508 Compliance Addresses Session Timeouts" topic in section titled "5. Import KAAJEE/SSOWAP Login Folder" of this manual. |
...
|                                                                                                             |                                                                                                                                                                                                                                                      |
|-------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/031.png) | NOTE: Users can optionally enter both their Access and Verify codes separated by a semi-colon (;) at the ACCESS Code prompt (e.g., accesscode;verifycode) in order to skip entering data in the Verify Code prompt that follows. |
...
|                                                                                                                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/032.png) | NOTE: The asterisks located next to the Sort by Station Number/Sort by Station Name radio buttons and the Institution dropdown box indicate that both the Station Name/Number sort order preference and the last Institution selected by the user are stored in a persistent cookie (see Figure 1‑4). Thus, until the user changes this information, both the sort order preference and default Institution will remain the same for each subsequent login. |

#### Login Procedures for J2EE Web-based Applications with SSOWAP

> 1\. The landing page will have all the required information from the IAM services. If there is an issue with IAM provisioning or data, the initial login page will have the popup-debug fields, informing the user of a misconfiguration.

> 2\. (optional) Select the sort order of the Institutions in the Institution dropdown list. You can sort the Institutions by Station Number or Station Name. Click on (check) either the Sort by Station Number or Sort by Station Name radio button.

> 4\. (required) Select the appropriate Station Name/Number from the Institution dropdown list or accept the default value displayed.

|     |                                                                                                                                                                                                                                                                                                                                                                    |
|-----|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|     | NOTE: Due to IAM's limitation in handling child station provisioning, SSOWAP auto-expands all the child stations for the parent stations user is provisioned for. This approach is different from the KAAJEE Classic drop-down station list, where both the parent and child stations to be displayed had to be specifically mentioned in the kaajeeConfig.xml |
...
|     |                                                      |
|-----|------------------------------------------------------|
|     | NOTE: Persistent cookies are not used in SSOWAP. |
...
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/033.png) <strong>NOTE:</strong> If the kaajeeDisableInstitutionComponents parameter is set to "true" the Sort By Number/Name radio buttons on the login page are automatically disabled as well.</p>
<p>The following is a sample URL passing in this parameter:</p>
...
|                                                                                                                |                                                                                                                                  |
|----------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/034.png) | NOTE: All of these sample URLs, with various combinations of parameters, can be saved as shortcuts on your computer desktop. |
...
![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/035.png)
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/036.png)</td>
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/037.png)</td>
...
|                                                                                                                |                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/038.png) | REF: For more information on the Kernel signon process and related error messages, please refer to the "Signon/Security" section in the *Kernel Systems Management Guide*. |
...
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/039.png) <strong>REF:</strong> For more information on the LoginUserInfoVO object, please refer to the "LoginUserInfoVO Object" topic in Chapter 7, "Programming Guidelines," in this manual.</p>
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/040.png) <strong>REF:</strong> For more information on the &lt;user-new-person-divisions&gt; tag in the kaajeeConfig.xml file, please refer to the "KAAJEE Configuration File Tags" topic in Chapter 6, "KAAJEE Configuration File," in this manual.</p></td>
</tr>
<tr class="even">
...
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/041.png) <strong>REF:</strong> For more information on this error code, please refer to the "Error: Your verify code has expired or needs changing" topic in Chapter 11, "Troubleshooting," in this manual.</p></td>
</tr>
<tr class="odd">
...
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/042.png) <strong>REF:</strong> For more information on configuring files and integrating KAAJEE with Web-based software applications, please refer to Chapter 4, "Integrating KAAJEE with an Application," in this manual.</p></td>
</tr>
<tr class="even">
<td><p>Network Communications Software/Capability</p>
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/043.png) <strong>REF:</strong> For more information on telecommunications support, please visit the VHA Communication Services Office (CSO) Home Page:</p>
<blockquote>
<p>REDACTED</p>
</blockquote></td>
...
<blockquote>
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/044.png) <strong>NOTE:</strong> Currently, only Winsock compliant TCP/IP protocol is supported on the LAN or remotely as Point-to-Point Protocol (PPP) or Serial Line Internet Protocol (SLIP). You <em>must</em> use RAS (Remote Access Service) or Dialup Networking to connect to the server using PPP or SLIP. For the setup of RAS or Dialup Networking, please refer to the appropriate operating system's documentation.</p>
</blockquote>
<ul>
<li><blockquote>
...
|                                                                                                                |                                                                                                                        |
|----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/045.png) | REF: For a list of VistALink dependent VistA M Server patches, please refer to the *VistALink Installation Guide*. |
...
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/046.png) <strong>NOTE:</strong> A J2EE standard for pluggable authentication for J2EE servers is underway<a href="#fn1" class="footnote-ref" id="fnref1" role="doc-noteref"><sup>1</sup></a>, but won't be finalized until J2EE 1.5.</p></td>
</tr>
<tr class="even">
<td>VistALink 1.6.1</td>
...
|                                                                                                                |                                                                                                                                                                                        |
|----------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/047.png) | REF: For Developer Workstation platform requirements, please refer to the "Dependencies: Preliminary Considerations for Developer Workstation Requirements" topic in this chapter. |
...
<span id="_Toc287867692" class="anchor"></span>Table 3‑4. Dependencies—KAAJEE-related software documentation
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/048.png)</td>
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/049.png)</td>
...
<blockquote>
<p>http://vista.med.va.gov/kernel/kaajee/download.asp</p>
</blockquote></td>
</tr>
</tbody>
</table>
...
> Unzip/Explode the KAAJEE_1_2_0_xxx.ZIP software distribution file in the \<STAGING_FOLDER\>.

> After unzipping/exploding the KAAJEE_1_2_0_xxx.ZIP file, you will see the following contents/folder structure:
...
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/050.png) <strong>NOTE:</strong> This file includes a description of the current KAAJEE software version numbering scheme.</p>
<blockquote>
...
<blockquote>
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/051.png) <strong>REF:</strong> For an example of this file, please refer to Appendix A—Sample Deployment Descriptors in this manual.</p>
</blockquote>
<ul>
<li><p>kaajeeConfig.xml</p></li>
</ul>
<blockquote>
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/052.png) <strong>REF:</strong> For an example of this file, please refer to Chapter 6, "KAAJEE Configuration File," in this manual.</p>
</blockquote>
<ul>
...
<blockquote>
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/053.png) <strong>REF:</strong> For an example of this worksheet, please refer to Appendix B—Mapping WebLogic Group Names with J2EE Security Role Names in this manual.</p>
</blockquote>
<ul>
<li><blockquote>
<p>web.xml</p>
...
<blockquote>
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/054.png) <strong>REF:</strong> For an example of this file, please refer to Appendix A—Sample Deployment Descriptors in this manual.</p>
</blockquote>
<ul>
<li><blockquote>
<p>weblogic.xml</p>
...
<blockquote>
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/055.png) <strong>REF:</strong> For an example of this file, please refer to Appendix A—Sample Deployment Descriptors in this manual.</p>
</blockquote></td>
</tr>
<tr class="odd">
<td>..\doc</td>
...
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/056.png) <strong>REF:</strong> For more information, please review the<br />
...
<td>..\samples</td>
<td><blockquote>
<p>This folder contains the KAAJEE Sample Web Application ear and exploded ear files. It also includes the MD5 file for software version validation purposes. In addition, there is shortcuts subfile containing sample shortcut URLs.</p>
</blockquote></td>
</tr>
<tr class="even">
<td>..\src</td>
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/057.png)</td>
...
|                                                                                                             |                                                                                                                                                                          |
|-------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/058.png) | CAUTION: Consuming applications should *not* provide a direct link to the login.jsp file. Otherwise, users could get a login error message when they click on that link. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/059.png)</td>
...
|                                                                                                                |                                                                                                                                                                                                      |
|----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/060.png) | REF: For more information on configuring files and integrating KAAJEE with Web-based software applications, please refer to Chapter 4, "Integrating KAAJEE with an Application," in this manual. |
...
|                                                                                                             |                                                                                                                   |
|-------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/061.png) | Congratulations! You have now completed the installation of KAAJEE-related software on the developer workstation. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/062.png)</td>
...
|                                                                                                                |                                                                                                                                                                                            |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/064.png) | NOTE: Kernel is the designated custodial software application for KAAJEE; however, KAAJEE comprises multiple patches and software releases from several HealtheVet-VistA applications. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/065.png)</td>
...
|                                                                                                                |                                                                                         |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/066.png) | REF: For more information on VistALink, please consult the VistALink documentation. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/068.png)</td>
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/069.png)</td>
...
|                                                                                                                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/070.png) | NOTE: KAAJEE works with SDS 13.0 or higher; however, KAAJEE 1.2.0.xxx distributes SDS 18.0 client jar files as part of the Sample Web Application. If you deploy the both the KAAJEE Sample Web Application and your own Web-based application on the same WebLogic Application Server domain instance and intend to use a different version of SDS, those client jar files will need to be swapped out for the appropriate version of the SDS client jar files. Otherwise, There may be a conflict if both applications reference the same JNDI tree. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/071.png)</td>
...
#### Import KAAJEE or SSOWAP Jar File

> Below instructions apply to either KAAJEE Classic or SSOWAP (2FA) component. It is either, or, not combined – either the A/V code authentication or 2FA.
...
| kaajee-1.2.0.xxx.jar | The KAAJEE Classic java classes. |
| ssowap-1.0.1.\*.jar  | The KAAJEE 2FA java classes      |
...
<span id="_Toc98223568" class="anchor"></span>Table 4‑3. Jar files and classpath defined for KAAJEE Classic-enabled Web-based applications
...
Table ‑a. Jar files and classpath defined for SSOWAP(2FA)-enabled Web-based applications

| Classpath        | Description                                       |
|----------------------|-------------------------------------------------------|
| ssowap-1.0.1.xxx.jar | KAAJEE 2FA Authentication developer-related software. |

> The kaajee-1.2.0.xxx.jar or ssowap-1.0.1.\*.jar file *must* be distributed in your application's Enterprise Archive (.ear) file with an application-level classloader.

> When you are ready to deploy/distribute your application, perform the following steps:

> a\. (required) Package the kaajee-1.2.0.xxx.jar file (see Table 4‑2 or Table 4-2a) in your application's ear file (e.g., in a "../APP-INF/lib" folder descendent from the root level of your application's ear file).
...
<span id="_Ref83460728" class="anchor"></span>Table 4‑5. Other dependent jar files for KAAJEE Classic-enabled Web-based applications
...
<thead>
<tr class="header">
<th><strong>Jar File Name</strong></th>
<th><strong>Description</strong></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td>Log4J.jar</td>
<td><p>(optional) A logging utility from the Apache Jakarta Project.</p>
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/072.png) <strong>NOTE:</strong> The Jakarta Project creates and maintains open source solutions on the Java platform for distribution to the public at no charge.</p>
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/073.png) <strong>REF:</strong> For more information on the Jakarta Project, please visit the following Web address:</p>
<blockquote>
<p><a href="http://jakarta.apache.org/">http://jakarta.apache.org/</a></p>
</blockquote></td>
</tr>
<tr class="even">
<td>vha-stddata-client-18.0.jar</td>
<td rowspan="2">(required) Two Standard Data Services (SDS) jar files (as of Version 18.0).</td>
</tr>
<tr class="odd">
<td>vha-stddata-basic-18.0.jar</td>
</tr>
</tbody>
</table>
...
> Thus, when you deploy/distribute your application it is recommended that you distribute both SDS jar files in the same ear file location as you distribute the kaajee-1.2.0.xxx.jar file.

#### Import KAAJEE/SSOWAP Login Folder

> The following files are present in the "login\\ folder contained in the \<STAGING_FOLDER\>\kaajee-1.2.0.xxx\jars\kaajee_classic_jsp or \<STAGING_FOLDER\>\ssowap-1.0.1.xxx\jars\ssowap_jsp folder of the KAAJEE distribution zip file (i.e., KAAJEE_1_2_0_xxx.ZIP):

<span id="_Toc83538904" class="anchor"></span>Table 4‑6. KAAJEE login folder files
...
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/074.png) CAUTION: Consuming applications should <em>not</em> provide a direct link to the login.jsp file. Otherwise, users could get a login error message when they click on that link, see the description for navigatonerrordisplay.jsp in this table.</p></td>
</tr>
<tr class="even">
<td>..login\</td>
...
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/075.png) <strong>REF:</strong> For more information on these types of errors, please refer to Chapter 11, "Troubleshooting," in this manual.</p></td>
</tr>
<tr class="even">
<td>..login\</td>
...
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/076.png) <strong>REF:</strong> For more information on this error, please refer to the "</p>
<p>Error: You navigated inappropriately to this page" topic in Chapter 11, "Troubleshooting," in this manual.</p></td>
</tr>
<tr class="odd">
<td>..login\</td>
...
|                                                                                                                |                                                                                                                                                                                                                                                           |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/077.png) | REF: For more information on how to configure your web.xml file for the login folder, please refer to "5. Configure Web-based Application for J2EE Form-based Authentication" topic in Chapter 5, "Role Design/Setup/Administration," in this manual. |
...
#### Set Up KAAJEE/SSOWAPConfiguration File
...
|                                                                                                                |                                                                                                                                    |
|----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/078.png) | REF: For a sample kaajeeConfig.xml file, please refer to Figure 6‑2 in Chapter 6, "KAAJEE Configuration File," in this manual. |
...
|                                                                                                                |                                                                                                                                                                                                                                                                                            |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/079.png) | NOTE: For every login Station Number you enter here, you also need to use VistALink's Institution Mapping to associate that login Station Number with a VistALink connector. SSOWAP does not make use of that setting, instead, it retrieves the station numbers from the IAM services |

|                                                                                                             |                                                                                                                        |
|-------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/080.png) | WARNING: The context root must have a minimum of four characters following the forward slash (e.g., /kaajeeSampleApp). |

|                                                                                                                |                                                                                                    |
|----------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/081.png) | REF: For more details, please refer to Chapter 6, "KAAJEE Configuration File," in this manual. |
...
|                                                                                                                |                                                                                                                |
|----------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/082.png) | REF: For a sample web.xml file, please refer to "Appendix A—Sample Deployment Descriptors" in this manual. |
...
<span id="_Ref134001208" class="anchor"></span>Table 4‑7. KAAJEE listeners
...
|                                                                                                                |                                                                                                                                                                                                                                            |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/083.png) | REF: For a sample spreadsheet showing a mapping between WebLogic group names (i.e., principals) with J2EE security role names, please refer to "Appendix B—Mapping WebLogic Group Names with J2EE Security Role Names" in this manual. |
...
|                                                                                                                |                                                                                                                                            |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/084.png) | REF: For more detailed role configuration instructions, please refer to Chapter 5, "Role Design/Setup/Administration," in this manual. |
...
|                                                                                                                |                                                                                                                                                                                                                                           |
|----------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/085.png) | REF: For specific directions on setting up logging for KAAJEE, please refer to the "Log4J Configuration" section in Chapter 8, "Implementation and Maintenance," in the Implementation and Maintenance section of this documentation. |
...
|                                                                                                                |                                                                                                                                                    |
|----------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/086.png) | REF: For information on setting up KAAJEE to protect Web pages, please refer to Chapter 5, "Role Design/Setup/Administration," in this manual. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/087.png)</td>
...
Table 4‑8 lists the elements that need to be added to your web.xml file. You can find the actual elements in the file named sso-elements.txt where you can cut and paste them in your application's web.xml file. This file can be found in your distribution, in the following directory:

> \<STAGING_FOLDER\>\kaajee-1.2.0.xxx\samples\sso-ccow\sso-elements.txt

<span id="_Ref206317550" class="anchor"></span>Table 4‑8. web.xml elements needed for SSO/UC/CCOW enabled KAAJEE Sample Application
...
Figure 4‑7 provides the contents of file sso-elements.tx which contains the elements listed in Table 4‑8.
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/088.png)</td>
...
|                                                                                                                |                                                                                                                                  |
|----------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/130.png) | REF: For more information on KAAJEE-related RPCs, please refer to the "Remote Procedure Calls (RPCs)" topic in this chapter. |
...
|                                                                                                                |                                                                                                                  |
|----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/131.png) | REF: For more information regarding the KAAJEE SSPI tables, please refer to the *KAAJEE Installation Guide*. |
...
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/132.png) <strong>NOTE:</strong> KAAJEE works with SDS 18.0 or higher; however, KAAJEE 1.2.0.xxx distributes SDS 18.0 client jar files as part of the Sample Web Application. If you deploy the both the KAAJEE Sample Web Application and your own Web-based application on the same WebLogic Application Server domain instance and intend to use a different version of SDS, those client jar files will need to be swapped out for the appropriate version of the SDS client jar files. Otherwise, There may be a conflict if both applications reference the same JNDI tree.</p></td>
</tr>
<tr class="odd">
<td>VA FileMan</td>
<td>22.2</td>
...
|                                                                                                                |                                                                                                                                                                                               |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/133.png) | NOTE: There are *no* other COTS (*non*-VA) products embedded in or requiring special interfaces by this version of KAAJEE, other than those provided by the underlying operating systems. |
...
|                                                                                                                |                                                                                                           |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/134.png) | NOTE: HTTP rides over Transmission Control Protocol/Internet Protocol (TCP/IP) in the payload packet. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/135.png)</td>
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/136.png)</td>
...
|                                                                                                                |                                                                                                                                                                                               |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/137.png) | NOTE: There are *no* other COTS (*non*-VA) products embedded in or requiring special interfaces by this version of KAAJEE, other than those provided by the underlying operating systems. |
...
|                                                                                                                |                                                                                                                                                                                                            |
|----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/138.png) | NOTE: KAAJEE calls the XUS ALLKEYS RPC to return all VistA M Server J2EE security keys; however, there are *no* new KAAJEE-specific VistA M Server security keys exported with this version of KAAJEE. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/139.png)</td>
...
|                                                                                                                |                                                                                                                   |
|----------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/140.png) | NOTE: This chapter assumes that the reader has a basic understanding of the Jakarta Cactus unit testing tool. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/141.png)</td>
...
|                                                                                                             |                                                                                                                                                  |
|-------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/142.png) | This mode should *never* be enabled on a production system. It defaults to "false" unless enable is specifically set to "true" (case sensitive). |
...
|                                                                                                                |                                                                                                  |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/143.png) | NOTE: The error messages discussed in this chapter are *not* listed in any particular order. |
...
If you believe you should be able to view this directory or page, please try to contact the Website by using any e-mail address or phone number that may be listed on the REDACTED home page.
...
|                                                                                                                |                                                                                                                                                                        |
|----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/144.png) | REF: For a list of other login-related error messages, please refer to the "Symptoms and Possible Solutions" topic in the VistALink *System Administration Guide*. |

|                                                                                                                |                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/145.png) | REF: For more information on the Kernel signon process and related error messages, please refer to the "Signon/Security" section in the *Kernel Systems Management Guide*. |
...
<p>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/146.png) NOTE: In the future, VistALink may incorporate and maintain this code.</p></td>
</tr>
<tr class="even">
<td>KERNEL</td>
...
<hr />
<ol>
<li id="fn1"><p><sup>R</sup>EDACTED<a href="#fnref1" class="footnote-back" role="doc-backlink">↩︎</a></p></li>
...
<li id="fn3"><p>REDACTED<a href="#fnref3" class="footnote-back" role="doc-backlink">↩︎</a></p></li>
...
<tbody>
<tr class="odd">
<td>![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/147.png)</td>
...
|                                                                                                                |                                                                                                                                           |
|----------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/148.png) | REF: For a sample of the kaajeeConfig.xml file, please refer to Figure 6‑2 in chapter 6, "KAAJEE Configuration File," in this manual. |

application.xml

<span id="_Toc287867680" class="anchor"></span>Figure A-1. Sample KAAJEE Deployment Descriptor: application.xml file (e.g., KAAJEE sample application)
...
\<servlet-class\>gov.va.med.authentication.kernel.samples.InitSampleAppServlet\</servlet-class\>
...
|                                                                                                                |                                                                        |
|----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/149.png) | NOTE: For the KAAJEE Login Page, use 'CONFIDENTIAL' when possible. |
...
|                                                                                                                |                                                                                                                                                                                                                                            |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/150.png) | REF: For a sample spreadsheet showing a mapping between WebLogic group names (i.e., principals) with J2EE security role names, please refer to "Appendix B—Mapping WebLogic Group Names with J2EE Security Role Names" in this manual. |

<span id="_Toc287867682" class="anchor"></span>Figure A-3. Sample KAAJEE Deployment Descriptor: weblogic.xml file (e.g., KAAJEE Sample Web Application)
...
|                                                                                                                |                                                                                                                                                                                                                                                                                              |
|----------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/151.png) | NOTE: Creating the weblogic.xml deployment descriptor is optional. If you do not include this file, or include the file but do not include mappings for all security roles, all security roles without mappings will default to any user or group whose name matches the role name.[^16] |
...
|                                                                                                                |                                                                                                                                                                                                                                                                                           |
|----------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-deployment-guide-weblogic-10-3-6/152.png) | NOTE: The \<security-role-assignment\> elements in the weblogic.xml file are not needed when the \<role-name\> element and the \<principal-name\> element are the same. By default, WebLogic automatically creates a group of the same name if no mapping is defined in weblogic.xml. |
...
[^13]: See [REDACTED](https://vaww.ocis.va.gov/portal/server.pt)?.
...
### From: KAAJEE 1.0.1 Deployment Guide (WebLogic 8.1)
...
## Role Design/Setup/Administration
...
|                                                                                                                |                                                                                                                                                                                                                                            |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-0-1-deployment-guide-weblogic-8-1/088.png) | REF: For a sample spreadsheet showing a mapping between WebLogic group names (i.e., principals) with J2EE security role names, please refer to "Appendix B—Mapping WebLogic Group Names with J2EE Security Role Names" in this manual. |

|                                                                                                                |                                                                                                                                        |
|----------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-0-1-deployment-guide-weblogic-8-1/089.png) | REF: For samples of the web.xml and weblogic.xml files, please refer to "Appendix A—Sample Deployment Descriptors" in this manual. |

KAAJEE includes a "magic" role (i.e., <span class="mark">AUTHENTICATED_KAAJEE_USER</span>).

|                                                                                                                |                                                                                                                                                      |
|----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-0-1-deployment-guide-weblogic-8-1/090.png) | REF: For more information on the "magic" role, please refer to "7. Grant Special Group to All Authenticated Users (Magic Role)" in this chapter. |

#### Declare Groups (weblogic.xml file)

> KAAJEE roles are based on the group names in your application's weblogic.xml file.

> For example:

> <span id="_Ref100372913" class="anchor"></span>Figure 5‑1. Sample application weblogic.xml file with group information (e.g., KAAJEE Sample Web Application)
...
|                                                                                                                |                                                                                                       |
|----------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-0-1-deployment-guide-weblogic-8-1/091.png) | NOTE: The \<WEBROOT\> represents the root directory of the application war file, if exploded. |
...
#### Create VistA M Server J2EE security keys Corresponding to WebLogic Group Names
...
|                                                                                                                |                                                                                                                |
|----------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-0-1-deployment-guide-weblogic-8-1/092.png) | NOTE: To set the SEND TO J2EE field (#.05), use VA FileMan's Enter or Edit File Entries option \[DIEDIT\]. |
...
#### Declare J2EE Security Role Names
...
#### Map J2EE Security Role Names to WebLogic Group Names (weblogic.xml file)
...
|                                                                                                                |                                                                                                                                                                                                                                            |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-0-1-deployment-guide-weblogic-8-1/093.png) | REF: For a sample spreadsheet showing a mapping between WebLogic group names (i.e., principals) with J2EE security role names, please refer to "Appendix B—Mapping WebLogic Group Names with J2EE Security Role Names" in this manual. |

#### Configure Web-based Application for J2EE Form-based Authentication
...
> <span id="_Toc83538915" class="anchor"></span>Figure 5‑2. Sample excerpt of the KAAJEE web.xml file—J2EE Form-based Authentication configuration setup

> <span class="mark">\<login-config\></span>

> <span class="mark">\<auth-method\></span>FORM<span class="mark">\</auth-method\></span>

> <span class="mark">\<form-login-config\></span>

> <span class="mark">\<form-login-page\></span>/login/login.jsp<span class="mark">\</form-login-page\></span>

> <span class="mark">\<form-error-page\></span>login/loginerror.jsp<span class="mark">\</form-error-page\></span>
...
|                                                                                                                |                                                                                                                                                                                                                                                                                                                                                                            |
|----------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-0-1-deployment-guide-weblogic-8-1/094.png) | NOTE: Because of the way J2EE Form-based Authentication works, there cannot be login buttons that point directly to the Web login page. Only an attempt to access a protected resource—as opposed to the Web login page, which cannot be protected since it *must* be accessed prior to successful authentication—triggers the J2EE Form-based Authentication process. |

#### Protect Resources in Your J2EE Application
...
> <span id="_Toc83538916" class="anchor"></span>Figure 5‑3. Sample web.xml file excerpt—Protecting an application URL (e.g., KAAJEE Sample Web Application)

> <span class="mark">\<security-constraint\></span>

> <span class="mark">\<web-resource-collection\></span>

> <span class="mark">\<web-resource-name\>A Protected Page\</web-resource-name\></span>

> <span class="mark">\<url-pattern\>/AppHelloWorld.jsp\</url-pattern\></span>

> <span class="mark">\<http-method\>GET\</http-method\></span>

> <span class="mark">\<http-method\>POST\</http-method\></span>

> <span class="mark">\</web-resource-collection\></span>

> <span class="mark">\<auth-constraint\></span>

> <span class="mark">\<role-name\>XUKAAJEE_SAMPLE_ROLE\</role-name\></span>

> <span class="mark">\</auth-constraint\></span>

> <span class="mark">\<user-data-constraint\></span>

> <span class="mark">\<transport-guarantee\>NONE\</transport-guarantee\></span>
...
#### Grant Special Group to All Authenticated Users (Magic Role)
...
|                                                                                                                |                                                                                                                                                                                                                                                                                              |
|----------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-0-1-deployment-guide-weblogic-8-1/095.png) | NOTE: In order to use this magic role in an application, KAAJEE software declared this group name in the KaajeeManageableLoginModuleImpl.java file in the KAAJEE SSPI software. It is also made available as a J2EE security role in the standard J2EE deployment descriptor(s) as well. |
...
<span id="_Ref100039910" class="anchor"></span>Table 6‑1. KAAJEE configuration file (i.e., kaajeeConfig.xml) tag settings
...
<tbody>
<tr class="odd">
<td><mark>&lt;kaajee-config</mark>&gt;</td>
<td><p>Root XML tag. For example:</p>
<blockquote>
<p><mark>&lt;kaajee-config</mark></p>
<p><mark>xmlns:xsi=</mark></p>
<p><mark>"http://www.w3.org/2001/XMLSchema-instance"</mark></p>
<p><mark>xsi:noNamespaceSchemaLocation=</mark></p>
<p><mark>"kaajeeConfig.xsd"&gt;</mark></p>
<p><mark></mark>&lt;/kaajee-config&gt;</p>
</blockquote></td>
</tr>
<tr class="even">
<td>&lt;host-application-name&gt;</td>
<td><p>The login Web page uses this value to prominently display your application name, so that users know why they are seeing the login Web page. For example:</p>
<blockquote>
<p><mark>&lt;host-application-name&gt;<strong>KAAJEE Sample</strong></mark></p>
<p><mark>&lt;/host-application-name&gt;</mark></p>
</blockquote></td>
</tr>
<tr class="odd">
<td>&lt;login-station-numbers&gt;</td>
<td>This tag contains the sub-tags (i.e., &lt;station-number&gt; tags) that are used to store a set of Station Numbers to present to a user at login time. It is administrator configurable.</td>
</tr>
<tr class="even">
<td><blockquote>
<p>&lt;station-number&gt;</p>
<p>(repeated <strong>n</strong> times)</p>
</blockquote></td>
<td><p>Within the &lt;login-station-numbers&gt; tag, add one &lt;station-number&gt; tag for every Station Number that is valid for the user to log into, for your application. You can specify both division-level and facility-level Station Numbers, as appropriate for your application. The values entered <em>must</em> be valid and recognized by Standard Data Services (SDS).</p>
<p>![](kaajee-1-0-1-deployment-guide-weblogic-8-1/097.png) <strong>NOTE:</strong> When a user selects a division to log into, KAAJEE uses this as the Station Number parameter it passes to VistALink's Institution Mapping to retrieve a JNDI connector name for VistALink; therefore, every login station number should have a mapping configured in VistALink's Institution Mapping.</p>
<p>As distributed:</p>
<blockquote>
<p><mark>&lt;login-station-numbers&gt;</mark></p>
<p>&lt;station-number&gt;<strong>###</strong>&lt;/station-number&gt;</p>
<p>&lt;station-number&gt;<strong>###9XX</strong>&lt;/station-number&gt;</p>
<p>&lt;station-number&gt;<strong>###9XX</strong>&lt;/station-number&gt;</p>
<p>&lt;station-number&gt;<strong>###XX</strong>&lt;/station-number&gt;</p>
<p>&lt;station-number&gt;<strong>###XX</strong>&lt;/station-number&gt;</p>
<p>&lt;station-number&gt;<strong>###</strong>&lt;/station-number&gt;</p>
<p>&lt;station-number&gt;<strong>###9XX</strong>&lt;/station-number&gt;</p>
<p>&lt;station-number&gt;<strong>###9XX</strong>&lt;/station-number&gt;</p>
...
<blockquote>
<p><mark>&lt;login-station-numbers&gt;</mark></p>
<p><mark>&lt;station-number&gt;<strong>11000</strong>&lt;/station-number&gt;</mark></p>
<p><mark>&lt;station-number&gt;<strong>459</strong>&lt;/station-number&gt;</mark></p>
<p><mark>&lt;station-number&gt;<strong>523</strong>&lt;/station-number&gt;</mark></p>
<p><mark>&lt;station-number&gt;<strong>631</strong>&lt;/station-number&gt;</mark></p>
<p><mark>&lt;station-number&gt;<strong>662BU</strong>&lt;/station-number&gt;</mark></p>
<p><mark>&lt;/login-station-numbers&gt;</mark></p>
</blockquote>
<p>![](kaajee-1-0-1-deployment-guide-weblogic-8-1/098.png) <strong>NOTE:</strong> In this example, 11000 is not a valid station number that is recognized by SDS and would not be available for selection by the user at signon.</p>
<p>![](kaajee-1-0-1-deployment-guide-weblogic-8-1/099.png) <strong>NOTE:</strong> For more information on editing the login Station Numbers in the kaajeeConfig.xml file, please refer to the "Edit the KAAJEE Configuration File" topic in the <em>KAAJEE Installation Guide</em>.</p></td>
</tr>
<tr class="odd">
<td>&lt;context-root-name&gt;</td>
<td><p><mark>This tag is used to generate the stored username in WebLogic's LDAP directory, not as the actual context root name for the application. The</mark> &lt;context-root-name&gt; must be "<strong>/</strong>" followed by at least four characters. <mark>For example:</mark></p>
<blockquote>
<p><mark>&lt;context-root-name&gt;<strong>/kaajeeSampleApp</strong>&lt;/context-root-name&gt;</mark></p>
<p>The KAAJEE code explicitly takes the 2nd through 5th characters to use as the username prefix.</p>
</blockquote></td>
</tr>
<tr class="even">
<td>&lt;system-announcement&gt;</td>
<td><p><mark>This tag is an administrator-configurable logon banner</mark>. It is the introductory text displayed to users when they sign onto the system.</p>
<p>KAAJEE was developed for centralized (national) applications/systems, where the main database (not M-based) and the application server are co-located; therefore, there is a one-to-many relationship between the application server and VistA M Servers. Because the presentation of the introductory text comes before the user signs into any VistA M Server and selects the Institution/Division, this text cannot be derived from a specific VistA M Server but <em>must</em> come from the application server. Thus, this tag <mark>is an administrator-configurable logon banner</mark>. It holds the introductory text displayed to users when they sign onto the system via one of these centralized KAAJEE-enabled applications.</p>
<p>Sites <em>must</em> enter announcement text in this tag. Use a tilde (<strong>~</strong>) character to provide line breaks, or "<strong>~ ~</strong>" (each tilde separated by a space) to provide a paragraph break.</p>
<p><mark>For example:</mark></p>
<blockquote>
<p><mark>&lt;system-announcement&gt;</mark></p>
<p><strong><mark>My System Announcement~</mark></strong></p>
<p><strong><mark>Line 2~ ~</mark></strong></p>
<p><strong><mark>Paragraph 2</mark></strong></p>
<p><mark>&lt;/system-announcement&gt;</mark></p>
</blockquote>
<p>![](kaajee-1-0-1-deployment-guide-weblogic-8-1/100.png) <strong>REF:</strong> For another example of introductory text, please refer to the "Suggested System Announcement Text" topic in this chapter.</p></td>
</tr>
<tr class="odd">
<td>&lt;user-new-person-divisions&gt;</td>
<td><p>Some applications want to support division switching only to those divisions that an IRM system manager has configured as valid divisions in a person's NEW PERSON file (#200) entry on their host VistA M Server.</p>
<p>Defaults to "false" (case sensitive).</p>
<p>To tell KAAJEE to return this list of divisions after login in the LoginUserInfoVO object, set the retrieve attribute of this tag to "true" (case sensitive):</p>
<blockquote>
<p>&lt;user-new-person-divisions retrieve="<strong>true</strong>" /&gt;</p>
</blockquote></td>
</tr>
<tr class="even">
<td>&lt;computing-facility-divisions&gt;</td>
<td><p>Some applications want to support division switching for all divisions supported at the same computing facility as the login division, regardless of whether explicit access has been granted to the user for any particular division.</p>
<p>Defaults to "false" (case sensitive).</p>
<p>To tell KAAJEE to return this list of divisions in the LoginUserInfoVO object, set the retrieve attribute tag of this tag to "true" (case sensitive):</p>
<blockquote>
<p><mark>&lt;computing-facility-divisions retrieve="<strong>true</strong>" /&gt;</mark></p>
</blockquote></td>
</tr>
<tr class="odd">
<td>&lt;cactus-insecure-mode&gt;</td>
<td><p>Enables an application with valid Access/Verify code login credentials to retrieve a non-expiring "temporary" j_username/j_password credential to use for unit testing (e.g., testing with the CACTUS unit testing framework).</p>
<p>Defaults to "<strong>false</strong>" (case sensitive).</p>
<p>For example:</p>
<blockquote>
<p><mark>&lt;cactus-insecure-mode enabled="false" /&gt;</mark></p>
</blockquote>
<p>![](kaajee-1-0-1-deployment-guide-weblogic-8-1/101.png) <strong>As the tag name indicates, setting this mode decreases system security. This mode should <em>never</em> be enabled on a production system. It defaults to "false" unless enabled is specifically set to "true" (case sensitive).</strong></p>
<p>![](kaajee-1-0-1-deployment-guide-weblogic-8-1/102.png) <strong>REF:</strong> For more information on CACTUS testing, please refer to Chapter 10, "Cactus Testing with KAAJEE," in this manual.</p></td>
</tr>
</tbody>
</table>
...
The following is suggested text for a mandatory banner warning from the Office of Cyber and Information Security (OCIS) as of February 20, 2002:[^12]

<span id="_Toc83538918" class="anchor"></span>Figure 6‑1. Mandatory OCIS banner warning message
...
<span id="_Ref76979669" class="anchor"></span>
...
- \<url-pattern\> Tag—Replace "<span class="mark">/AppHelloWorld.jsp</span>" security constraint URL with your application's security constraint URL.
- \<role-name\> Tag—Replace "XUKAAJEE_SAMPLE_ROLE" security constraint role name with your application's security constraint role name.
- \<security-role\> Tag (multiple):
- \<description\> Tag—Replace/add all security role descriptions (e.g., "KERNEL KAAJEE Sample role") with your application's security role descriptions.
- \<role-name\> Tag—Replace/add all security role names (e.g., "XUKAAJEE_SAMPLE_ROLE") with your application's security role names.
...
|                                                                                                                |                                                                                                                                                                                                                                            |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-0-1-deployment-guide-weblogic-8-1/144.png) | REF: For a sample spreadsheet showing a mapping between WebLogic group names (i.e., principals) with J2EE security role names, please refer to "Appendix B—Mapping WebLogic Group Names with J2EE Security Role Names" in this manual. |

<span id="_Toc226447269" class="anchor"></span>Figure 12‑3. Sample KAAJEE Deployment Descriptor: weblogic.xml file (e.g., KAAJEE Sample Web Application)
...
|                                                                                                                |                                                                                                                                                                                                                                                                                              |
|----------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-0-1-deployment-guide-weblogic-8-1/145.png) | NOTE: Creating the weblogic.xml deployment descriptor is optional. If you do not include this file, or include the file but do not include mappings for all security roles, all security roles without mappings will default to any user or group whose name matches the role name.[^15] |
