---
title: KAAJEE 1.2.0 Release Notes
doc_type: RN
...
- PROVIDER
menu_options: 0
description: KERNEL AUTHENTICATION & AUTHORIZATION FOR J2EE (KAAJEE) VERSION 1.2.0andSECURITY SERVICE PROVIDER INTERFACES (SSPI)VERSION 1.2.0FOR WEBLOGIC (WL) VERSIONS 10.3.6 AND HIGHERRELEASE
...
docx_url: https://www.va.gov/vdl/documents/Infrastructure/KAAJEE_Archive/kaajee_1_2_releasenotes.docx
pdf_url: https://www.va.gov/vdl/documents/Infrastructure/KAAJEE_Archive/kaajee_1_2_releasenotes.pdf
...
![](kaajee-1-2-0-release-notes/001.png)

KERNEL AUTHENTICATION & AUTHORIZATION FOR J2EE (KAAJEE) VERSION 1.2.0andSECURITY SERVICE PROVIDER INTERFACES (SSPI)VERSION 1.2.0FOR WEBLOGIC (WL) VERSIONS 10.3.6 AND HIGHERRELEASE NOTES
...
- [New Features / Changes for KAAJEE Security Provider Version 1.2.0](#new-features-changes-for-kaajee-security-provider-version-120)
  ...
  - [KAAJEE SSPI Upgraded to WebLogic's AuthenticationProviderV2 SSPI](#kaajee-sspi-upgraded-to-weblogics-authenticationproviderv2-sspi)
...
> /kaajee_security_provider_1.2.0.xxx – This is the KAAJEE SSPI \<root\> level folder containing the following files:
...
|                                                                                                                |                                                                                                                                                                                                                               |
|----------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-1-2-0-release-notes/002.png) | NOTE: The Classpath on WebLogic 10.3.6 and higher Managed Servers, which is located on the Start Server tab, must now include the classpath to the KAAJEE SSPI JAR file. (i.e., wlKaajeeSecurityProviders-1.2.0.005.jar). |
