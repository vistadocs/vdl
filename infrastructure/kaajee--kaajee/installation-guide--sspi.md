---
title: KAAJEE SSPI Installation Guide 1.3 (WebLogic 10.3.6 and higher)
doc_type: IG
doc_label: Installation Guide
doc_layer: anchor
doc_subject: (WebLogic 10.3.6 and higher)
app_code: KAAJEE
app_name: KAAJEE
section: INF
app_status: archive
...
patch_ver: 1.3
patch_id: null
group_key: KAAJEE::1.3
file_numbers: []
security_keys:
- PROVIDER
- XUPROGMODE
menu_options: 0
description: The purpose of this guide is to provide instructions for installing the Health e Vet-Veterans Health Information Systems and Technology Architecture (VistA) Kernel Authentication and Authorization for Java (2) Enterprise Edition (KAAJEE) and related software.
...
docx_url: https://www.va.gov/vdl/documents/Infrastructure/KAAJEE_Archive/kaajee_sspi_1_3_ig.docx
pdf_url: https://www.va.gov/vdl/documents/Infrastructure/KAAJEE_Archive/kaajee_sspi_1_3_ig.pdf
...
- KAAJEE SSPI Installation Guide (WebLogic 12.2)
...
### From: KAAJEE SSPI Installation Guide (WebLogic 12.2)
...
![](kaajee-sspi-installation-guide-weblogic-12-2/029.png)
...
KAAJEE SSPI prior to 1.2 re-install

### Re-Deploy SSPI Software
...
|                                                                                                                                                       |                                                                                                                   |
|-------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/030.png) | UPGRADES: Skip this step if you have already created an SSPI staging area on the WebLogic Application Server. |
...
|                                                   |                               |
|---------------------------------------------------|-------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/031.png) | BEGIN: Linux Instructions |

Use the "jar" command to decompress the kaajee_security_provider_1.1.0.xxx.zip distribution file in the \<SSPI_STAGING_FOLDER\> staging directory:

> \<SSPI_STAGING_FOLDER\> jar -xvf kaajee_security_provider_1.1.0.xxx.zip

|                                                   |                             |
|---------------------------------------------------|-----------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/032.png) | END: Linux Instructions |

|                                                   |                               |
|---------------------------------------------------|-------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/033.png) | Linux users, skip to 4.2.2.4. |
...
|                                                                                                                   |                                                                                                                                                                                                                            |
|-------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/034.png) | Shut down the WebLogic Admin and Managed Servers. Shutting down the servers ensures that the domain servers will refresh their configuration values, etc. upon startup and that the new configuration changes take effect. |

|                                                   |                               |
|---------------------------------------------------|-------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/035.png) | BEGIN: Linux Instructions |
...
|                                                                                                                |                                                                                                                                                                                                                                                                                                               |
|----------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/036.png) | NOTE: In the examples that follow, some of the directory paths are represented by their \<Alias\>, as described in Table 4‑1. You can copy and paste these examples for your own use but *must* substitute the \<Alias\> placeholder with the directory information specific to your workstation. |
...
|                                                                                                                |                                                                                                                  |
|----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/037.png) | NOTE: Only the sections of setDomainEnv.sh script pertinent to demarcating file updates are displayed below. |
...
sspijar="\<SSPI_STAGING_FOLDER\>/kaajee_security_provider/ wlKaajeeSecurityProviders-1.1.0.xxx.jar"

For the following example, we substituted the \<Alias\> placeholder as shown below:

> \<SSPI_STAGING_FOLDER\> = /u01/app/bea/user_projects/domains/kaajeewebdomain

<span id="_Toc63680737" class="anchor"></span>Figure ‑. Linux Admin Server—KAAJEE SSPI classpath additions to the setDomainEnv.sh file  
(*Alias placeholders resolved with actual path names.*)
...
|                                                                                                                |                                                                                                                                                                                   |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/038.png) | NOTE: For more information on the KaajeeDatabase.properties file, please refer to the "Edit the KaajeeDatabase.properties File in the Props Directory" topic in this chapter. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-sspi-installation-guide-weblogic-12-2/039.png)</td>
...
|                                                   |                             |
|---------------------------------------------------|-----------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/040.png) | END: Linux Instructions |

|                                                   |                                 |
|---------------------------------------------------|---------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/041.png) | Linux users, skip to 4.2.2.4.3. |
...
|                                                                                                                |                                                                                                                                                                                                                                                                                                               |
|----------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/042.png) | NOTE: In the examples that follow, some of the directory paths are represented by their \<Alias\>, as described in Table 4‑1. You can copy and paste these examples for your own use but *must* substitute the \<Alias\> placeholder with the directory information specific to your workstation. |
...
|                                                                                                                |                                                                                                                   |
|----------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/043.png) | NOTE: Only the sections of setDomainEnv.cmd script pertinent to demarcating file updates are displayed below. |
...
|                                                                                                                |                                                                                                                                                                                   |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/044.png) | NOTE: For more information on the KaajeeDatabase.properties file, please refer to the "Edit the KaajeeDatabase.properties File in the Props Directory" topic in this chapter. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-sspi-installation-guide-weblogic-12-2/045.png)</td>
<td><p><strong>NOTE:</strong> KAAJEE allows users to locate the file(s) pointed to by the propertiesdir and sspidir as follows:</p>
<ul>
<li><blockquote>
<p>Co-located together in the same directory—Only one classpath is required.</p>
...
|                                                   |                                   |
|---------------------------------------------------|-----------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/046.png) | Windows users, skip to 4.2.2.4.4. |

|                                                   |                               |
|---------------------------------------------------|-------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/047.png) | BEGIN: Linux Instructions |
...
<span id="_Toc63680739" class="anchor"></span>Figure ‑. WebLogic Server Administration Console: Managed Server Start tab settings

![](kaajee-sspi-installation-guide-weblogic-12-2/048.png)
...
<tbody>
<tr class="odd">
<td>![](kaajee-sspi-installation-guide-weblogic-12-2/049.png)</td>
...
|                                                                                                                |                                                                                                                                                                                   |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/050.png) | NOTE: For more information on the KaajeeDatabase.properties file, please refer to the "Edit the KaajeeDatabase.properties File in the Props Directory" topic in this chapter. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-sspi-installation-guide-weblogic-12-2/051.png)</td>
<td><p><strong>NOTE:</strong> KAAJEE allows users to locate the file(s) pointed to by the propertiesdir and sspidir as follows:</p>
<ul>
<li><blockquote>
<p>Co-located together in the same directory—Only one classpath is required.</p>
...
<span id="_Toc63680740" class="anchor"></span>Figure ‑. Linux Managed Server—KAAJEE SSPI classpath additions on the Server Start tab  
(*Generic* example *with* \<Alias\> placeholders)
...
|                                                                                                                |                                                                                                   |
|----------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/052.png) | NOTE: Other VistALink- and WebLogic-specific classpaths will also be displayed in this field. |
...
<span id="_Toc63680741" class="anchor"></span>Figure ‑. Linux Managed Server—KAAJEE SSPI classpath additions/replacements on the Server Start tab  
(*Actual* example *without* \<Alias\> placeholders)
...
|                                                                                                                |                                                                                                   |
|----------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/053.png) | NOTE: Other VistALink- and WebLogic-specific classpaths will also be displayed in this field. |
...
<span id="_Toc63680742" class="anchor"></span>Figure ‑. Linux Managed Server—KAAJEE SSPI argument additions/replacements on the Server Start tab  
(*Generic* example *with* \<Alias\> placeholders)
...
<span id="_Toc63680743" class="anchor"></span>Figure ‑. Linux Managed Server—KAAJEE SSPI argument additions/replacements on the Server Start tab  
(*Actual* example *without* \<Alias\> placeholders)
...
<span id="_Toc63680744" class="anchor"></span>Figure ‑. Linux Managed Server—KAAJEE SSPI Security Policy File field addition/replacement on the Server Start tab  
(*Generic* example *with* \<Alias\> placeholders)
...
<span id="_Toc63680745" class="anchor"></span>Figure ‑. Linux Managed Server—KAAJEE SSPI Security Policy File field addition/replacement on the Server Start tab  
(*Actual* example *without* \<Alias\> placeholders)
...
|                                                   |                             |
|---------------------------------------------------|-----------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/054.png) | END: Linux Instructions |

|                                                   |                                 |
|---------------------------------------------------|---------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/055.png) | Linux users, skip to 4.2.2.4.5. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-sspi-installation-guide-weblogic-12-2/056.png)</td>
<td><strong>NOTE:</strong> In the examples that follow, some of the directory paths are represented by their <strong>&lt;Alias&gt;</strong>, as described in Table 4‑1. You can copy and paste these examples for your own use but <em>must</em> substitute the <strong>&lt;Alias&gt;</strong> placeholder with the directory information specific to your workstation.<br />
<br />
...
|                                                                                                                |                                                                                                                                                                                   |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/057.png) | NOTE: For more information on the KaajeeDatabase.properties file, please refer to the "Edit the KaajeeDatabase.properties File in the Props Directory" topic in this chapter. |
...
<tbody>
<tr class="odd">
<td>![](kaajee-sspi-installation-guide-weblogic-12-2/058.png)</td>
<td><p><strong>NOTE:</strong> KAAJEE allows users to locate the file(s) pointed to by the propertiesdir and sspidir as follows:</p>
<ul>
<li><blockquote>
<p>Co-located together in the same directory—Only one classpath is required.</p>
...
<span id="_Toc63680746" class="anchor"></span>Figure ‑. Windows Managed Server—KAAJEE SSPI classpath additions/replacements on the Server Start tab  
(*Generic* example *with* \<Alias\> placeholders)
...
|                                                                                                                |                                                                                                   |
|----------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/059.png) | NOTE: Other VistALink- and WebLogic-specific classpaths will also be displayed in this field. |
...
<span id="_Toc63680747" class="anchor"></span>Figure ‑. Windows Managed Server—KAAJEE SSPI classpath additions/replacements on the Server Start tab (Actual example without \<Alias\> placeholders)
...
|                                                                                                                |                                                                                                   |
|----------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| ![](kaajee-sspi-installation-guide-weblogic-12-2/060.png) | NOTE: Other VistALink- and WebLogic-specific classpaths will also be displayed in this field. |
...
<span id="_Toc63680748" class="anchor"></span>Figure ‑. Windows Managed Server—KAAJEE SSPI argument additions/replacements on the Server Start tab (*Generic* example *with* \<Alias\> placeholders)
...
<span id="_Toc63680749" class="anchor"></span>Figure ‑. Windows Managed Server—KAAJEE SSPI argument additions/replacements on the Server Start tab (*Actual* example *without* \<Alias\> placeholders)
...
<span id="_Toc63680750" class="anchor"></span>Figure ‑. Windows Managed Server—KAAJEE SSPI Security Policy File field addition/replacement on the Server Start tab (*Generic* example *with* \<Alias\> placeholders)
...
<span id="_Toc63680751" class="anchor"></span>Figure ‑. Windows Managed Server—KAAJEE SSPI Security Policy File field addition/replacement on the Server Start tab (*Actual* example *without* \<Alias\> placeholders)
