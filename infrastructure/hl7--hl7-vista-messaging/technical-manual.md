...
patch_id: null
group_key: HL7::1.6
description: The DHCP Health Level Seven (HL7) software package provides an interface that allows DHCP applications to exchange healthcare data with other applications using the HL7 protocol. This manual provides technical information for use by IRM Service personnel to operate and maintain the DHCP HL7...
