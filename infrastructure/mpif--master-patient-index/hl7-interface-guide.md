...
description: 3/2019 Modified some of the HL7 message examples to include the Name Components that are sent in the OBX segment in ADT-A08 messages sent from VistA to MPI and the ERR segment in ACK-A31 application acknowledgement messages sent from VistA to MPI. For details, see the entry in this table on the...
audience: ''
keywords: []
file_numbers:
- '1'
