---
title: Kernel XTMP Global Description Rules of Use
doc_type: SUP
...
4\. Code Cleanup—Kernel has included the necessary code in the XQ82 routine to clean up the ^XTMP global (e.g., ^XTMP("RA1"). It KILLs this global under any of the following conditions:
...
<tbody>
<tr class="odd">
<td>![](kernel-xtmp-global-description-rules-of-use/001.png)</td>
<td><p>To view the entire SAC document, please visit the SACC home page at the following Web address:</p>
<blockquote>
<p><a href="http://vaww.vista.med.va.gov/sacc/">REDACTED</a></p>
</blockquote></td>
</tr>
</tbody>
</table>