---
title: XWB*1.1*73 Release Notes
doc_type: RN
...
<ul>
<li><p>Changed all references throughout to “Patch XWB*1.1*73” as the latest BDK release.</p></li>
<li><p>Added Section <mark></mark><u>4.1.1.1</u>.</p></li>
<li><p>Updated <u>4.1.17.2</u>.</p></li>
<li><p>Supports Delphi XE8, 10.0, 10.1, 10.2, 10.3, and Delphi/RAD Studio v10.4: Sections.</p></li>
<li><p>Deleted Section 5.2, "RPC Broker BDK Online Help," since it is not being released with RPC Broker Patch XWB*1.1*73.</p></li>
</ul>
...
<ul>
<li><p>Changed all references throughout to “Patch XWB*1.1*72” as the latest BDK release.</p></li>
<li><p>Updated Section <mark></mark><u>4.1.1</u>.</p></li>
...
<li><p>Updated Section <mark></mark><u>4.1.1</u>; release notes for RPC Broker BDK Patch XWB*1.1*71.</p></li>
...
<li><p>Reformatted all sections to follow the most current Release Notes template Version 1.1, dated July 2016.</p></li>
<li><p>Added/Updated support for 2-factor authentication, Microsoft<sup>®</sup> Windows 32-bit Client applications, Delphi supported versions, added <strong>TXWBSSOiToken</strong>, and updated patch references in Section <u>4.1</u>.</p></li>
<li><p>Added Section <u>4.1.1</u>, “<u>Bug Fixes</u>.”</p></li>
<li><p>Updated Sections <u>4.1.5</u>; changed references from “Attachmate Reflections” to “Micro Focus Reflection.”</p></li>
<li><p>Updated Section <u>4.1.14</u>; added <strong>TXWBSSOiToken</strong> and alphabetized the list of components.</p></li>
<li><p>Added Section <u>4.1.14.5</u>, “<u>TXWBSSOiToken</u>.”</p></li>
<li><p>Updated Section <u>4.1.15</u>; added <strong>TXWBSSOiToken</strong>.</p></li>
<li><p>Updated Section <u>4.1.17.2</u>.</p></li>
<li><p>Added Section <u>4.1.17.6</u>.</p></li>
<li><p>Updated Section <u>4.2.2</u>; removed Note.</p></li>
<li><p>Added Section <u>4.3</u>.</p></li>
</ul>
...
<ul>
<li><p>Reformatted document to follow current documentation standards and style formatting requirements.</p></li>
<li><p>Updated Section 1.1.</p></li>
<li><p>Added Section 2.1.</p></li>
<li><p>Added Section 3.1.1.</p></li>
<li><p>Updated Section 3.1.2.</p></li>
<li><p>Deleted Section 3.1.4, “Full Backward Compatibility with Broker 1.0”, since there is no means of testing this. The only Broker 1.0 application was PCMM, and the most recently released PCMM version no longer uses Broker 1.0.</p></li>
<li><p>Updated Section 3.2.1.</p></li>
<li><p>Updated Section 4.</p></li>
<li><p>Updated Section 4.2; deleted references to the <strong>TSharedBroker</strong> and <strong>TSharedRPCBroker</strong> components.</p></li>
<li><p>Deleted Section 4.2.3, “TSharedBroker” and Section 4.2.4, “TSharedRPCBroker.”</p></li>
<li><p>Updated Section 4.2.6.2.</p></li>
<li><p>Updated Section 4.2.7.2.</p></li>
<li><p>Updated Section 4.2.7.3.</p></li>
<li><p>Updated Figure 1.</p></li>
<li><p>Added Note to Section 4.5.</p></li>
<li><p>Updated Sections 5.1 and 5.2 for Broker Help file references.</p></li>
<li><p>Updated Figure 2.</p></li>
...
<ul>
<li><p>Microsoft<sup>®</sup> XP and 7 (operating system) throughout.</p></li>
...
<ul>
<li><p>Supports Secure Shell (SSH).</p></li>
<li><p>Supports Broker Security Enhancement (BSE).</p></li>
<li><p><strong>TContextorControl</strong> component.</p></li>
</ul>
<ul>
<li><p>Added Section 2.1.</p></li>
<li><p>Updated Section 3.1.1.</p></li>
<li><p>Updated Section 3.2.1.</p></li>
<li><p>Deleted Section 3.2.2, “Edit Broker Servers Program,” because this application does not function on Windows 7 due to added security. An alternative is still being developed.</p></li>
<li><p>Updated Section 4.1.</p></li>
<li><p>Updated Section 4.2.1.2.</p></li>
<li><p>Added Section 4.2.4.</p></li>
<li><p>Updated Figure 2.</p></li>
</ul>
...
<td>07/06/2010</td>
<td>3.2</td>
<td><p>Updates for RPC Broker Patch XWB*1.1*50 (client-side only patch):</p>
<ul>
<li><p>Added support for SSH for Attachmate Reflections (see Section 3.1.1).</p></li>
<li><p>Wrapped CCOW User Context into the primary <strong>TRPCBroker</strong> component and deleting the <strong>TCCOWRPCBroker</strong> component (see Section 4.2.1.2).</p></li>
<li><p>Support for Delphi 5.0, 6.0, 7.0, 2005, 2006, 2007, 2008, 2009, and 2010.</p></li>
<li><p>Changed references form Patch 47 to Patch 50 where appropriate.</p></li>
<li><p>Reformatted document to follow current PD National Documentation Standards and current style guidelines.</p></li>
</ul>
<p><strong>RPC Broker 1.1; XWB*1.1*50 BDK</strong></p></td>
<td>RPC Broker Development Team</td>
</tr>
...
<td>02/22/2005</td>
<td>3.0</td>
<td><p>Revised Version for RPC Broker Patch XWB*1.1*40 and previous undocumented patch updates.</p>
<p><strong>RPC Broker 1.1; XWB*1.1*40 BDK</strong></p></td>
<td>RPC Broker Development Team</td>
</tr>
<tr class="odd">
<td>02/19/2002</td>
...
- [This Release](#this-release)
  - [New Features and Functions Added](#new-features-and-functions-added)
    ...
    - [Active Directory (AD) Credentials Support](#active-directory-ad-credentials-support)
    - [2-Factor Authentication Support](#2-factor-authentication-support)
    - [IPv4/IPv6 Dual-Stack Environment Support](#ipv4ipv6-dual-stack-environment-support)
    - [Secure Shell (SSH) Tunneling Support](#secure-shell-ssh-tunneling-support)
    - [Single Signon/User Context (SSO/UC) Support](#single-signonuser-context-ssouc-support)
    - [Silent Logon Support](#silent-logon-support)
    - [32-Bit Processing and Delphi Support](#32-bit-processing-and-delphi-support)
    - [Broker Security Enhancement (BSE)](#broker-security-enhancement-bse)
    - [Non-Callback Connections](#non-callback-connections)
    - [Deferred RPCs](#deferred-rpcs)
    - [Remote RPCs](#remote-rpcs)
    - [Multi-Instances Support](#multi-instances-support)
    - [RPC Broker Components](#rpc-broker-components)
    - [Classes Added](#classes-added)
    - [Library Methods Added](#library-methods-added)
    - [Properties Added](#properties-added)
    - [Types Added/Modified](#types-addedmodified)
  ...
  - [Enhancements and Modifications to Existing](#enhancements-and-modifications-to-existing)
    - [GetServerInfo Function Modified](#getserverinfo-function-modified)
    - [Dynamic Link Library (DLL) Interface Updated](#dynamic-link-library-dll-interface-updated)
    - [Library Methods Modified](#library-methods-modified)
  - [Changes to the User Authentication Process—Guide for Technical Writers](#changes-to-the-user-authentication-processguide-for-technical-writers)
    - [Validation of Users](#validation-of-users)
  - [Known Issues](#known-issues)
- [Product Documentation](#product-documentation)
  - [RPC Broker Documentation](#rpc-broker-documentation)
...
- Capability to create and implement client/server technology in the 32-bit Microsoft<sup>®</sup> Windows environment using the Broker component (e.g., create Delphi-based client/server VistA applications with Graphical User Interfaces \[GUI\]).
...
- TXWBRichEdit
- TXWBSSOiToken
![](xwb-1-1-73-release-notes/002.png) NOTE: These RPC Broker components wrap the functionality of the Broker resulting in a more modularized and orderly interface. Those components derived from the original TRPCBroker component, inherit the TRPCBroker properties and methods.
...
- Patient Safety Issue (HITPS-2387)—Mental Health providers are unable to renew medications in the Computerized Patient Record System (CPRS) when a patient has more than one medication used by Mental Health providers. The issue arises when more than one medication is being renewed. The data received from First DataBank for  
  drug\<-\>drug interactions exceeds the allowable width of a string in the LPack function in the wsockc.pas code of the BDK. This patch widens the width from 999 characters to 99999 characters.
...
### Active Directory (AD) Credentials Support
...
![](xwb-1-1-73-release-notes/003.png) NOTE: In the future, IAM may implement other authentication methods that will be exchanged for the same form of SAML token, so that no modification of RPC Broker or VistA will be required to implement the new authentication method.

### IPv4/IPv6 Dual-Stack Environment Support

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

RPC Broker 1.1 supports IPv4/IPv6 Dual-Stack Environment. It upgraded Microsoft<sup>®</sup> Windows Application Programming Interfaces (APIs) from WinSock 1.1 IPv4 to WinSock 2.2 IPv4/IPv6 dual-stack. Applications compiled with the latest BDK will be protocol independent and able to connect to both IPv4 and IPv6 VistA servers. IPv4/IPv6 dual-stack support on the VistA server is handled by VistA Kernel software. No RPC Broker changes are needed in VistA to enable IPv6 on a Broker listener. (XWB\*1.1\*60)
...
- <u>Micro Focus<sup>®</sup> Reflection</u>—Terminal emulator software using SSH tunneling for clients within the VA to provide secure data transfer between the client and the VistA M Server.
- <u>PuTTY Link (Plink)</u>—Secure channels for clients using VistA outside of the VA.

#### Micro Focus<sup>®</sup> Reflection

For SSH tunneling using Micro Focus<sup>®</sup> Reflection, “SSH” is set as a command line option or as a property within the application (set to Micro Focus<sup>®</sup> Reflection). SSH is set to true if either of the following command line parameters are set:
...
### Single Signon/User Context (SSO/UC) Support
...
![](xwb-1-1-73-release-notes/005.png) REF: For more information on SSO/UC, see the *Single Sign-On/User Context (SSO/UC) Installation Guide* and *Single Sign-On/User Context (SSO/UC) Deployment Guide* on the VA Software Document Library (VDL) at: <https://www.va.gov/vdl/application.asp?appid=162>.
...
### 32-Bit Processing and Delphi Support

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

RPC Broker 1.1 operates in a 32-bit Microsoft<sup>®</sup> Windows environment (i.e., client workstations running Microsoft<sup>®</sup> Windows 7, 8.1, or 10 operating systems). All RPC Broker components are upgraded to operate in a Microsoft<sup>®</sup> Windows 32-bit environment. (XWB\*1.1\*47)

![](xwb-1-1-73-release-notes/006.png) NOTE: The current version does *not* support development in a 64-bit environment.
...
![](xwb-1-1-73-release-notes/007.png) CAUTION: Although it is believed that there should be no problems, the RPC Broker is *not* guaranteed to be thread safe.
...
- <u>TCCOWRPCBroker</u>
- <u>TContextorControl</u>
- <u>TRPCBroker</u>
- <u>TXWBRichEdit</u>
- <u>TXWBSSOiToken</u>

![](xwb-1-1-73-release-notes/008.png) NOTE: These RPC Broker components wrap the functionality of the Broker resulting in a more modularized and orderly interface. Those components derived from the original TRPCBroker component, inherit the TRPCBroker properties and methods.

![](xwb-1-1-73-release-notes/009.png) REF: For a complete description of the RPC Broker components, properties, and methods, see the *RPC Broker Developer’s Guide*.

#### TCCOWRPCBroker

#### TCCOWRPCBroker Component Added

The TCCOWRPCBroker component allows VistA application developers to make their applications CCOW-enabled and Single Sign-On/User Context (SSO/UC)-aware with all of the client/server-related functionality in one integrated component. Using the TCCOWRPCBroker component, an application can share User Context stored in the CCOW Context Vault. (XWB\*1.1\*40)
...
![](xwb-1-1-73-release-notes/010.png) NOTE: All of the functionality used by and for the TCCOWRPCBroker component is still present, but it is now part of the regular TRPCBroker component.

#### TContextorControl

The TContextorControl component communicates with the Vergence Locator service. (XWB\*1.1\*40)
...
#### TSharedBroker and TSharedRPCBroker Properties
...
![](xwb-1-1-73-release-notes/011.png) CAUTION: Modified BDK source code should *not* be used to create VistA GUI applications.  
...
### GetServerInfo Function Modified
...
![](xwb-1-1-73-release-notes/012.png)

### Dynamic Link Library (DLL) Interface Updated

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

RPC Broker 1.1 provides Dynamic Link Library (DLL) functions that allow applications written in *any* Microsoft<sup>®</sup> Windows-based development environment (e.g., Embarcadero’s Delphi, Embarcadero C++, Microsoft<sup>®</sup> Visual Basic, and other COTS products), to take advantage of all the features offered by the RPC Broker component. This reflects VistA’s continued movement toward open systems that support multiple GUI and client front-ends.
...
![](xwb-1-1-73-release-notes/013.png) NOTE: The BAPI32.DLL contains all of the 32-bit Broker DLL functions. It provides an interface to the Broker component.
...
## Changes to the User Authentication Process—Guide for Technical Writers
...
After starting the application, many applications display a splash screen. An example of a VistA application splash screen is shown in <u>Figure 2</u>:

Figure 2: Sample VistA Application “Signon” Splash Screen

![](xwb-1-1-73-release-notes/014.png)
...
1.  If a user does *not* have a PIV Smart Card inserted, the system prompts them as shown in <u>Figure 3</u>. Selecting Cancel will fail over to Access and Verify code authentication.

Figure 3: Microsoft Windows Security: PIV Smart Card Prompt

![](xwb-1-1-73-release-notes/015.png)

2.  After inserting a PIV Smart Card, the system displays the available Public Key Infrastructure (PKI) certificates from which to choose, as shown in <u>Figure 4</u>.  
...
> ![](xwb-1-1-73-release-notes/016.png)

4.  After selecting a valid certificate, the user is prompted to enter a Personal Identification Number (PIN), as shown in <u>Figure 5</u>.  
      
    Selecting Cancel at this point fails over to Access and Verify code authentication.

> Figure 5: ActivClient Login: PIN Dialogue

> ![](xwb-1-1-73-release-notes/017.png)

5.  After entering a PIN, there is a short system delay as the user is authenticated and identified.
6.  A mandatory “System Use Notification” warning message is then displayed to the user as shown in <u>Figure 6</u>.

Figure 6: Sample System Use Notification

> ![](xwb-1-1-73-release-notes/018.png)
...
A sample of the “VistA Sign-on” dialogue with Access and Verify code fields is illustrated <u>Figure 7</u>:

Figure 7: Sample VistA Sign-on Security Dialogue: Access and Verify Codes

![](xwb-1-1-73-release-notes/019.png)

#### VistA Division Selection Dialogue

After completing user authentication and identification, the process of user authorization continues. If a user is associated with more than one institution (division), the user is presented with a dialogue similar to <u>Figure 8</u>:

Figure 8: Select Division Dialogue—Sample Entries

![](xwb-1-1-73-release-notes/020.png)
