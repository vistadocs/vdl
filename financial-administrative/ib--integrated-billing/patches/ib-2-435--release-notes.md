---
title: IB*2*435 ePharmacy Phase V Release Notes
doc_type: RN
doc_label: Release Notes
doc_layer: patch
doc_subject: ePharmacy Phase V
app_code: IB
...
- [Enhancements](#enhancements)
  - [Technical Modifications](#technical-modifications)
    - [Insurance Eligibility Processing](#insurance-eligibility-processing)
    - [Initiate e-Pharmacy Eligibility Inquiry](#initiate-e-pharmacy-eligibility-inquiry)
    - [Creation of New Insurance Buffer Entries](#creation-of-new-insurance-buffer-entries)
    - [Changes to IB Insurance Buffer Application](#changes-to-ib-insurance-buffer-application)
    - [ePharmacy-Only View in Insurance Buffer](#epharmacy-only-view-in-insurance-buffer)
    - [New Entry in SOURCE OF INFORMATION File (355.12)](#new-entry-in-source-of-information-file-35512)
    - [New Payer Sheets](#new-payer-sheets)
    - [Change to ECME Number Length](#change-to-ecme-number-length)
    - [New Action on TPJI Application](#new-action-on-tpji-application)
    - [Changes to Claims Tracking Back-Billing Option](#changes-to-claims-tracking-back-billing-option)
...
Run Date: SEP 21, 2011 Designation: IB\*2\*435
...
### Initiate e-Pharmacy Eligibility Inquiry 
...
### ePharmacy-Only View in Insurance Buffer
...
### New Entry in SOURCE OF INFORMATION File (355.12)
...
### New Action on TPJI Application
...
### Changes to Claims Tracking Back-Billing Option

<!-- back-to-toc -->[↑ Table of Contents](#table-of-contents)

1.  The IB users will now be able to enter a Delay Reason Code when submitting ECME claims through the Claims Tracking back-billing option.
