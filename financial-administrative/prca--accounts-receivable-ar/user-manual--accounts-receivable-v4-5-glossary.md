...
description: '- Glossary Account Records established for an individual debtor in the AR Debtor file. One account can have any number of bills, just as a VISA or Master Card account can be used for multiple purchases. Accounting Classification Code (ACC) Nine-character codes used for budget purposes....'
