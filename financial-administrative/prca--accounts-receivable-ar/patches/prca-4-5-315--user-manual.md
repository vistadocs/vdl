---
title: PRCA*4.5*315 AR User Manual - Agent Cashier
doc_type: UM
...
- [![](prca-4-5-315-ar-user-manual-agent-cashier/001.png)Agent Cashier Menu](#prca-4-5-315-ar-user-manual-agent-cashier001pngagent-cashier-menu)
...
![](prca-4-5-315-ar-user-manual-agent-cashier/002.png)

![](prca-4-5-315-ar-user-manual-agent-cashier/003.png)
...
![](prca-4-5-315-ar-user-manual-agent-cashier/004.png)
...
This option will print out a summary of current receipts in the system, sorted by receipt number.
